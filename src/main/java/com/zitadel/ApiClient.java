...
public class ApiClient {
    ...
    /**
     * Parse content type object from the header value
     */
    private ContentType getContentType(String headerValue) {
        try {
            return ContentType.parse(headerValue);
        } catch (UnsupportedCharsetException e) {
            throw new RuntimeException("Could not parse content type " + headerValue, e);
        }
    }
    ...
    /**
     * Serialize the given Java object into string according to the given Content-Type (only JSON is
     * supported for now).
     *
     * @param obj         Object
    ...
    public HttpEntity serialize(
        ...
        if (isJsonMime(mimeType)) {
            ...
            throw new RuntimeException("Serialization for content type '" + contentType + "' not supported");
        }
    }
    ...
    public <T> T invokeAPI(
        ...
        if (body != null && !formParams.isEmpty()) {
            throw new RuntimeException("Cannot have body and form params");
        }
        ...
        if (body != null || !formParams.isEmpty()) {
            if (isBodyAllowed(method)) {
                ...
                throw new RuntimeException("method " + method + " does not support a request body");
            }
        } else {
