...
/**
 * UserServiceBetaSendPasskeyRegistrationLink
 */
@JsonPropertyOrder({
  UserServiceBetaSendPasskeyRegistrationLink.JSON_PROPERTY_URL_TEMPLATE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class UserServiceBetaSendPasskeyRegistrationLink {
  public static final String JSON_PROPERTY_URL_TEMPLATE = "urlTemplate";
  @javax.annotation.Nullable
  private String urlTemplate;

  public UserServiceBetaSendPasskeyRegistrationLink() {
  }

  public UserServiceBetaSendPasskeyRegistrationLink urlTemplate(@javax.annotation.Nullable String urlTemplate) {
  ...
  public boolean equals(Object o) {
    ...
    UserServiceBetaSendPasskeyRegistrationLink userServiceBetaSendPasskeyRegistrationLink = (UserServiceBetaSendPasskeyRegistrationLink) o;
    return Objects.equals(this.urlTemplate, userServiceBetaSendPasskeyRegistrationLink.urlTemplate);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserServiceBetaSendPasskeyRegistrationLink {\n");
