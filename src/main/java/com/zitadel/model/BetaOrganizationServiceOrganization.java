...
public class BetaOrganizationServiceOrganization {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaOrganizationServiceOrganization other)) {
      return false;
    }
    return java.util.Objects.equals(this.id, other.id)
        && java.util.Objects.equals(this.creationDate, other.creationDate)
        && java.util.Objects.equals(this.changedDate, other.changedDate)
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, creationDate, changedDate, state, name, primaryDomain);
  }
}
