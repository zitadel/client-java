...
public class ActionServiceAddPublicKeyResponse {

  /**
   * The KeyID is the unique identifier of the newly added public key. The ID is also used a `kid`
   * in the JWT header for payload encryption. This allows the target to identify the correct key to
   * use for decryption.
   *
   * <p>Example: {@code null}
   */
  ...
  public ActionServiceAddPublicKeyResponse() {}
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ActionServiceAddPublicKeyResponse other)) {
      return false;
    }
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(keyId, creationDate);
  }
}
