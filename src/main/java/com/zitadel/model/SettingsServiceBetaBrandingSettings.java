...
import com.zitadel.model.SettingsServiceBetaTheme;
import com.zitadel.model.SettingsServiceBetaThemeMode;
...
/**
 * SettingsServiceBetaBrandingSettings
 */
@JsonPropertyOrder({
  SettingsServiceBetaBrandingSettings.JSON_PROPERTY_LIGHT_THEME,
  SettingsServiceBetaBrandingSettings.JSON_PROPERTY_DARK_THEME,
  SettingsServiceBetaBrandingSettings.JSON_PROPERTY_FONT_URL,
  SettingsServiceBetaBrandingSettings.JSON_PROPERTY_HIDE_LOGIN_NAME_SUFFIX,
  SettingsServiceBetaBrandingSettings.JSON_PROPERTY_DISABLE_WATERMARK,
  SettingsServiceBetaBrandingSettings.JSON_PROPERTY_RESOURCE_OWNER_TYPE,
  SettingsServiceBetaBrandingSettings.JSON_PROPERTY_THEME_MODE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class SettingsServiceBetaBrandingSettings {
  public static final String JSON_PROPERTY_LIGHT_THEME = "lightTheme";
  @javax.annotation.Nullable
  private SettingsServiceBetaTheme lightTheme;

  public static final String JSON_PROPERTY_DARK_THEME = "darkTheme";
  @javax.annotation.Nullable
  private SettingsServiceBetaTheme darkTheme;
  ...
  @javax.annotation.Nullable
  private SettingsServiceBetaThemeMode themeMode = SettingsServiceBetaThemeMode.THEME_MODE_UNSPECIFIED;

  public SettingsServiceBetaBrandingSettings() {
  }

  public SettingsServiceBetaBrandingSettings lightTheme(@javax.annotation.Nullable SettingsServiceBetaTheme lightTheme) {
  ...
  public SettingsServiceBetaTheme getLightTheme() {
    return lightTheme;
  }
  ...
  @JsonProperty(JSON_PROPERTY_LIGHT_THEME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLightTheme(@javax.annotation.Nullable SettingsServiceBetaTheme lightTheme) {
    this.lightTheme = lightTheme;
  }

  public SettingsServiceBetaBrandingSettings darkTheme(@javax.annotation.Nullable SettingsServiceBetaTheme darkTheme) {
  ...
  public SettingsServiceBetaTheme getDarkTheme() {
    return darkTheme;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DARK_THEME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDarkTheme(@javax.annotation.Nullable SettingsServiceBetaTheme darkTheme) {
    this.darkTheme = darkTheme;
  }

  public SettingsServiceBetaBrandingSettings fontUrl(@javax.annotation.Nullable String fontUrl) {
  ...
  public SettingsServiceBetaBrandingSettings hideLoginNameSuffix(@javax.annotation.Nullable Boolean hideLoginNameSuffix) {
  ...
  public SettingsServiceBetaBrandingSettings disableWatermark(@javax.annotation.Nullable Boolean disableWatermark) {
  ...
  public SettingsServiceBetaBrandingSettings resourceOwnerType(@javax.annotation.Nullable SettingsServiceBetaResourceOwnerType resourceOwnerType) {
  ...
  public SettingsServiceBetaBrandingSettings themeMode(@javax.annotation.Nullable SettingsServiceBetaThemeMode themeMode) {
  ...
  public SettingsServiceBetaThemeMode getThemeMode() {
    return themeMode;
  }
  ...
  @JsonProperty(JSON_PROPERTY_THEME_MODE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setThemeMode(@javax.annotation.Nullable SettingsServiceBetaThemeMode themeMode) {
    this.themeMode = themeMode;
  }
  ...
  public boolean equals(Object o) {
    ...
    SettingsServiceBetaBrandingSettings settingsServiceBetaBrandingSettings = (SettingsServiceBetaBrandingSettings) o;
    return Objects.equals(this.lightTheme, settingsServiceBetaBrandingSettings.lightTheme) &&
        Objects.equals(this.darkTheme, settingsServiceBetaBrandingSettings.darkTheme) &&
        Objects.equals(this.fontUrl, settingsServiceBetaBrandingSettings.fontUrl) &&
        Objects.equals(this.hideLoginNameSuffix, settingsServiceBetaBrandingSettings.hideLoginNameSuffix) &&
        Objects.equals(this.disableWatermark, settingsServiceBetaBrandingSettings.disableWatermark) &&
        Objects.equals(this.resourceOwnerType, settingsServiceBetaBrandingSettings.resourceOwnerType) &&
        Objects.equals(this.themeMode, settingsServiceBetaBrandingSettings.themeMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class SettingsServiceBetaBrandingSettings {\n");
