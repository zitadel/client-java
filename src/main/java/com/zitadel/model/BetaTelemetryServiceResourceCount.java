...
public class BetaTelemetryServiceResourceCount {
  ...
  /** The {@code parentType} property. */
  @JsonProperty("parentType")
  @Nullable
  public BetaTelemetryServiceCountParentType parentType;

  /**
   * The parent ID of the resource counts (e.g. organization or instance ID). For example, reporting
   * the amount of users per organization would use `COUNT_PARENT_TYPE_ORGANIZATION` as parent type
   * and the organization ID as parent ID.
   */
  ...
  /**
   * The name of the table in the database, which was used to calculate the counts. This can be used
   * to deduplicate counts in case of multiple reports. For example, if the counts were calculated
   * from the `users14` table, the table name would be `users14`, where there could also be a
   * `users15` table reported at the same time as the system is rolling out a new version.
   */
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaTelemetryServiceResourceCount other)) {
      return false;
    }
    return java.util.Objects.equals(this.instanceId, other.instanceId)
        ...
        && java.util.Objects.equals(this.updatedAt, other.updatedAt)
  ...
  public int hashCode() {
    return java.util.Objects.hash(
        instanceId, parentType, parentId, resourceName, tableName, updatedAt, amount);
  }
}
