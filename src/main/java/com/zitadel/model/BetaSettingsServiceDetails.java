...
public class BetaSettingsServiceDetails {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaSettingsServiceDetails other)) {
      return false;
    }
    return java.util.Objects.equals(this.sequence, other.sequence)
        && java.util.Objects.equals(this.changeDate, other.changeDate)
        && java.util.Objects.equals(this.resourceOwner, other.resourceOwner)
        && java.util.Objects.equals(this.creationDate, other.creationDate);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(sequence, changeDate, resourceOwner, creationDate);
  }
}
