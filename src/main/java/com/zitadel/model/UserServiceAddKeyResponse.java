...
public class UserServiceAddKeyResponse {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof UserServiceAddKeyResponse other)) {
      return false;
    }
    return java.util.Objects.equals(this.creationDate, other.creationDate)
        && java.util.Objects.equals(this.keyId, other.keyId)
        && java.util.Arrays.equals(this.keyContent, other.keyContent);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(creationDate, keyId, java.util.Arrays.hashCode(keyContent));
  }
}
