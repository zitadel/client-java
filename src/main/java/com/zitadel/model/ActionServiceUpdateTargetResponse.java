...
public class ActionServiceUpdateTargetResponse {
  ...
  /**
   * Key used to sign and check payload sent to the target. The key can be used to verify the
   * integrity and authenticity of the request on the receiver side. The key should be treated as a
   * secret and only known to ZITADEL and the receiver. The signature is included in the request
   * header `X-ZITADEL-Signature` and calculated over the raw body of the request using HMAC with
   * SHA256. The key is only returned if expirationSigningKey was set in the request.
   *
   * <p>Example: {@code null}
   */
  ...
  public ActionServiceUpdateTargetResponse() {}
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ActionServiceUpdateTargetResponse other)) {
      return false;
    }
    return java.util.Objects.equals(this.changeDate, other.changeDate)
        && java.util.Objects.equals(this.signingKey, other.signingKey);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(changeDate, signingKey);
  }
}
