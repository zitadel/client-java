...
public class WebKeyServiceWebKey {
  ...
  @JsonProperty("state")
  @Nullable
  public WebKeyServiceState state;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof WebKeyServiceWebKey other)) {
      return false;
    }
    return java.util.Objects.equals(this.id, other.id)
        ...
        && java.util.Objects.equals(this.ecdsa, other.ecdsa)
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, creationDate, changeDate, state, ecdsa, ed25519, rsa);
  }
}
