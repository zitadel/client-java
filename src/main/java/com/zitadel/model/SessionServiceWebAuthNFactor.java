...
public class SessionServiceWebAuthNFactor {
  ...
  /**
   * Indicates if the user presence was verified during the last challenge. This can be used to
   * determine if the factor can be considered as multi-factor authentication.
   *
   * <p>Example: {@code null}
   */
  ...
  public SessionServiceWebAuthNFactor() {}
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SessionServiceWebAuthNFactor other)) {
      return false;
    }
    return java.util.Objects.equals(this.verifiedAt, other.verifiedAt)
        && java.util.Objects.equals(this.userVerified, other.userVerified);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(verifiedAt, userVerified);
  }
}
