...
import com.zitadel.model.SessionServiceFactors;
 ...
 */
@JsonPropertyOrder({
  SessionServiceSession.JSON_PROPERTY_ID,
  SessionServiceSession.JSON_PROPERTY_CREATION_DATE,
  SessionServiceSession.JSON_PROPERTY_CHANGE_DATE,
  SessionServiceSession.JSON_PROPERTY_SEQUENCE,
  SessionServiceSession.JSON_PROPERTY_FACTORS,
  SessionServiceSession.JSON_PROPERTY_METADATA,
...
public class SessionServiceSession {
  ...
  @javax.annotation.Nullable
  private SessionServiceFactors factors;
  ...
  public SessionServiceSession() {
  }

  public SessionServiceSession id(@javax.annotation.Nullable String id) {
  ...
  public SessionServiceSession creationDate(@javax.annotation.Nullable OffsetDateTime creationDate) {
  ...
  public SessionServiceSession changeDate(@javax.annotation.Nullable OffsetDateTime changeDate) {
  ...
  public SessionServiceFactors getFactors() {
    return factors;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FACTORS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFactors(@javax.annotation.Nullable SessionServiceFactors factors) {
    this.factors = factors;
  }

  public SessionServiceSession metadata(@javax.annotation.Nullable Map<String, byte[]> metadata) {
    
    this.metadata = metadata;
    return this;
  }

  public SessionServiceSession putMetadataItem(String key, byte[] metadataItem) {
  ...
  public SessionServiceSession userAgent(@javax.annotation.Nullable SessionServiceUserAgent userAgent) {
  ...
  public SessionServiceSession expirationDate(@javax.annotation.Nullable OffsetDateTime expirationDate) {
  ...
  public boolean equals(Object o) {
    ...
    SessionServiceSession sessionServiceSession = (SessionServiceSession) o;
  ...
  public String toString() {
    ...
    sb.append("class SessionServiceSession {\n");
