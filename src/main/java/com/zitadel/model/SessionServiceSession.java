...
public class SessionServiceSession {
  ...
  /** The {@code factors} property. */
  @JsonProperty("factors")
  @Nullable
  public SessionServiceFactors factors;

  /**
   * Metadata contains custom key value pairs set by the user. The metadata is not interpreted by
   * ZITADEL and can be used to store any information relevant to the session.
   */
  @JsonProperty("metadata")
  @Nullable
  public Map<String, byte[]> metadata = new HashMap<>();

  /** The {@code userAgent} property. */
  @JsonProperty("userAgent")
  @Nullable
  public SessionServiceUserAgent userAgent;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SessionServiceSession other)) {
      return false;
    }
