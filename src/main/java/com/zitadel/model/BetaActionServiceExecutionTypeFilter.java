...
public class BetaActionServiceExecutionTypeFilter {
  ...
  /** The {@code executionType} property. */
  @JsonProperty("executionType")
  @Nullable
  public BetaActionServiceExecutionType executionType;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaActionServiceExecutionTypeFilter other)) {
      return false;
    }
    return java.util.Objects.equals(this.executionType, other.executionType);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(executionType);
  }
}
