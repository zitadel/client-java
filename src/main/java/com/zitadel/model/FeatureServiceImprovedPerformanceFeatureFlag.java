...
import com.zitadel.model.FeatureServiceSource;
...
public class FeatureServiceImprovedPerformanceFeatureFlag {
  ...
  private List<FeatureServiceImprovedPerformance> executionPaths = new ArrayList<>();
  ...
  public FeatureServiceImprovedPerformanceFeatureFlag executionPaths(@javax.annotation.Nullable List<FeatureServiceImprovedPerformance> executionPaths) {
    
    this.executionPaths = executionPaths;
    return this;
  }

  public FeatureServiceImprovedPerformanceFeatureFlag addExecutionPathsItem(FeatureServiceImprovedPerformance executionPathsItem) {
  ...
  public List<FeatureServiceImprovedPerformance> getExecutionPaths() {
    return executionPaths;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EXECUTION_PATHS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExecutionPaths(@javax.annotation.Nullable List<FeatureServiceImprovedPerformance> executionPaths) {
    this.executionPaths = executionPaths;
  }

  public FeatureServiceImprovedPerformanceFeatureFlag source(@javax.annotation.Nullable FeatureServiceSource source) {
  ...
  public FeatureServiceSource getSource() {
    return source;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SOURCE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSource(@javax.annotation.Nullable FeatureServiceSource source) {
    this.source = source;
  }
  ...
  public boolean equals(Object o) {
    ...
    FeatureServiceImprovedPerformanceFeatureFlag featureServiceImprovedPerformanceFeatureFlag = (FeatureServiceImprovedPerformanceFeatureFlag) o;
    return Objects.equals(this.executionPaths, featureServiceImprovedPerformanceFeatureFlag.executionPaths) &&
        Objects.equals(this.source, featureServiceImprovedPerformanceFeatureFlag.source);
  }
  ...
  public String toString() {
    ...
    sb.append("class FeatureServiceImprovedPerformanceFeatureFlag {\n");
