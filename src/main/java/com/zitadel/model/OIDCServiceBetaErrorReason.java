...
/**
 * Gets or Sets OIDCServiceBetaErrorReason
 */
public enum OIDCServiceBetaErrorReason {
  ...
  OIDCServiceBetaErrorReason(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static OIDCServiceBetaErrorReason fromValue(String value) {
    for (OIDCServiceBetaErrorReason b : OIDCServiceBetaErrorReason.values()) {
