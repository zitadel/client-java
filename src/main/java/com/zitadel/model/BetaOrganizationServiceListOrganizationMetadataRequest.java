...
public class BetaOrganizationServiceListOrganizationMetadataRequest {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaOrganizationServiceListOrganizationMetadataRequest other)) {
      return false;
    }
  ...
  public int hashCode() {
    return java.util.Objects.hash(
        organizationId, pagination, com.zitadel.ObjectSerializer.structuralHashCode(filter));
  }
}
