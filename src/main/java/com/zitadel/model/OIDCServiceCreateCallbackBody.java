 ...
 */
@JsonPropertyOrder({
  OIDCServiceCreateCallbackBody.JSON_PROPERTY_SESSION,
  OIDCServiceCreateCallbackBody.JSON_PROPERTY_ERROR
})
...
public class OIDCServiceCreateCallbackBody {
  ...
  @javax.annotation.Nullable
  private V2AuthorizationError error;
  ...
  public OIDCServiceCreateCallbackBody error(@javax.annotation.Nullable V2AuthorizationError error) {
  ...
  public V2AuthorizationError getError() {
    return error;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ERROR)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setError(@javax.annotation.Nullable V2AuthorizationError error) {
    this.error = error;
  }
  ...
  public boolean equals(Object o) {
    ...
    OIDCServiceCreateCallbackBody oiDCServiceCreateCallbackBody = (OIDCServiceCreateCallbackBody) o;
    return Objects.equals(this.session, oiDCServiceCreateCallbackBody.session) &&
        Objects.equals(this.error, oiDCServiceCreateCallbackBody.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class OIDCServiceCreateCallbackBody {\n");
