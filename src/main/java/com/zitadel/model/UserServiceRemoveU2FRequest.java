...
public class UserServiceRemoveU2FRequest {
  ...
  public UserServiceRemoveU2FRequest userId(@javax.annotation.Nonnull String userId) {
  ...
  public UserServiceRemoveU2FRequest u2fId(@javax.annotation.Nonnull String u2fId) {
