...
public enum SettingsServiceAutoLinkingOption {
  ...
  SettingsServiceAutoLinkingOption(String value) {
    this.value = value;
  }
  ...
  public static SettingsServiceAutoLinkingOption fromValue(String value) {
    for (SettingsServiceAutoLinkingOption b : values()) {
