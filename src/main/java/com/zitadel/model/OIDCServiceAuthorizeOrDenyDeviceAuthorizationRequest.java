...
public class OIDCServiceAuthorizeOrDenyDeviceAuthorizationRequest {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `deviceAuthorizationId` to the URL query string
    if (getDeviceAuthorizationId() != null) {
      try {
        joiner.add(String.format("%sdeviceAuthorizationId%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDeviceAuthorizationId()), "UTF-8").replaceAll("\\+", "%20")));
