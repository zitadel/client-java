 ...
 */
@JsonPropertyOrder({
  V2SecuritySettings.JSON_PROPERTY_EMBEDDED_IFRAME,
  V2SecuritySettings.JSON_PROPERTY_ENABLE_IMPERSONATION
})
@JsonTypeName("v2SecuritySettings")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2SecuritySettings {
  ...
  public V2SecuritySettings() {
  }

  public V2SecuritySettings embeddedIframe(@javax.annotation.Nullable V2EmbeddedIframeSettings embeddedIframe) {
  ...
  public V2SecuritySettings enableImpersonation(@javax.annotation.Nullable Boolean enableImpersonation) {
  ...
  public boolean equals(Object o) {
    ...
    V2SecuritySettings v2SecuritySettings = (V2SecuritySettings) o;
    return Objects.equals(this.embeddedIframe, v2SecuritySettings.embeddedIframe) &&
        Objects.equals(this.enableImpersonation, v2SecuritySettings.enableImpersonation);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2SecuritySettings {\n");
