...
public class FeatureServiceSetSystemFeaturesRequest {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.loginDefaultOrg, featureServiceSetSystemFeaturesRequest.loginDefaultOrg) &&
        equalsNullable(this.oidcTriggerIntrospectionProjections, featureServiceSetSystemFeaturesRequest.oidcTriggerIntrospectionProjections) &&
        equalsNullable(this.oidcLegacyIntrospection, featureServiceSetSystemFeaturesRequest.oidcLegacyIntrospection) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(loginDefaultOrg), hashCodeNullable(oidcTriggerIntrospectionProjections), hashCodeNullable(oidcLegacyIntrospection), hashCodeNullable(userSchema), hashCodeNullable(oidcTokenExchange), improvedPerformance, hashCodeNullable(oidcSingleV1SessionTermination), hashCodeNullable(disableUserTokenEvent), hashCodeNullable(enableBackChannelLogout), loginV2, hashCodeNullable(permissionCheckV2));
  }
