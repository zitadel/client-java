 ...
 */
@JsonPropertyOrder({
  NameQuery.JSON_PROPERTY_NAME_QUERY
})
@JsonTypeName("name_query")
...
public class NameQuery {
  ...
  public NameQuery nameQuery(@javax.annotation.Nonnull OrganizationServiceOrganizationNameQuery nameQuery) {
  ...
  public boolean equals(Object o) {
    ...
    NameQuery nameQuery = (NameQuery) o;
    return Objects.equals(this.nameQuery, nameQuery.nameQuery);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nameQuery);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NameQuery {\n");
