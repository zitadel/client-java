...
public class SessionServiceExpirationDateQuery {
  ...
  @JsonProperty("method")
  @Nullable
  public SessionServiceTimestampQueryMethod method;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SessionServiceExpirationDateQuery other)) {
      return false;
    }
    return java.util.Objects.equals(this.expirationDate, other.expirationDate)
        && java.util.Objects.equals(this.method, other.method);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(expirationDate, method);
  }
}
