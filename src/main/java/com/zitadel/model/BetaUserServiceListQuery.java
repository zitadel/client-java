 ...
 */
@JsonPropertyOrder({
  BetaUserServiceListQuery.JSON_PROPERTY_OFFSET,
  BetaUserServiceListQuery.JSON_PROPERTY_LIMIT,
  BetaUserServiceListQuery.JSON_PROPERTY_ASC
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class BetaUserServiceListQuery {
  ...
  public BetaUserServiceListQuery() {
  }

  public BetaUserServiceListQuery offset(@javax.annotation.Nullable Object offset) {
  ...
  public BetaUserServiceListQuery limit(@javax.annotation.Nullable Integer limit) {
  ...
  public BetaUserServiceListQuery asc(@javax.annotation.Nullable Boolean asc) {
  ...
  public boolean equals(Object o) {
    ...
    BetaUserServiceListQuery betaUserServiceListQuery = (BetaUserServiceListQuery) o;
    return equalsNullable(this.offset, betaUserServiceListQuery.offset) &&
        Objects.equals(this.limit, betaUserServiceListQuery.limit) &&
        Objects.equals(this.asc, betaUserServiceListQuery.asc);
  }
  ...
  public String toString() {
    ...
    sb.append("class BetaUserServiceListQuery {\n");
