 ...
 */
@JsonPropertyOrder({
  InstanceServiceCustomDomain.JSON_PROPERTY_INSTANCE_ID,
  InstanceServiceCustomDomain.JSON_PROPERTY_CREATION_DATE,
  InstanceServiceCustomDomain.JSON_PROPERTY_DOMAIN,
  InstanceServiceCustomDomain.JSON_PROPERTY_PRIMARY,
  InstanceServiceCustomDomain.JSON_PROPERTY_GENERATED
})
...
public class InstanceServiceCustomDomain {
  ...
  public InstanceServiceCustomDomain instanceId(@javax.annotation.Nullable String instanceId) {
  ...
  public InstanceServiceCustomDomain creationDate(@javax.annotation.Nullable OffsetDateTime creationDate) {
  ...
  public InstanceServiceCustomDomain domain(@javax.annotation.Nullable String domain) {
  ...
  public InstanceServiceCustomDomain primary(@javax.annotation.Nullable Boolean primary) {
  ...
  public InstanceServiceCustomDomain generated(@javax.annotation.Nullable Boolean generated) {
  ...
  public boolean equals(Object o) {
    ...
    InstanceServiceCustomDomain instanceServiceCustomDomain = (InstanceServiceCustomDomain) o;
    return Objects.equals(this.instanceId, instanceServiceCustomDomain.instanceId) &&
        Objects.equals(this.creationDate, instanceServiceCustomDomain.creationDate) &&
        Objects.equals(this.domain, instanceServiceCustomDomain.domain) &&
        Objects.equals(this.primary, instanceServiceCustomDomain.primary) &&
        Objects.equals(this.generated, instanceServiceCustomDomain.generated);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstanceServiceCustomDomain {\n");
