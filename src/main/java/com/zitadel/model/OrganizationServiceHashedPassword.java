...
public class OrganizationServiceHashedPassword {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof OrganizationServiceHashedPassword other)) {
      return false;
    }
    return java.util.Objects.equals(this.hash, other.hash)
        && java.util.Objects.equals(this.changeRequired, other.changeRequired);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(hash, changeRequired);
  }
}
