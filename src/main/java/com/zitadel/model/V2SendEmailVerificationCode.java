 ...
 */
@JsonPropertyOrder({
  V2SendEmailVerificationCode.JSON_PROPERTY_URL_TEMPLATE
})
@JsonTypeName("v2SendEmailVerificationCode")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2SendEmailVerificationCode {
  public static final String JSON_PROPERTY_URL_TEMPLATE = "urlTemplate";
  @javax.annotation.Nullable
  private String urlTemplate;

  public V2SendEmailVerificationCode() {
  }

  public V2SendEmailVerificationCode urlTemplate(@javax.annotation.Nullable String urlTemplate) {
  ...
  public boolean equals(Object o) {
    ...
    V2SendEmailVerificationCode v2SendEmailVerificationCode = (V2SendEmailVerificationCode) o;
    return Objects.equals(this.urlTemplate, v2SendEmailVerificationCode.urlTemplate);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2SendEmailVerificationCode {\n");
