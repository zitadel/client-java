...
public enum BetaUserServiceNotificationType {
  /** The {@code "NOTIFICATION_TYPE_Unspecified"} value. */
  NOTIFICATION_TYPE_UNSPECIFIED("NOTIFICATION_TYPE_Unspecified"),
  /** The {@code "NOTIFICATION_TYPE_Email"} value. */
  NOTIFICATION_TYPE_EMAIL("NOTIFICATION_TYPE_Email"),
  /** The {@code "NOTIFICATION_TYPE_SMS"} value. */
  NOTIFICATION_TYPE_SMS("NOTIFICATION_TYPE_SMS");

  private final String value;

  BetaUserServiceNotificationType(String value) {
    this.value = value;
  }
  ...
  public static BetaUserServiceNotificationType fromValue(String value) {
    for (BetaUserServiceNotificationType b : values()) {
