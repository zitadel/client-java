...
/**
 * UserServiceBetaRedirectURLs
 */
@JsonPropertyOrder({
  UserServiceBetaRedirectURLs.JSON_PROPERTY_SUCCESS_URL,
  UserServiceBetaRedirectURLs.JSON_PROPERTY_FAILURE_URL
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class UserServiceBetaRedirectURLs {
  ...
  public UserServiceBetaRedirectURLs() {
  }

  public UserServiceBetaRedirectURLs successUrl(@javax.annotation.Nullable String successUrl) {
  ...
  public UserServiceBetaRedirectURLs failureUrl(@javax.annotation.Nullable String failureUrl) {
  ...
  public boolean equals(Object o) {
    ...
    UserServiceBetaRedirectURLs userServiceBetaRedirectURLs = (UserServiceBetaRedirectURLs) o;
    return Objects.equals(this.successUrl, userServiceBetaRedirectURLs.successUrl) &&
        Objects.equals(this.failureUrl, userServiceBetaRedirectURLs.failureUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserServiceBetaRedirectURLs {\n");
