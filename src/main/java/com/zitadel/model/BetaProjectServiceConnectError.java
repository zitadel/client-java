...
public class BetaProjectServiceConnectError extends HashMap<String, Object> {
  ...
  public BetaProjectServiceConnectError code(@javax.annotation.Nullable CodeEnum code) {
  ...
  public BetaProjectServiceConnectError message(@javax.annotation.Nullable String message) {
  ...
  public String toString() {
    ...
    sb.append("class BetaProjectServiceConnectError {\n");
