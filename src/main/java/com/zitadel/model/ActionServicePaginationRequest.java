 ...
 */
@JsonPropertyOrder({
  ActionServicePaginationRequest.JSON_PROPERTY_OFFSET,
  ActionServicePaginationRequest.JSON_PROPERTY_LIMIT,
  ActionServicePaginationRequest.JSON_PROPERTY_ASC
})
...
public class ActionServicePaginationRequest {
  ...
  public ActionServicePaginationRequest offset(@javax.annotation.Nullable Object offset) {
  ...
  public ActionServicePaginationRequest limit(@javax.annotation.Nullable Integer limit) {
  ...
  public ActionServicePaginationRequest asc(@javax.annotation.Nullable Boolean asc) {
  ...
  public boolean equals(Object o) {
    ...
    ActionServicePaginationRequest actionServicePaginationRequest = (ActionServicePaginationRequest) o;
    return equalsNullable(this.offset, actionServicePaginationRequest.offset) &&
        Objects.equals(this.limit, actionServicePaginationRequest.limit) &&
        Objects.equals(this.asc, actionServicePaginationRequest.asc);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionServicePaginationRequest {\n");
