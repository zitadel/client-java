...
public class UserServiceVerifyInviteCodeRequest {
  ...
  public UserServiceVerifyInviteCodeRequest userId(@javax.annotation.Nullable String userId) {
  ...
  public UserServiceVerifyInviteCodeRequest verificationCode(@javax.annotation.Nullable String verificationCode) {
