...
/**
 * SettingsServiceBetaPasswordExpirySettings
 */
@JsonPropertyOrder({
  SettingsServiceBetaPasswordExpirySettings.JSON_PROPERTY_MAX_AGE_DAYS,
  SettingsServiceBetaPasswordExpirySettings.JSON_PROPERTY_EXPIRE_WARN_DAYS,
  SettingsServiceBetaPasswordExpirySettings.JSON_PROPERTY_RESOURCE_OWNER_TYPE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class SettingsServiceBetaPasswordExpirySettings {
  ...
  public SettingsServiceBetaPasswordExpirySettings() {
  }

  public SettingsServiceBetaPasswordExpirySettings maxAgeDays(@javax.annotation.Nullable String maxAgeDays) {
  ...
  public SettingsServiceBetaPasswordExpirySettings expireWarnDays(@javax.annotation.Nullable String expireWarnDays) {
  ...
  public SettingsServiceBetaPasswordExpirySettings resourceOwnerType(@javax.annotation.Nullable SettingsServiceBetaResourceOwnerType resourceOwnerType) {
  ...
  public boolean equals(Object o) {
    ...
    SettingsServiceBetaPasswordExpirySettings settingsServiceBetaPasswordExpirySettings = (SettingsServiceBetaPasswordExpirySettings) o;
    return Objects.equals(this.maxAgeDays, settingsServiceBetaPasswordExpirySettings.maxAgeDays) &&
        Objects.equals(this.expireWarnDays, settingsServiceBetaPasswordExpirySettings.expireWarnDays) &&
        Objects.equals(this.resourceOwnerType, settingsServiceBetaPasswordExpirySettings.resourceOwnerType);
  }
  ...
  public String toString() {
    ...
    sb.append("class SettingsServiceBetaPasswordExpirySettings {\n");
