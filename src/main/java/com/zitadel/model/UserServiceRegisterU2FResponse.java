...
public class UserServiceRegisterU2FResponse {
  ...
  public UserServiceRegisterU2FResponse publicKeyCredentialCreationOptions(@javax.annotation.Nullable Map<String, UserServiceValue> publicKeyCredentialCreationOptions) {
    
    this.publicKeyCredentialCreationOptions = publicKeyCredentialCreationOptions;
    return this;
  }

  public UserServiceRegisterU2FResponse putPublicKeyCredentialCreationOptionsItem(String key, UserServiceValue publicKeyCredentialCreationOptionsItem) {
