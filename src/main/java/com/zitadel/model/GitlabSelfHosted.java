 ...
 */
@JsonPropertyOrder({
  GitlabSelfHosted.JSON_PROPERTY_GITLAB_SELF_HOSTED
})
@JsonTypeName("gitlab_self_hosted")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class GitlabSelfHosted {
  ...
  public GitlabSelfHosted() {
  }

  public GitlabSelfHosted gitlabSelfHosted(@javax.annotation.Nonnull IdentityProviderServiceGitLabSelfHostedConfig gitlabSelfHosted) {
  ...
  public boolean equals(Object o) {
    ...
    GitlabSelfHosted gitlabSelfHosted = (GitlabSelfHosted) o;
    return Objects.equals(this.gitlabSelfHosted, gitlabSelfHosted.gitlabSelfHosted);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gitlabSelfHosted);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GitlabSelfHosted {\n");
