...
public class ApplicationServicePaginationResponse {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ApplicationServicePaginationResponse other)) {
      return false;
    }
    return java.util.Objects.equals(this.totalResult, other.totalResult)
        && java.util.Objects.equals(this.appliedLimit, other.appliedLimit);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(totalResult, appliedLimit);
  }
}
