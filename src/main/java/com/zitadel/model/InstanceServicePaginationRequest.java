 ...
 */
@JsonPropertyOrder({
  InstanceServicePaginationRequest.JSON_PROPERTY_OFFSET,
  InstanceServicePaginationRequest.JSON_PROPERTY_LIMIT,
  InstanceServicePaginationRequest.JSON_PROPERTY_ASC
})
@javax.annotation.Generated(value = "io.github.mridang.codegen.generators.java.BetterJavaCodegen", comments = "Generator version: 7.14.0")
public class InstanceServicePaginationRequest {
  ...
  public InstanceServicePaginationRequest() {
  }

  public InstanceServicePaginationRequest offset(@javax.annotation.Nullable Object offset) {
  ...
  public InstanceServicePaginationRequest limit(@javax.annotation.Nullable Integer limit) {
  ...
  public InstanceServicePaginationRequest asc(@javax.annotation.Nullable Boolean asc) {
  ...
  public boolean equals(Object o) {
    ...
    InstanceServicePaginationRequest instanceServicePaginationRequest = (InstanceServicePaginationRequest) o;
    return equalsNullable(this.offset, instanceServicePaginationRequest.offset) &&
        Objects.equals(this.limit, instanceServicePaginationRequest.limit) &&
        Objects.equals(this.asc, instanceServicePaginationRequest.asc);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstanceServicePaginationRequest {\n");
