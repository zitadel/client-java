...
/**
 * SettingsServiceBetaListDetails
 */
@JsonPropertyOrder({
  SettingsServiceBetaListDetails.JSON_PROPERTY_TOTAL_RESULT,
  SettingsServiceBetaListDetails.JSON_PROPERTY_PROCESSED_SEQUENCE,
  SettingsServiceBetaListDetails.JSON_PROPERTY_TIMESTAMP
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class SettingsServiceBetaListDetails {
  ...
  public SettingsServiceBetaListDetails() {
  }

  public SettingsServiceBetaListDetails totalResult(@javax.annotation.Nullable String totalResult) {
  ...
  public SettingsServiceBetaListDetails processedSequence(@javax.annotation.Nullable String processedSequence) {
  ...
  public SettingsServiceBetaListDetails timestamp(@javax.annotation.Nullable OffsetDateTime timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    SettingsServiceBetaListDetails settingsServiceBetaListDetails = (SettingsServiceBetaListDetails) o;
    return Objects.equals(this.totalResult, settingsServiceBetaListDetails.totalResult) &&
        Objects.equals(this.processedSequence, settingsServiceBetaListDetails.processedSequence) &&
        Objects.equals(this.timestamp, settingsServiceBetaListDetails.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class SettingsServiceBetaListDetails {\n");
