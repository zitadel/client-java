...
public class UserServicePersonalAccessTokensSearchFilter {
  ...
  /** The {@code tokenIdFilter} property. */
  @JsonProperty("tokenIdFilter")
  @Nullable
  public UserServiceIDFilter tokenIdFilter;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof UserServicePersonalAccessTokensSearchFilter other)) {
      return false;
    }
    return java.util.Objects.equals(this.createdDateFilter, other.createdDateFilter)
        ...
        && java.util.Objects.equals(this.tokenIdFilter, other.tokenIdFilter)
  ...
  public int hashCode() {
    return java.util.Objects.hash(
        createdDateFilter, expirationDateFilter, organizationIdFilter, tokenIdFilter, userIdFilter);
  }
}
