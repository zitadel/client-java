...
public class BetaAuthorizationServiceListAuthorizationsRequest {
  ...
  @Nullable
  public BetaAuthorizationServicePaginationRequest pagination;

  /** Example: {@code null} */
  @JsonProperty("sortingColumn")
  @Nullable
  public BetaAuthorizationServiceAuthorizationFieldName sortingColumn;
  ...
  @Nullable
  public List<BetaAuthorizationServiceAuthorizationsSearchFilter> filters = new ArrayList<>();
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaAuthorizationServiceListAuthorizationsRequest other)) {
      return false;
    }
