 ...
 */
@JsonPropertyOrder({
  V2LockoutSettings.JSON_PROPERTY_MAX_PASSWORD_ATTEMPTS,
  V2LockoutSettings.JSON_PROPERTY_RESOURCE_OWNER_TYPE,
  V2LockoutSettings.JSON_PROPERTY_MAX_OTP_ATTEMPTS
})
@JsonTypeName("v2LockoutSettings")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2LockoutSettings {
  ...
  public V2LockoutSettings() {
  }

  public V2LockoutSettings maxPasswordAttempts(@javax.annotation.Nullable String maxPasswordAttempts) {
  ...
  public V2LockoutSettings resourceOwnerType(@javax.annotation.Nullable V2ResourceOwnerType resourceOwnerType) {
  ...
  public V2LockoutSettings maxOtpAttempts(@javax.annotation.Nullable String maxOtpAttempts) {
  ...
  public boolean equals(Object o) {
    ...
    V2LockoutSettings v2LockoutSettings = (V2LockoutSettings) o;
    return Objects.equals(this.maxPasswordAttempts, v2LockoutSettings.maxPasswordAttempts) &&
        Objects.equals(this.resourceOwnerType, v2LockoutSettings.resourceOwnerType) &&
        Objects.equals(this.maxOtpAttempts, v2LockoutSettings.maxOtpAttempts);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2LockoutSettings {\n");
