 ...
 */
@JsonPropertyOrder({
  FirstNameQuery.JSON_PROPERTY_FIRST_NAME_QUERY
})
@JsonTypeName("first_name_query")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class FirstNameQuery {
  ...
  public FirstNameQuery firstNameQuery(@javax.annotation.Nonnull UserServiceFirstNameQuery firstNameQuery) {
  ...
  public boolean equals(Object o) {
    ...
    FirstNameQuery firstNameQuery = (FirstNameQuery) o;
    return Objects.equals(this.firstNameQuery, firstNameQuery.firstNameQuery);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirstNameQuery {\n");
