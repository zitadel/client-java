...
public enum BetaSessionServiceSessionFieldName {
  ...
  /** The {@code "SESSION_FIELD_NAME_CREATION_DATE"} value. */
  SESSION_FIELD_NAME_CREATION_DATE("SESSION_FIELD_NAME_CREATION_DATE");

  private final String value;

  BetaSessionServiceSessionFieldName(String value) {
    this.value = value;
  }
  ...
  public static BetaSessionServiceSessionFieldName fromValue(String value) {
    for (BetaSessionServiceSessionFieldName b : values()) {
