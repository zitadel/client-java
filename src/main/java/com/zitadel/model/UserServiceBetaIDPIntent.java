...
/**
 * UserServiceBetaIDPIntent
 */
@JsonPropertyOrder({
  UserServiceBetaIDPIntent.JSON_PROPERTY_IDP_INTENT_ID,
  UserServiceBetaIDPIntent.JSON_PROPERTY_IDP_INTENT_TOKEN,
  UserServiceBetaIDPIntent.JSON_PROPERTY_USER_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class UserServiceBetaIDPIntent {
  ...
  public UserServiceBetaIDPIntent() {
  }

  public UserServiceBetaIDPIntent idpIntentId(@javax.annotation.Nullable String idpIntentId) {
  ...
  public UserServiceBetaIDPIntent idpIntentToken(@javax.annotation.Nullable String idpIntentToken) {
  ...
  public UserServiceBetaIDPIntent userId(@javax.annotation.Nullable String userId) {
  ...
  public boolean equals(Object o) {
    ...
    UserServiceBetaIDPIntent userServiceBetaIDPIntent = (UserServiceBetaIDPIntent) o;
    return Objects.equals(this.idpIntentId, userServiceBetaIDPIntent.idpIntentId) &&
        Objects.equals(this.idpIntentToken, userServiceBetaIDPIntent.idpIntentToken) &&
        Objects.equals(this.userId, userServiceBetaIDPIntent.userId);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserServiceBetaIDPIntent {\n");
