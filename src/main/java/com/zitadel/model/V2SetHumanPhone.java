 ...
 */
@JsonPropertyOrder({
  V2SetHumanPhone.JSON_PROPERTY_PHONE,
  V2SetHumanPhone.JSON_PROPERTY_SEND_CODE,
  V2SetHumanPhone.JSON_PROPERTY_RETURN_CODE,
  V2SetHumanPhone.JSON_PROPERTY_IS_VERIFIED
})
@JsonTypeName("v2SetHumanPhone")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2SetHumanPhone {
  ...
  public V2SetHumanPhone() {
  }

  public V2SetHumanPhone phone(@javax.annotation.Nullable String phone) {
  ...
  public V2SetHumanPhone sendCode(@javax.annotation.Nullable Object sendCode) {
  ...
  public V2SetHumanPhone returnCode(@javax.annotation.Nullable Object returnCode) {
  ...
  public V2SetHumanPhone isVerified(@javax.annotation.Nullable Boolean isVerified) {
  ...
  public boolean equals(Object o) {
    ...
    V2SetHumanPhone v2SetHumanPhone = (V2SetHumanPhone) o;
    return Objects.equals(this.phone, v2SetHumanPhone.phone) &&
        Objects.equals(this.sendCode, v2SetHumanPhone.sendCode) &&
        Objects.equals(this.returnCode, v2SetHumanPhone.returnCode) &&
        Objects.equals(this.isVerified, v2SetHumanPhone.isVerified);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2SetHumanPhone {\n");
