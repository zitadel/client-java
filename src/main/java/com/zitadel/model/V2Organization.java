 ...
 */
@JsonPropertyOrder({
  V2Organization.JSON_PROPERTY_ORG_ID,
  V2Organization.JSON_PROPERTY_ORG_DOMAIN
})
@JsonTypeName("v2Organization")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2Organization {
  ...
  public V2Organization orgId(@javax.annotation.Nullable String orgId) {
  ...
  public V2Organization orgDomain(@javax.annotation.Nullable String orgDomain) {
  ...
  public boolean equals(Object o) {
    ...
    V2Organization v2Organization = (V2Organization) o;
    return Objects.equals(this.orgId, v2Organization.orgId) &&
        Objects.equals(this.orgDomain, v2Organization.orgDomain);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2Organization {\n");
