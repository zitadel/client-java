 ...
 */
@JsonPropertyOrder({
  V2ResendEmailCodeResponse.JSON_PROPERTY_DETAILS,
  V2ResendEmailCodeResponse.JSON_PROPERTY_VERIFICATION_CODE
})
@JsonTypeName("v2ResendEmailCodeResponse")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2ResendEmailCodeResponse {
  ...
  public V2ResendEmailCodeResponse() {
  }

  public V2ResendEmailCodeResponse details(@javax.annotation.Nullable V2Details details) {
  ...
  public V2ResendEmailCodeResponse verificationCode(@javax.annotation.Nullable String verificationCode) {
  ...
  public boolean equals(Object o) {
    ...
    V2ResendEmailCodeResponse v2ResendEmailCodeResponse = (V2ResendEmailCodeResponse) o;
    return Objects.equals(this.details, v2ResendEmailCodeResponse.details) &&
        Objects.equals(this.verificationCode, v2ResendEmailCodeResponse.verificationCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2ResendEmailCodeResponse {\n");
