 ...
 */
@JsonPropertyOrder({
  BetaUserServiceSetHumanProfile.JSON_PROPERTY_GIVEN_NAME,
  BetaUserServiceSetHumanProfile.JSON_PROPERTY_FAMILY_NAME,
  BetaUserServiceSetHumanProfile.JSON_PROPERTY_NICK_NAME,
  BetaUserServiceSetHumanProfile.JSON_PROPERTY_DISPLAY_NAME,
  BetaUserServiceSetHumanProfile.JSON_PROPERTY_PREFERRED_LANGUAGE,
  BetaUserServiceSetHumanProfile.JSON_PROPERTY_GENDER
})
@javax.annotation.Generated(value = "io.github.mridang.codegen.generators.java.BetterJavaCodegen", comments = "Generator version: 7.14.0")
public class BetaUserServiceSetHumanProfile {
  ...
  public BetaUserServiceSetHumanProfile() {
  }

  public BetaUserServiceSetHumanProfile givenName(@javax.annotation.Nullable String givenName) {
  ...
  public BetaUserServiceSetHumanProfile familyName(@javax.annotation.Nullable String familyName) {
  ...
  public BetaUserServiceSetHumanProfile nickName(@javax.annotation.Nullable String nickName) {
  ...
  public BetaUserServiceSetHumanProfile displayName(@javax.annotation.Nullable String displayName) {
  ...
  public BetaUserServiceSetHumanProfile preferredLanguage(@javax.annotation.Nullable String preferredLanguage) {
  ...
  public BetaUserServiceSetHumanProfile gender(@javax.annotation.Nullable BetaUserServiceGender gender) {
  ...
  public boolean equals(Object o) {
    ...
    BetaUserServiceSetHumanProfile betaUserServiceSetHumanProfile = (BetaUserServiceSetHumanProfile) o;
    return Objects.equals(this.givenName, betaUserServiceSetHumanProfile.givenName) &&
        Objects.equals(this.familyName, betaUserServiceSetHumanProfile.familyName) &&
        equalsNullable(this.nickName, betaUserServiceSetHumanProfile.nickName) &&
        equalsNullable(this.displayName, betaUserServiceSetHumanProfile.displayName) &&
        equalsNullable(this.preferredLanguage, betaUserServiceSetHumanProfile.preferredLanguage) &&
        Objects.equals(this.gender, betaUserServiceSetHumanProfile.gender);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(givenName, familyName, hashCodeNullable(nickName), hashCodeNullable(displayName), hashCodeNullable(preferredLanguage), gender);
  }
  ...
  public String toString() {
    ...
    sb.append("class BetaUserServiceSetHumanProfile {\n");
