 ...
 */
@JsonPropertyOrder({
  BetaProjectServicePaginationRequest.JSON_PROPERTY_OFFSET,
  BetaProjectServicePaginationRequest.JSON_PROPERTY_LIMIT,
  BetaProjectServicePaginationRequest.JSON_PROPERTY_ASC
})
@javax.annotation.Generated(value = "io.github.mridang.codegen.generators.java.BetterJavaCodegen", comments = "Generator version: 7.14.0")
public class BetaProjectServicePaginationRequest {
  ...
  public BetaProjectServicePaginationRequest() {
  }

  public BetaProjectServicePaginationRequest offset(@javax.annotation.Nullable Object offset) {
  ...
  public BetaProjectServicePaginationRequest limit(@javax.annotation.Nullable Integer limit) {
  ...
  public BetaProjectServicePaginationRequest asc(@javax.annotation.Nullable Boolean asc) {
  ...
  public boolean equals(Object o) {
    ...
    BetaProjectServicePaginationRequest betaProjectServicePaginationRequest = (BetaProjectServicePaginationRequest) o;
    return equalsNullable(this.offset, betaProjectServicePaginationRequest.offset) &&
        Objects.equals(this.limit, betaProjectServicePaginationRequest.limit) &&
        Objects.equals(this.asc, betaProjectServicePaginationRequest.asc);
  }
  ...
  public String toString() {
    ...
    sb.append("class BetaProjectServicePaginationRequest {\n");
