...
public class SAMLServicePostResponse {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SAMLServicePostResponse other)) {
      return false;
    }
    return java.util.Objects.equals(this.relayState, other.relayState)
        && java.util.Objects.equals(this.samlResponse, other.samlResponse);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(relayState, samlResponse);
  }
}
