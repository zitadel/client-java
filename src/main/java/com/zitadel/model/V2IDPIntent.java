 ...
 */
@JsonPropertyOrder({
  V2IDPIntent.JSON_PROPERTY_IDP_INTENT_ID,
  V2IDPIntent.JSON_PROPERTY_IDP_INTENT_TOKEN,
  V2IDPIntent.JSON_PROPERTY_USER_ID
})
@JsonTypeName("v2IDPIntent")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2IDPIntent {
  ...
  public V2IDPIntent idpIntentId(@javax.annotation.Nullable String idpIntentId) {
  ...
  public V2IDPIntent idpIntentToken(@javax.annotation.Nullable String idpIntentToken) {
  ...
  public V2IDPIntent userId(@javax.annotation.Nullable String userId) {
  ...
  public boolean equals(Object o) {
    ...
    V2IDPIntent v2IDPIntent = (V2IDPIntent) o;
    return Objects.equals(this.idpIntentId, v2IDPIntent.idpIntentId) &&
      Objects.equals(this.idpIntentToken, v2IDPIntent.idpIntentToken) &&
      Objects.equals(this.userId, v2IDPIntent.userId);
  }
