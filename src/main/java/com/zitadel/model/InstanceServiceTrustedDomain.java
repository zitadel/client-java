 ...
 */
@JsonPropertyOrder({
  InstanceServiceTrustedDomain.JSON_PROPERTY_INSTANCE_ID,
  InstanceServiceTrustedDomain.JSON_PROPERTY_CREATION_DATE,
  InstanceServiceTrustedDomain.JSON_PROPERTY_DOMAIN
})
@javax.annotation.Generated(value = "io.github.mridang.codegen.generators.java.BetterJavaCodegen", comments = "Generator version: 7.14.0")
public class InstanceServiceTrustedDomain {
  ...
  public InstanceServiceTrustedDomain() {
  }

  public InstanceServiceTrustedDomain instanceId(@javax.annotation.Nullable String instanceId) {
  ...
  public InstanceServiceTrustedDomain creationDate(@javax.annotation.Nullable OffsetDateTime creationDate) {
  ...
  public InstanceServiceTrustedDomain domain(@javax.annotation.Nullable String domain) {
  ...
  public boolean equals(Object o) {
    ...
    InstanceServiceTrustedDomain instanceServiceTrustedDomain = (InstanceServiceTrustedDomain) o;
    return Objects.equals(this.instanceId, instanceServiceTrustedDomain.instanceId) &&
        Objects.equals(this.creationDate, instanceServiceTrustedDomain.creationDate) &&
        Objects.equals(this.domain, instanceServiceTrustedDomain.domain);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstanceServiceTrustedDomain {\n");
