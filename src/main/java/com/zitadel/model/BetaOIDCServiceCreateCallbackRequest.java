...
public class BetaOIDCServiceCreateCallbackRequest {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaOIDCServiceCreateCallbackRequest other)) {
      return false;
    }
    return java.util.Objects.equals(this.authRequestId, other.authRequestId)
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(authRequestId, error, session);
  }
}
