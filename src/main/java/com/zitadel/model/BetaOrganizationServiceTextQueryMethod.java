...
public enum BetaOrganizationServiceTextQueryMethod {
  ...
  BetaOrganizationServiceTextQueryMethod(String value) {
    this.value = value;
  }
  ...
  public static BetaOrganizationServiceTextQueryMethod fromValue(String value) {
    for (BetaOrganizationServiceTextQueryMethod b : values()) {
