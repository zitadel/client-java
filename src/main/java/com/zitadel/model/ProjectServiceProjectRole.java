...
public class ProjectServiceProjectRole {
  ...
  /**
   * Key of the project role. The key identifies the role. It's the only relevant attribute for
   * ZITADEL and will be used for authorization checks and as claim in tokens and user info
   * responses.
   *
   * <p>Example: {@code null}
   */
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ProjectServiceProjectRole other)) {
      return false;
    }
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(projectId, key, creationDate, changeDate, displayName, group);
  }
}
