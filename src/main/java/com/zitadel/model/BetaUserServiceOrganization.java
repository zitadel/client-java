...
public class BetaUserServiceOrganization {
  ...
  public BetaUserServiceOrganization orgDomain(@javax.annotation.Nonnull String orgDomain) {
  ...
  public BetaUserServiceOrganization orgId(@javax.annotation.Nonnull String orgId) {
