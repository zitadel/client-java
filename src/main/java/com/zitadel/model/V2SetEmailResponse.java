 ...
 */
@JsonPropertyOrder({
  V2SetEmailResponse.JSON_PROPERTY_DETAILS,
  V2SetEmailResponse.JSON_PROPERTY_VERIFICATION_CODE
})
@JsonTypeName("v2SetEmailResponse")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2SetEmailResponse {
  ...
  public V2SetEmailResponse() {
  }

  public V2SetEmailResponse details(@javax.annotation.Nullable V2Details details) {
  ...
  public V2SetEmailResponse verificationCode(@javax.annotation.Nullable String verificationCode) {
  ...
  public boolean equals(Object o) {
    ...
    V2SetEmailResponse v2SetEmailResponse = (V2SetEmailResponse) o;
    return Objects.equals(this.details, v2SetEmailResponse.details) &&
        Objects.equals(this.verificationCode, v2SetEmailResponse.verificationCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2SetEmailResponse {\n");
