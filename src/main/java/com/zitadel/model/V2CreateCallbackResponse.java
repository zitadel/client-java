 ...
 */
@JsonPropertyOrder({
  V2CreateCallbackResponse.JSON_PROPERTY_DETAILS,
  V2CreateCallbackResponse.JSON_PROPERTY_CALLBACK_URL
})
@JsonTypeName("v2CreateCallbackResponse")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2CreateCallbackResponse {
  ...
  public V2CreateCallbackResponse() {
  }

  public V2CreateCallbackResponse details(@javax.annotation.Nullable V2Details details) {
  ...
  public V2CreateCallbackResponse callbackUrl(@javax.annotation.Nullable String callbackUrl) {
  ...
  public boolean equals(Object o) {
    ...
    V2CreateCallbackResponse v2CreateCallbackResponse = (V2CreateCallbackResponse) o;
    return Objects.equals(this.details, v2CreateCallbackResponse.details) &&
      Objects.equals(this.callbackUrl, v2CreateCallbackResponse.callbackUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2CreateCallbackResponse {\n");
