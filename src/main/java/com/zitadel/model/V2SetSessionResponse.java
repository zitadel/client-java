 ...
 */
@JsonPropertyOrder({
  V2SetSessionResponse.JSON_PROPERTY_DETAILS,
  V2SetSessionResponse.JSON_PROPERTY_SESSION_TOKEN,
  V2SetSessionResponse.JSON_PROPERTY_CHALLENGES
})
@JsonTypeName("v2SetSessionResponse")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2SetSessionResponse {
  ...
  public V2SetSessionResponse() {
  }

  public V2SetSessionResponse details(@javax.annotation.Nullable V2Details details) {
  ...
  public V2SetSessionResponse sessionToken(@javax.annotation.Nullable String sessionToken) {
  ...
  public V2SetSessionResponse challenges(@javax.annotation.Nullable V2Challenges challenges) {
  ...
  public boolean equals(Object o) {
    ...
    V2SetSessionResponse v2SetSessionResponse = (V2SetSessionResponse) o;
    return Objects.equals(this.details, v2SetSessionResponse.details) &&
        Objects.equals(this.sessionToken, v2SetSessionResponse.sessionToken) &&
        Objects.equals(this.challenges, v2SetSessionResponse.challenges);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2SetSessionResponse {\n");
