...
/**
 * FeatureServiceSetSystemFeaturesRequest1
 */
@JsonPropertyOrder({
  FeatureServiceSetSystemFeaturesRequest1.JSON_PROPERTY_LOGIN_DEFAULT_ORG,
  FeatureServiceSetSystemFeaturesRequest1.JSON_PROPERTY_OIDC_TRIGGER_INTROSPECTION_PROJECTIONS,
  FeatureServiceSetSystemFeaturesRequest1.JSON_PROPERTY_OIDC_LEGACY_INTROSPECTION,
  FeatureServiceSetSystemFeaturesRequest1.JSON_PROPERTY_USER_SCHEMA,
  FeatureServiceSetSystemFeaturesRequest1.JSON_PROPERTY_OIDC_TOKEN_EXCHANGE,
  FeatureServiceSetSystemFeaturesRequest1.JSON_PROPERTY_ACTIONS,
  FeatureServiceSetSystemFeaturesRequest1.JSON_PROPERTY_IMPROVED_PERFORMANCE,
  FeatureServiceSetSystemFeaturesRequest1.JSON_PROPERTY_OIDC_SINGLE_V1_SESSION_TERMINATION,
  FeatureServiceSetSystemFeaturesRequest1.JSON_PROPERTY_DISABLE_USER_TOKEN_EVENT,
  FeatureServiceSetSystemFeaturesRequest1.JSON_PROPERTY_ENABLE_BACK_CHANNEL_LOGOUT,
  FeatureServiceSetSystemFeaturesRequest1.JSON_PROPERTY_LOGIN_V2,
  FeatureServiceSetSystemFeaturesRequest1.JSON_PROPERTY_PERMISSION_CHECK_V2
})
@JsonTypeName("FeatureServiceSetSystemFeaturesRequest_1")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class FeatureServiceSetSystemFeaturesRequest1 {
  ...
  public FeatureServiceSetSystemFeaturesRequest1() {
  }

  public FeatureServiceSetSystemFeaturesRequest1 loginDefaultOrg(@javax.annotation.Nullable Boolean loginDefaultOrg) {
  ...
  public FeatureServiceSetSystemFeaturesRequest1 oidcTriggerIntrospectionProjections(@javax.annotation.Nullable Boolean oidcTriggerIntrospectionProjections) {
  ...
  public FeatureServiceSetSystemFeaturesRequest1 oidcLegacyIntrospection(@javax.annotation.Nullable Boolean oidcLegacyIntrospection) {
  ...
  public FeatureServiceSetSystemFeaturesRequest1 userSchema(@javax.annotation.Nullable Boolean userSchema) {
  ...
  public FeatureServiceSetSystemFeaturesRequest1 oidcTokenExchange(@javax.annotation.Nullable Boolean oidcTokenExchange) {
  ...
  public FeatureServiceSetSystemFeaturesRequest1 actions(@javax.annotation.Nullable Boolean actions) {
  ...
  public FeatureServiceSetSystemFeaturesRequest1 improvedPerformance(@javax.annotation.Nullable List<FeatureServiceImprovedPerformance> improvedPerformance) {
    
    this.improvedPerformance = improvedPerformance;
    return this;
  }

  public FeatureServiceSetSystemFeaturesRequest1 addImprovedPerformanceItem(FeatureServiceImprovedPerformance improvedPerformanceItem) {
  ...
  public FeatureServiceSetSystemFeaturesRequest1 oidcSingleV1SessionTermination(@javax.annotation.Nullable Boolean oidcSingleV1SessionTermination) {
  ...
  public FeatureServiceSetSystemFeaturesRequest1 disableUserTokenEvent(@javax.annotation.Nullable Boolean disableUserTokenEvent) {
  ...
  public FeatureServiceSetSystemFeaturesRequest1 enableBackChannelLogout(@javax.annotation.Nullable Boolean enableBackChannelLogout) {
  ...
  public FeatureServiceSetSystemFeaturesRequest1 loginV2(@javax.annotation.Nullable FeatureServiceLoginV2 loginV2) {
  ...
  public FeatureServiceSetSystemFeaturesRequest1 permissionCheckV2(@javax.annotation.Nullable Boolean permissionCheckV2) {
  ...
  public boolean equals(Object o) {
    ...
    FeatureServiceSetSystemFeaturesRequest1 featureServiceSetSystemFeaturesRequest1 = (FeatureServiceSetSystemFeaturesRequest1) o;
    return Objects.equals(this.loginDefaultOrg, featureServiceSetSystemFeaturesRequest1.loginDefaultOrg) &&
        Objects.equals(this.oidcTriggerIntrospectionProjections, featureServiceSetSystemFeaturesRequest1.oidcTriggerIntrospectionProjections) &&
        Objects.equals(this.oidcLegacyIntrospection, featureServiceSetSystemFeaturesRequest1.oidcLegacyIntrospection) &&
        Objects.equals(this.userSchema, featureServiceSetSystemFeaturesRequest1.userSchema) &&
        Objects.equals(this.oidcTokenExchange, featureServiceSetSystemFeaturesRequest1.oidcTokenExchange) &&
        Objects.equals(this.actions, featureServiceSetSystemFeaturesRequest1.actions) &&
        Objects.equals(this.improvedPerformance, featureServiceSetSystemFeaturesRequest1.improvedPerformance) &&
        Objects.equals(this.oidcSingleV1SessionTermination, featureServiceSetSystemFeaturesRequest1.oidcSingleV1SessionTermination) &&
        Objects.equals(this.disableUserTokenEvent, featureServiceSetSystemFeaturesRequest1.disableUserTokenEvent) &&
        Objects.equals(this.enableBackChannelLogout, featureServiceSetSystemFeaturesRequest1.enableBackChannelLogout) &&
        Objects.equals(this.loginV2, featureServiceSetSystemFeaturesRequest1.loginV2) &&
        Objects.equals(this.permissionCheckV2, featureServiceSetSystemFeaturesRequest1.permissionCheckV2);
  }
  ...
  public String toString() {
    ...
    sb.append("class FeatureServiceSetSystemFeaturesRequest1 {\n");
