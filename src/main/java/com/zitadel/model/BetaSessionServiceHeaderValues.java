...
/**
 * A header may have multiple values. In Go, headers are defined as map[string][]string, but
 * protobuf doesn't allow this scheme.
 */
@SuppressWarnings({
...
public class BetaSessionServiceHeaderValues {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaSessionServiceHeaderValues other)) {
      return false;
    }
