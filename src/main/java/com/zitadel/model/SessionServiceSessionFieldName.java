...
public enum SessionServiceSessionFieldName {
  ...
  SessionServiceSessionFieldName(String value) {
    this.value = value;
  }
  ...
  public static SessionServiceSessionFieldName fromValue(String value) {
    for (SessionServiceSessionFieldName b : values()) {
