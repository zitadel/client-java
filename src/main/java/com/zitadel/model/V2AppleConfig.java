 ...
 */
@JsonPropertyOrder({
  V2AppleConfig.JSON_PROPERTY_CLIENT_ID,
  V2AppleConfig.JSON_PROPERTY_TEAM_ID,
  V2AppleConfig.JSON_PROPERTY_KEY_ID,
  V2AppleConfig.JSON_PROPERTY_SCOPES
})
@JsonTypeName("v2AppleConfig")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2AppleConfig {
  ...
  public V2AppleConfig() {
  }

  public V2AppleConfig clientId(@javax.annotation.Nullable String clientId) {
  ...
  public V2AppleConfig teamId(@javax.annotation.Nullable String teamId) {
  ...
  public V2AppleConfig keyId(@javax.annotation.Nullable String keyId) {
  ...
  public V2AppleConfig scopes(@javax.annotation.Nullable List<String> scopes) {
    
    this.scopes = scopes;
    return this;
  }

  public V2AppleConfig addScopesItem(String scopesItem) {
    if (this.scopes == null) {
  ...
  public boolean equals(Object o) {
    ...
    V2AppleConfig v2AppleConfig = (V2AppleConfig) o;
    return Objects.equals(this.clientId, v2AppleConfig.clientId) &&
        Objects.equals(this.teamId, v2AppleConfig.teamId) &&
        Objects.equals(this.keyId, v2AppleConfig.keyId) &&
        Objects.equals(this.scopes, v2AppleConfig.scopes);
  }
