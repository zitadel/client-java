...
public class ActionServiceTarget {
  ...
  /**
   * The current signing key used to sign the request sent to the target. The key can be used to
   * verify the integrity and authenticity of the request on the receiver side. The key should be
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ActionServiceTarget other)) {
      return false;
    }
