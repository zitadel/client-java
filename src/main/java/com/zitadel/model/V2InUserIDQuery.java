 ...
 */
@JsonPropertyOrder({
  V2InUserIDQuery.JSON_PROPERTY_USER_IDS
})
@JsonTypeName("v2InUserIDQuery")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2InUserIDQuery {
  public static final String JSON_PROPERTY_USER_IDS = "userIds";
  @javax.annotation.Nullable
  private List<String> userIds = new ArrayList<>();

  public V2InUserIDQuery() {
  }

  public V2InUserIDQuery userIds(@javax.annotation.Nullable List<String> userIds) {
    
    this.userIds = userIds;
    return this;
  }

  public V2InUserIDQuery addUserIdsItem(String userIdsItem) {
  ...
  public boolean equals(Object o) {
    ...
    V2InUserIDQuery v2InUserIDQuery = (V2InUserIDQuery) o;
    return Objects.equals(this.userIds, v2InUserIDQuery.userIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2InUserIDQuery {\n");
