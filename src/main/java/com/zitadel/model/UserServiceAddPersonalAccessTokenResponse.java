...
public class UserServiceAddPersonalAccessTokenResponse {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof UserServiceAddPersonalAccessTokenResponse other)) {
      return false;
    }
    return java.util.Objects.equals(this.creationDate, other.creationDate)
        && java.util.Objects.equals(this.tokenId, other.tokenId)
        && java.util.Objects.equals(this.token, other.token);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(creationDate, tokenId, token);
  }
}
