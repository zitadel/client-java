 ...
 */
@JsonPropertyOrder({
  IdentityProviderServiceAppleConfig.JSON_PROPERTY_CLIENT_ID,
  IdentityProviderServiceAppleConfig.JSON_PROPERTY_TEAM_ID,
...
public class IdentityProviderServiceAppleConfig {
  ...
  public IdentityProviderServiceAppleConfig clientId(@javax.annotation.Nullable String clientId) {
  ...
  public IdentityProviderServiceAppleConfig teamId(@javax.annotation.Nullable String teamId) {
  ...
  public IdentityProviderServiceAppleConfig keyId(@javax.annotation.Nullable String keyId) {
  ...
  public IdentityProviderServiceAppleConfig scopes(@javax.annotation.Nullable List<String> scopes) {
    
    this.scopes = scopes;
    return this;
  }

  public IdentityProviderServiceAppleConfig addScopesItem(String scopesItem) {
    if (this.scopes == null) {
  ...
  public boolean equals(Object o) {
    ...
    IdentityProviderServiceAppleConfig identityProviderServiceAppleConfig = (IdentityProviderServiceAppleConfig) o;
    return Objects.equals(this.clientId, identityProviderServiceAppleConfig.clientId) &&
        Objects.equals(this.teamId, identityProviderServiceAppleConfig.teamId) &&
        Objects.equals(this.keyId, identityProviderServiceAppleConfig.keyId) &&
        Objects.equals(this.scopes, identityProviderServiceAppleConfig.scopes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientId, teamId, keyId, scopes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IdentityProviderServiceAppleConfig {\n");
