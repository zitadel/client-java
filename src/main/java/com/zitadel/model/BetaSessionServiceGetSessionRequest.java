 ...
 */
@JsonPropertyOrder({
  BetaSessionServiceGetSessionRequest.JSON_PROPERTY_SESSION_ID,
  BetaSessionServiceGetSessionRequest.JSON_PROPERTY_SESSION_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class BetaSessionServiceGetSessionRequest {
  ...
  public BetaSessionServiceGetSessionRequest() {
  }

  public BetaSessionServiceGetSessionRequest sessionId(@javax.annotation.Nullable String sessionId) {
  ...
  public BetaSessionServiceGetSessionRequest sessionToken(@javax.annotation.Nullable String sessionToken) {
  ...
  public boolean equals(Object o) {
    ...
    BetaSessionServiceGetSessionRequest betaSessionServiceGetSessionRequest = (BetaSessionServiceGetSessionRequest) o;
    return Objects.equals(this.sessionId, betaSessionServiceGetSessionRequest.sessionId) &&
        equalsNullable(this.sessionToken, betaSessionServiceGetSessionRequest.sessionToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class BetaSessionServiceGetSessionRequest {\n");
