...
public class BetaSessionServiceUserFactor {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaSessionServiceUserFactor other)) {
      return false;
    }
    return java.util.Objects.equals(this.verifiedAt, other.verifiedAt)
        && java.util.Objects.equals(this.id, other.id)
        && java.util.Objects.equals(this.loginName, other.loginName)
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(verifiedAt, id, loginName, displayName, organizationId);
  }
}
