 ...
 */
@JsonPropertyOrder({
  BetaActionServicePaginationRequest.JSON_PROPERTY_OFFSET,
  BetaActionServicePaginationRequest.JSON_PROPERTY_LIMIT,
  BetaActionServicePaginationRequest.JSON_PROPERTY_ASC
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class BetaActionServicePaginationRequest {
  ...
  public BetaActionServicePaginationRequest() {
  }

  public BetaActionServicePaginationRequest offset(@javax.annotation.Nullable Object offset) {
  ...
  public BetaActionServicePaginationRequest limit(@javax.annotation.Nullable Integer limit) {
  ...
  public BetaActionServicePaginationRequest asc(@javax.annotation.Nullable Boolean asc) {
  ...
  public boolean equals(Object o) {
    ...
    BetaActionServicePaginationRequest betaActionServicePaginationRequest = (BetaActionServicePaginationRequest) o;
    return equalsNullable(this.offset, betaActionServicePaginationRequest.offset) &&
        Objects.equals(this.limit, betaActionServicePaginationRequest.limit) &&
        Objects.equals(this.asc, betaActionServicePaginationRequest.asc);
  }
  ...
  public String toString() {
    ...
    sb.append("class BetaActionServicePaginationRequest {\n");
