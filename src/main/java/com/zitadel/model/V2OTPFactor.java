 ...
 */
@JsonPropertyOrder({
  V2OTPFactor.JSON_PROPERTY_VERIFIED_AT
})
@JsonTypeName("v2OTPFactor")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2OTPFactor {
  ...
  public V2OTPFactor verifiedAt(@javax.annotation.Nullable OffsetDateTime verifiedAt) {
  ...
  public boolean equals(Object o) {
    ...
    V2OTPFactor v2OTPFactor = (V2OTPFactor) o;
    return Objects.equals(this.verifiedAt, v2OTPFactor.verifiedAt);
  }
