...
public enum InstanceServiceTextQueryMethod {
  ...
  InstanceServiceTextQueryMethod(String value) {
    this.value = value;
  }
  ...
  public static InstanceServiceTextQueryMethod fromValue(String value) {
    for (InstanceServiceTextQueryMethod b : values()) {
