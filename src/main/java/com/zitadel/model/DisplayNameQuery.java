 ...
 */
@JsonPropertyOrder({
  DisplayNameQuery.JSON_PROPERTY_DISPLAY_NAME_QUERY
})
@JsonTypeName("display_name_query")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class DisplayNameQuery {
  ...
  public DisplayNameQuery displayNameQuery(@javax.annotation.Nonnull UserServiceDisplayNameQuery displayNameQuery) {
  ...
  public boolean equals(Object o) {
    ...
    DisplayNameQuery displayNameQuery = (DisplayNameQuery) o;
    return Objects.equals(this.displayNameQuery, displayNameQuery.displayNameQuery);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisplayNameQuery {\n");
