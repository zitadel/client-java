...
public class ApplicationServiceCreateApplicationResponse {
  ...
  @Nullable
  public ApplicationServiceCreateAPIApplicationResponse apiConfiguration;

  /** Example: {@code null} */
  @JsonProperty("oidcConfiguration")
  @Nullable
  public ApplicationServiceCreateOIDCApplicationResponse oidcConfiguration;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ApplicationServiceCreateApplicationResponse other)) {
      return false;
    }
  ...
  public int hashCode() {
    return java.util.Objects.hash(
        applicationId, creationDate, apiConfiguration, oidcConfiguration, samlConfiguration);
  }
}
