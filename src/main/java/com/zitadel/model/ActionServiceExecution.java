...
public class ActionServiceExecution {
  ...
  @Nullable
  public ActionServiceCondition condition;
  ...
  /**
   * Ordered list of targets called during the execution. The order of the targets in this list
   * defines the order of execution. If one of the targets fails, depending on the target's type and
   * settings, the execution might be interrupted and the following targets will not be called.
   *
   * <p>Example: {@code null}
   */
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ActionServiceExecution other)) {
      return false;
    }
