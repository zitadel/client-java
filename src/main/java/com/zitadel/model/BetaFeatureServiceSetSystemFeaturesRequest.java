...
@JsonPropertyOrder({
  ...
  BetaFeatureServiceSetSystemFeaturesRequest.JSON_PROPERTY_OIDC_TRIGGER_INTROSPECTION_PROJECTIONS,
  BetaFeatureServiceSetSystemFeaturesRequest.JSON_PROPERTY_OIDC_LEGACY_INTROSPECTION,
...
public class BetaFeatureServiceSetSystemFeaturesRequest {
  ...
  public BetaFeatureServiceSetSystemFeaturesRequest oidcTriggerIntrospectionProjections(@javax.annotation.Nullable Boolean oidcTriggerIntrospectionProjections) {
  ...
  public BetaFeatureServiceSetSystemFeaturesRequest oidcLegacyIntrospection(@javax.annotation.Nullable Boolean oidcLegacyIntrospection) {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.loginDefaultOrg, betaFeatureServiceSetSystemFeaturesRequest.loginDefaultOrg) &&
        equalsNullable(this.oidcTriggerIntrospectionProjections, betaFeatureServiceSetSystemFeaturesRequest.oidcTriggerIntrospectionProjections) &&
        equalsNullable(this.oidcLegacyIntrospection, betaFeatureServiceSetSystemFeaturesRequest.oidcLegacyIntrospection) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(loginDefaultOrg), hashCodeNullable(oidcTriggerIntrospectionProjections), hashCodeNullable(oidcLegacyIntrospection), hashCodeNullable(userSchema), hashCodeNullable(oidcTokenExchange), improvedPerformance, hashCodeNullable(oidcSingleV1SessionTermination));
  }
