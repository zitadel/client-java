...
public class UserServiceCreateUserRequest {
  ...
  public UserServiceCreateUserRequest human(@javax.annotation.Nonnull UserServiceHuman human) {
  ...
  public UserServiceCreateUserRequest machine(@javax.annotation.Nonnull UserServiceMachine machine) {
