...
public class UserServiceSetPhoneRequest {
  ...
  public UserServiceSetPhoneRequest userId(@javax.annotation.Nullable String userId) {
  ...
  public UserServiceSetPhoneRequest phone(@javax.annotation.Nullable String phone) {
