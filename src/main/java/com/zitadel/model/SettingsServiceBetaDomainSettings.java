...
/**
 * SettingsServiceBetaDomainSettings
 */
@JsonPropertyOrder({
  SettingsServiceBetaDomainSettings.JSON_PROPERTY_LOGIN_NAME_INCLUDES_DOMAIN,
  SettingsServiceBetaDomainSettings.JSON_PROPERTY_REQUIRE_ORG_DOMAIN_VERIFICATION,
  SettingsServiceBetaDomainSettings.JSON_PROPERTY_SMTP_SENDER_ADDRESS_MATCHES_INSTANCE_DOMAIN,
  SettingsServiceBetaDomainSettings.JSON_PROPERTY_RESOURCE_OWNER_TYPE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class SettingsServiceBetaDomainSettings {
  ...
  public SettingsServiceBetaDomainSettings() {
  }

  public SettingsServiceBetaDomainSettings loginNameIncludesDomain(@javax.annotation.Nullable Boolean loginNameIncludesDomain) {
  ...
  public SettingsServiceBetaDomainSettings requireOrgDomainVerification(@javax.annotation.Nullable Boolean requireOrgDomainVerification) {
  ...
  public SettingsServiceBetaDomainSettings smtpSenderAddressMatchesInstanceDomain(@javax.annotation.Nullable Boolean smtpSenderAddressMatchesInstanceDomain) {
  ...
  public SettingsServiceBetaDomainSettings resourceOwnerType(@javax.annotation.Nullable SettingsServiceBetaResourceOwnerType resourceOwnerType) {
  ...
  public boolean equals(Object o) {
    ...
    SettingsServiceBetaDomainSettings settingsServiceBetaDomainSettings = (SettingsServiceBetaDomainSettings) o;
    return Objects.equals(this.loginNameIncludesDomain, settingsServiceBetaDomainSettings.loginNameIncludesDomain) &&
        Objects.equals(this.requireOrgDomainVerification, settingsServiceBetaDomainSettings.requireOrgDomainVerification) &&
        Objects.equals(this.smtpSenderAddressMatchesInstanceDomain, settingsServiceBetaDomainSettings.smtpSenderAddressMatchesInstanceDomain) &&
        Objects.equals(this.resourceOwnerType, settingsServiceBetaDomainSettings.resourceOwnerType);
  }
  ...
  public String toString() {
    ...
    sb.append("class SettingsServiceBetaDomainSettings {\n");
