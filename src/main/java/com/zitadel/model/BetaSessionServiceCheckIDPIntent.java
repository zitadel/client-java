 ...
 */
@JsonPropertyOrder({
  BetaSessionServiceCheckIDPIntent.JSON_PROPERTY_IDP_INTENT_ID,
  BetaSessionServiceCheckIDPIntent.JSON_PROPERTY_IDP_INTENT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class BetaSessionServiceCheckIDPIntent {
  ...
  public BetaSessionServiceCheckIDPIntent() {
  }

  public BetaSessionServiceCheckIDPIntent idpIntentId(@javax.annotation.Nullable String idpIntentId) {
  ...
  public BetaSessionServiceCheckIDPIntent idpIntentToken(@javax.annotation.Nullable String idpIntentToken) {
  ...
  public boolean equals(Object o) {
    ...
    BetaSessionServiceCheckIDPIntent betaSessionServiceCheckIDPIntent = (BetaSessionServiceCheckIDPIntent) o;
    return Objects.equals(this.idpIntentId, betaSessionServiceCheckIDPIntent.idpIntentId) &&
        Objects.equals(this.idpIntentToken, betaSessionServiceCheckIDPIntent.idpIntentToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class BetaSessionServiceCheckIDPIntent {\n");
