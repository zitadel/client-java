 ...
 */
@JsonPropertyOrder({
  V2AuthRequest.JSON_PROPERTY_ID,
  V2AuthRequest.JSON_PROPERTY_CREATION_DATE,
  V2AuthRequest.JSON_PROPERTY_CLIENT_ID,
  V2AuthRequest.JSON_PROPERTY_SCOPE,
  V2AuthRequest.JSON_PROPERTY_REDIRECT_URI,
  V2AuthRequest.JSON_PROPERTY_PROMPT,
  V2AuthRequest.JSON_PROPERTY_UI_LOCALES,
  V2AuthRequest.JSON_PROPERTY_LOGIN_HINT,
  V2AuthRequest.JSON_PROPERTY_MAX_AGE,
  V2AuthRequest.JSON_PROPERTY_HINT_USER_ID
})
@JsonTypeName("v2AuthRequest")
...
public class V2AuthRequest {
  ...
  @javax.annotation.Nullable
  private List<V2Prompt> prompt = new ArrayList<>();
  ...
  public V2AuthRequest() {
  }

  public V2AuthRequest id(@javax.annotation.Nullable String id) {
  ...
  public V2AuthRequest creationDate(@javax.annotation.Nullable OffsetDateTime creationDate) {
  ...
  public V2AuthRequest clientId(@javax.annotation.Nullable String clientId) {
  ...
  public V2AuthRequest scope(@javax.annotation.Nullable List<String> scope) {
    
    this.scope = scope;
    return this;
  }

  public V2AuthRequest addScopeItem(String scopeItem) {
    if (this.scope == null) {
  ...
  public V2AuthRequest redirectUri(@javax.annotation.Nullable String redirectUri) {
  ...
  public V2AuthRequest prompt(@javax.annotation.Nullable List<V2Prompt> prompt) {
    
    this.prompt = prompt;
    return this;
  }

  public V2AuthRequest addPromptItem(V2Prompt promptItem) {
    if (this.prompt == null) {
  ...
  public List<V2Prompt> getPrompt() {
    return prompt;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PROMPT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPrompt(@javax.annotation.Nullable List<V2Prompt> prompt) {
    this.prompt = prompt;
  }

  public V2AuthRequest uiLocales(@javax.annotation.Nullable List<String> uiLocales) {
    
    this.uiLocales = uiLocales;
    return this;
  }

  public V2AuthRequest addUiLocalesItem(String uiLocalesItem) {
  ...
  public V2AuthRequest loginHint(@javax.annotation.Nullable String loginHint) {
  ...
  public V2AuthRequest maxAge(@javax.annotation.Nullable String maxAge) {
  ...
  public V2AuthRequest hintUserId(@javax.annotation.Nullable String hintUserId) {
  ...
  public boolean equals(Object o) {
    ...
    V2AuthRequest v2AuthRequest = (V2AuthRequest) o;
    return Objects.equals(this.id, v2AuthRequest.id) &&
        Objects.equals(this.creationDate, v2AuthRequest.creationDate) &&
        Objects.equals(this.clientId, v2AuthRequest.clientId) &&
        Objects.equals(this.scope, v2AuthRequest.scope) &&
        Objects.equals(this.redirectUri, v2AuthRequest.redirectUri) &&
        Objects.equals(this.prompt, v2AuthRequest.prompt) &&
        Objects.equals(this.uiLocales, v2AuthRequest.uiLocales) &&
        Objects.equals(this.loginHint, v2AuthRequest.loginHint) &&
        Objects.equals(this.maxAge, v2AuthRequest.maxAge) &&
        Objects.equals(this.hintUserId, v2AuthRequest.hintUserId);
  }
