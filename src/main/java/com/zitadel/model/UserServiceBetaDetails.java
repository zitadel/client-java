...
/**
 * UserServiceBetaDetails
 */
@JsonPropertyOrder({
  UserServiceBetaDetails.JSON_PROPERTY_SEQUENCE,
  UserServiceBetaDetails.JSON_PROPERTY_CHANGE_DATE,
  UserServiceBetaDetails.JSON_PROPERTY_RESOURCE_OWNER,
  UserServiceBetaDetails.JSON_PROPERTY_CREATION_DATE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class UserServiceBetaDetails {
  ...
  public UserServiceBetaDetails() {
  }

  public UserServiceBetaDetails sequence(@javax.annotation.Nullable String sequence) {
  ...
  public UserServiceBetaDetails changeDate(@javax.annotation.Nullable OffsetDateTime changeDate) {
  ...
  public UserServiceBetaDetails resourceOwner(@javax.annotation.Nullable String resourceOwner) {
  ...
  public UserServiceBetaDetails creationDate(@javax.annotation.Nullable OffsetDateTime creationDate) {
  ...
  public boolean equals(Object o) {
    ...
    UserServiceBetaDetails userServiceBetaDetails = (UserServiceBetaDetails) o;
    return Objects.equals(this.sequence, userServiceBetaDetails.sequence) &&
        Objects.equals(this.changeDate, userServiceBetaDetails.changeDate) &&
        Objects.equals(this.resourceOwner, userServiceBetaDetails.resourceOwner) &&
        Objects.equals(this.creationDate, userServiceBetaDetails.creationDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserServiceBetaDetails {\n");
