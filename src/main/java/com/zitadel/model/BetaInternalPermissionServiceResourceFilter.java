...
import com.zitadel.model.OrganizationId1;
import com.zitadel.model.ProjectGrantId;
import com.zitadel.model.ProjectId1;
...
public class BetaInternalPermissionServiceResourceFilter {
  ...
  public BetaInternalPermissionServiceResourceFilter instance(@javax.annotation.Nonnull Boolean instance) {
  ...
  public BetaInternalPermissionServiceResourceFilter organizationId(@javax.annotation.Nonnull String organizationId) {
  ...
  public BetaInternalPermissionServiceResourceFilter projectGrantId(@javax.annotation.Nonnull String projectGrantId) {
  ...
  @JsonProperty(JSON_PROPERTY_PROJECT_GRANT_ID)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setProjectGrantId(@javax.annotation.Nonnull String projectGrantId) {
    this.projectGrantId = projectGrantId;
  }

  public BetaInternalPermissionServiceResourceFilter projectId(@javax.annotation.Nonnull String projectId) {
