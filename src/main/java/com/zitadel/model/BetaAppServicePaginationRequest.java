 ...
 */
@JsonPropertyOrder({
  BetaAppServicePaginationRequest.JSON_PROPERTY_OFFSET,
...
public class BetaAppServicePaginationRequest {
  ...
  public BetaAppServicePaginationRequest() {
  }

  public BetaAppServicePaginationRequest offset(@javax.annotation.Nullable Object offset) {
  ...
  public BetaAppServicePaginationRequest limit(@javax.annotation.Nullable Integer limit) {
  ...
  public BetaAppServicePaginationRequest asc(@javax.annotation.Nullable Boolean asc) {
  ...
  public boolean equals(Object o) {
    ...
    BetaAppServicePaginationRequest betaAppServicePaginationRequest = (BetaAppServicePaginationRequest) o;
    return equalsNullable(this.offset, betaAppServicePaginationRequest.offset) &&
        Objects.equals(this.limit, betaAppServicePaginationRequest.limit) &&
        Objects.equals(this.asc, betaAppServicePaginationRequest.asc);
  }
  ...
  public String toString() {
    ...
    sb.append("class BetaAppServicePaginationRequest {\n");
