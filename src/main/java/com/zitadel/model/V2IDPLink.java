 ...
 */
@JsonPropertyOrder({
  V2IDPLink.JSON_PROPERTY_IDP_ID,
  V2IDPLink.JSON_PROPERTY_USER_ID,
  V2IDPLink.JSON_PROPERTY_USER_NAME
})
@JsonTypeName("v2IDPLink")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2IDPLink {
  ...
  public V2IDPLink idpId(@javax.annotation.Nullable String idpId) {
  ...
  public V2IDPLink userId(@javax.annotation.Nullable String userId) {
  ...
  public V2IDPLink userName(@javax.annotation.Nullable String userName) {
  ...
  public boolean equals(Object o) {
    ...
    V2IDPLink v2IDPLink = (V2IDPLink) o;
    return Objects.equals(this.idpId, v2IDPLink.idpId) &&
      Objects.equals(this.userId, v2IDPLink.userId) &&
      Objects.equals(this.userName, v2IDPLink.userName);
  }
