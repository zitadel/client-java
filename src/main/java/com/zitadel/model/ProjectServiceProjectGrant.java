...
public class ProjectServiceProjectGrant {
  ...
  /**
   * The unique identifier of the organization which granted the project to the
   ...
   * <p>Example: {@code null}
   */
  @JsonProperty("grantedRoleKeys")
  @Nullable
  public List<String> grantedRoleKeys = new ArrayList<>();
  ...
  @JsonProperty("state")
  @Nullable
  public ProjectServiceProjectGrantState state;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ProjectServiceProjectGrant other)) {
      return false;
    }
