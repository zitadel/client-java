...
public class ApplicationServiceGenerateClientSecretResponse {
  ...
  /**
   * The newly generated client secret. It must be stored safely, as it will not be possible to
   * retrieve it again. A new client secret can be generated using this endpoint.
   *
   * <p>Example: {@code null}
   */
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ApplicationServiceGenerateClientSecretResponse other)) {
      return false;
    }
    return java.util.Objects.equals(this.clientSecret, other.clientSecret)
        && java.util.Objects.equals(this.creationDate, other.creationDate);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(clientSecret, creationDate);
  }
}
