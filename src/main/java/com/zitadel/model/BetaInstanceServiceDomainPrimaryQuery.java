...
public class BetaInstanceServiceDomainPrimaryQuery {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaInstanceServiceDomainPrimaryQuery other)) {
      return false;
    }
    return java.util.Objects.equals(this.primary, other.primary);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(primary);
  }
}
