...
/**
 * Gets or Sets v2AuthFactorState
 */
public enum V2AuthFactorState {
  ...
  V2AuthFactorState(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static V2AuthFactorState fromValue(String value) {
    for (V2AuthFactorState b : V2AuthFactorState.values()) {
