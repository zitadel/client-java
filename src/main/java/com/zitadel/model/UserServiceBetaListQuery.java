 ...
 */
@JsonPropertyOrder({
  UserServiceBetaListQuery.JSON_PROPERTY_OFFSET,
  UserServiceBetaListQuery.JSON_PROPERTY_LIMIT,
  UserServiceBetaListQuery.JSON_PROPERTY_ASC
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class UserServiceBetaListQuery {
  ...
  public UserServiceBetaListQuery() {
  }

  public UserServiceBetaListQuery offset(@javax.annotation.Nullable String offset) {
  ...
  public UserServiceBetaListQuery limit(@javax.annotation.Nullable Long limit) {
  ...
  public UserServiceBetaListQuery asc(@javax.annotation.Nullable Boolean asc) {
  ...
  public boolean equals(Object o) {
    ...
    UserServiceBetaListQuery userServiceBetaListQuery = (UserServiceBetaListQuery) o;
    return Objects.equals(this.offset, userServiceBetaListQuery.offset) &&
        Objects.equals(this.limit, userServiceBetaListQuery.limit) &&
        Objects.equals(this.asc, userServiceBetaListQuery.asc);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserServiceBetaListQuery {\n");
