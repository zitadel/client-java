...
public class BetaUserServiceRedirectURLs {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaUserServiceRedirectURLs other)) {
      return false;
    }
    return java.util.Objects.equals(this.successUrl, other.successUrl)
        && java.util.Objects.equals(this.failureUrl, other.failureUrl);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(successUrl, failureUrl);
  }
}
