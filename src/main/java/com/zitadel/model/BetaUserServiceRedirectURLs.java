 ...
 */
@JsonPropertyOrder({
  BetaUserServiceRedirectURLs.JSON_PROPERTY_SUCCESS_URL,
  BetaUserServiceRedirectURLs.JSON_PROPERTY_FAILURE_URL
})
@javax.annotation.Generated(value = "io.github.mridang.codegen.generators.java.BetterJavaCodegen", comments = "Generator version: 7.14.0")
public class BetaUserServiceRedirectURLs {
  ...
  public BetaUserServiceRedirectURLs() {
  }

  public BetaUserServiceRedirectURLs successUrl(@javax.annotation.Nullable String successUrl) {
  ...
  public BetaUserServiceRedirectURLs failureUrl(@javax.annotation.Nullable String failureUrl) {
  ...
  public boolean equals(Object o) {
    ...
    BetaUserServiceRedirectURLs betaUserServiceRedirectURLs = (BetaUserServiceRedirectURLs) o;
    return Objects.equals(this.successUrl, betaUserServiceRedirectURLs.successUrl) &&
        Objects.equals(this.failureUrl, betaUserServiceRedirectURLs.failureUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class BetaUserServiceRedirectURLs {\n");
