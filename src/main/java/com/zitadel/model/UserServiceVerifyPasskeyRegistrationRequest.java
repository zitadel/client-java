...
public class UserServiceVerifyPasskeyRegistrationRequest {
  ...
  @javax.annotation.Nonnull
  private Map<String, UserServiceValue> publicKeyCredential = new HashMap<>();
  ...
  public UserServiceVerifyPasskeyRegistrationRequest publicKeyCredential(@javax.annotation.Nonnull Map<String, UserServiceValue> publicKeyCredential) {
    
    this.publicKeyCredential = publicKeyCredential;
    return this;
  }

  public UserServiceVerifyPasskeyRegistrationRequest putPublicKeyCredentialItem(String key, UserServiceValue publicKeyCredentialItem) {
  ...
  public Map<String, UserServiceValue> getPublicKeyCredential() {
    return publicKeyCredential;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PUBLIC_KEY_CREDENTIAL)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPublicKeyCredential(@javax.annotation.Nonnull Map<String, UserServiceValue> publicKeyCredential) {
    this.publicKeyCredential = publicKeyCredential;
  }
