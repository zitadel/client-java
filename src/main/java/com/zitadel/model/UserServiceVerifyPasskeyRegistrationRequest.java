...
public class UserServiceVerifyPasskeyRegistrationRequest {
  ...
  public UserServiceVerifyPasskeyRegistrationRequest userId(@javax.annotation.Nullable String userId) {
  ...
  public UserServiceVerifyPasskeyRegistrationRequest passkeyId(@javax.annotation.Nullable String passkeyId) {
  ...
  public UserServiceVerifyPasskeyRegistrationRequest publicKeyCredential(@javax.annotation.Nullable Map<String, Object> publicKeyCredential) {
  ...
  public UserServiceVerifyPasskeyRegistrationRequest passkeyName(@javax.annotation.Nullable String passkeyName) {
