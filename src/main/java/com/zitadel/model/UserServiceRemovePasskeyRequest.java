 ...
 */
@JsonPropertyOrder({
  UserServiceRemovePasskeyRequest.JSON_PROPERTY_USER_ID,
  UserServiceRemovePasskeyRequest.JSON_PROPERTY_PASSKEY_ID
})
@javax.annotation.Generated(value = "io.github.mridang.codegen.generators.java.BetterJavaCodegen", comments = "Generator version: 7.14.0")
public class UserServiceRemovePasskeyRequest {
  ...
  public UserServiceRemovePasskeyRequest userId(@javax.annotation.Nullable String userId) {
  ...
  public UserServiceRemovePasskeyRequest passkeyId(@javax.annotation.Nullable String passkeyId) {
  ...
  public boolean equals(Object o) {
    ...
    UserServiceRemovePasskeyRequest userServiceRemovePasskeyRequest = (UserServiceRemovePasskeyRequest) o;
    return Objects.equals(this.userId, userServiceRemovePasskeyRequest.userId) &&
        Objects.equals(this.passkeyId, userServiceRemovePasskeyRequest.passkeyId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userId, passkeyId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserServiceRemovePasskeyRequest {\n");
