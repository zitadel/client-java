 ...
 */
@JsonPropertyOrder({
  BetaOIDCServiceDetails.JSON_PROPERTY_SEQUENCE,
  BetaOIDCServiceDetails.JSON_PROPERTY_CHANGE_DATE,
  BetaOIDCServiceDetails.JSON_PROPERTY_RESOURCE_OWNER,
  BetaOIDCServiceDetails.JSON_PROPERTY_CREATION_DATE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class BetaOIDCServiceDetails {
  ...
  public BetaOIDCServiceDetails() {
  }

  public BetaOIDCServiceDetails sequence(@javax.annotation.Nullable Object sequence) {
  ...
  public BetaOIDCServiceDetails changeDate(@javax.annotation.Nullable OffsetDateTime changeDate) {
  ...
  public BetaOIDCServiceDetails resourceOwner(@javax.annotation.Nullable String resourceOwner) {
  ...
  public BetaOIDCServiceDetails creationDate(@javax.annotation.Nullable OffsetDateTime creationDate) {
  ...
  public boolean equals(Object o) {
    ...
    BetaOIDCServiceDetails betaOIDCServiceDetails = (BetaOIDCServiceDetails) o;
    return equalsNullable(this.sequence, betaOIDCServiceDetails.sequence) &&
        Objects.equals(this.changeDate, betaOIDCServiceDetails.changeDate) &&
        Objects.equals(this.resourceOwner, betaOIDCServiceDetails.resourceOwner) &&
        Objects.equals(this.creationDate, betaOIDCServiceDetails.creationDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class BetaOIDCServiceDetails {\n");
