 ...
 */
@JsonPropertyOrder({
  InternalPermissionServiceAny.JSON_PROPERTY_TYPE,
  InternalPermissionServiceAny.JSON_PROPERTY_VALUE,
  InternalPermissionServiceAny.JSON_PROPERTY_DEBUG
})
@javax.annotation.Generated(value = "io.github.mridang.codegen.generators.java.BetterJavaCodegen", comments = "Generator version: 7.14.0")
public class InternalPermissionServiceAny extends HashMap<String, Object> {
  ...
  public InternalPermissionServiceAny() {

  }

  public InternalPermissionServiceAny type(@javax.annotation.Nullable String type) {
  ...
  public InternalPermissionServiceAny value(@javax.annotation.Nullable File value) {
  ...
  public InternalPermissionServiceAny debug(@javax.annotation.Nullable Object debug) {
  ...
  public boolean equals(Object o) {
    ...
    InternalPermissionServiceAny internalPermissionServiceAny = (InternalPermissionServiceAny) o;
    return Objects.equals(this.type, internalPermissionServiceAny.type) &&
        Objects.equals(this.value, internalPermissionServiceAny.value) &&
        equalsNullable(this.debug, internalPermissionServiceAny.debug) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class InternalPermissionServiceAny {\n");
