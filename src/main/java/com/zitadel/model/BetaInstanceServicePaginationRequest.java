 ...
 */
@JsonPropertyOrder({
  BetaInstanceServicePaginationRequest.JSON_PROPERTY_OFFSET,
  BetaInstanceServicePaginationRequest.JSON_PROPERTY_LIMIT,
  BetaInstanceServicePaginationRequest.JSON_PROPERTY_ASC
})
@javax.annotation.Generated(value = "io.github.mridang.codegen.generators.java.BetterJavaCodegen", comments = "Generator version: 7.14.0")
public class BetaInstanceServicePaginationRequest {
  ...
  public BetaInstanceServicePaginationRequest() {
  }

  public BetaInstanceServicePaginationRequest offset(@javax.annotation.Nullable Object offset) {
  ...
  public BetaInstanceServicePaginationRequest limit(@javax.annotation.Nullable Integer limit) {
  ...
  public BetaInstanceServicePaginationRequest asc(@javax.annotation.Nullable Boolean asc) {
  ...
  public boolean equals(Object o) {
    ...
    BetaInstanceServicePaginationRequest betaInstanceServicePaginationRequest = (BetaInstanceServicePaginationRequest) o;
    return equalsNullable(this.offset, betaInstanceServicePaginationRequest.offset) &&
        Objects.equals(this.limit, betaInstanceServicePaginationRequest.limit) &&
        Objects.equals(this.asc, betaInstanceServicePaginationRequest.asc);
  }
  ...
  public String toString() {
    ...
    sb.append("class BetaInstanceServicePaginationRequest {\n");
