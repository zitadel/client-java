 ...
 */
@JsonPropertyOrder({
  V2PasswordResetResponse.JSON_PROPERTY_DETAILS,
  V2PasswordResetResponse.JSON_PROPERTY_VERIFICATION_CODE
})
@JsonTypeName("v2PasswordResetResponse")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2PasswordResetResponse {
  ...
  public V2PasswordResetResponse() {
  }

  public V2PasswordResetResponse details(@javax.annotation.Nullable V2Details details) {
  ...
  public V2PasswordResetResponse verificationCode(@javax.annotation.Nullable String verificationCode) {
  ...
  public boolean equals(Object o) {
    ...
    V2PasswordResetResponse v2PasswordResetResponse = (V2PasswordResetResponse) o;
    return Objects.equals(this.details, v2PasswordResetResponse.details) &&
        Objects.equals(this.verificationCode, v2PasswordResetResponse.verificationCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2PasswordResetResponse {\n");
