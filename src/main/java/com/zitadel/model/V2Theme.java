 ...
 */
@JsonPropertyOrder({
  V2Theme.JSON_PROPERTY_PRIMARY_COLOR,
  V2Theme.JSON_PROPERTY_BACKGROUND_COLOR,
  V2Theme.JSON_PROPERTY_WARN_COLOR,
  V2Theme.JSON_PROPERTY_FONT_COLOR,
  V2Theme.JSON_PROPERTY_LOGO_URL,
  V2Theme.JSON_PROPERTY_ICON_URL
})
@JsonTypeName("v2Theme")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2Theme {
  ...
  public V2Theme primaryColor(@javax.annotation.Nullable String primaryColor) {
  ...
  public V2Theme backgroundColor(@javax.annotation.Nullable String backgroundColor) {
  ...
  public V2Theme warnColor(@javax.annotation.Nullable String warnColor) {
  ...
  public V2Theme fontColor(@javax.annotation.Nullable String fontColor) {
  ...
  public V2Theme logoUrl(@javax.annotation.Nullable String logoUrl) {
  ...
  public V2Theme iconUrl(@javax.annotation.Nullable String iconUrl) {
  ...
  public boolean equals(Object o) {
    ...
    V2Theme v2Theme = (V2Theme) o;
    return Objects.equals(this.primaryColor, v2Theme.primaryColor) &&
      Objects.equals(this.backgroundColor, v2Theme.backgroundColor) &&
      Objects.equals(this.warnColor, v2Theme.warnColor) &&
      Objects.equals(this.fontColor, v2Theme.fontColor) &&
      Objects.equals(this.logoUrl, v2Theme.logoUrl) &&
      Objects.equals(this.iconUrl, v2Theme.iconUrl);
  }
