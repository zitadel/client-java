...
/**
 * UserServiceBetaListDetails
 */
@JsonPropertyOrder({
  UserServiceBetaListDetails.JSON_PROPERTY_TOTAL_RESULT,
  UserServiceBetaListDetails.JSON_PROPERTY_PROCESSED_SEQUENCE,
  UserServiceBetaListDetails.JSON_PROPERTY_TIMESTAMP
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class UserServiceBetaListDetails {
  ...
  public UserServiceBetaListDetails() {
  }

  public UserServiceBetaListDetails totalResult(@javax.annotation.Nullable String totalResult) {
  ...
  public UserServiceBetaListDetails processedSequence(@javax.annotation.Nullable String processedSequence) {
  ...
  public UserServiceBetaListDetails timestamp(@javax.annotation.Nullable OffsetDateTime timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    UserServiceBetaListDetails userServiceBetaListDetails = (UserServiceBetaListDetails) o;
    return Objects.equals(this.totalResult, userServiceBetaListDetails.totalResult) &&
        Objects.equals(this.processedSequence, userServiceBetaListDetails.processedSequence) &&
        Objects.equals(this.timestamp, userServiceBetaListDetails.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserServiceBetaListDetails {\n");
