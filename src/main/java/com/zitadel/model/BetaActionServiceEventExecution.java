...
public class BetaActionServiceEventExecution {
  ...
  public BetaActionServiceEventExecution all(@javax.annotation.Nullable Boolean all) {
  ...
  public BetaActionServiceEventExecution event(@javax.annotation.Nullable String event) {
  ...
  public BetaActionServiceEventExecution group(@javax.annotation.Nullable String group) {
