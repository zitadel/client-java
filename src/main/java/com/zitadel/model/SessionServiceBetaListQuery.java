 ...
 */
@JsonPropertyOrder({
  SessionServiceBetaListQuery.JSON_PROPERTY_OFFSET,
  SessionServiceBetaListQuery.JSON_PROPERTY_LIMIT,
  SessionServiceBetaListQuery.JSON_PROPERTY_ASC
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class SessionServiceBetaListQuery {
  ...
  public SessionServiceBetaListQuery() {
  }

  public SessionServiceBetaListQuery offset(@javax.annotation.Nullable String offset) {
  ...
  public SessionServiceBetaListQuery limit(@javax.annotation.Nullable Long limit) {
  ...
  public SessionServiceBetaListQuery asc(@javax.annotation.Nullable Boolean asc) {
  ...
  public boolean equals(Object o) {
    ...
    SessionServiceBetaListQuery sessionServiceBetaListQuery = (SessionServiceBetaListQuery) o;
    return Objects.equals(this.offset, sessionServiceBetaListQuery.offset) &&
        Objects.equals(this.limit, sessionServiceBetaListQuery.limit) &&
        Objects.equals(this.asc, sessionServiceBetaListQuery.asc);
  }
  ...
  public String toString() {
    ...
    sb.append("class SessionServiceBetaListQuery {\n");
