 ...
 */
@JsonPropertyOrder({
  ProjectServicePaginationRequest.JSON_PROPERTY_OFFSET,
  ProjectServicePaginationRequest.JSON_PROPERTY_LIMIT,
  ProjectServicePaginationRequest.JSON_PROPERTY_ASC
})
@javax.annotation.Generated(value = "io.github.mridang.codegen.generators.java.BetterJavaCodegen", comments = "Generator version: 7.14.0")
public class ProjectServicePaginationRequest {
  ...
  public ProjectServicePaginationRequest() {
  }

  public ProjectServicePaginationRequest offset(@javax.annotation.Nullable Object offset) {
  ...
  public ProjectServicePaginationRequest limit(@javax.annotation.Nullable Integer limit) {
  ...
  public ProjectServicePaginationRequest asc(@javax.annotation.Nullable Boolean asc) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectServicePaginationRequest projectServicePaginationRequest = (ProjectServicePaginationRequest) o;
    return equalsNullable(this.offset, projectServicePaginationRequest.offset) &&
        Objects.equals(this.limit, projectServicePaginationRequest.limit) &&
        Objects.equals(this.asc, projectServicePaginationRequest.asc);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectServicePaginationRequest {\n");
