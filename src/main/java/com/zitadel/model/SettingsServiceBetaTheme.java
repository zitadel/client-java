...
/**
 * SettingsServiceBetaTheme
 */
@JsonPropertyOrder({
  SettingsServiceBetaTheme.JSON_PROPERTY_PRIMARY_COLOR,
  SettingsServiceBetaTheme.JSON_PROPERTY_BACKGROUND_COLOR,
  SettingsServiceBetaTheme.JSON_PROPERTY_WARN_COLOR,
  SettingsServiceBetaTheme.JSON_PROPERTY_FONT_COLOR,
  SettingsServiceBetaTheme.JSON_PROPERTY_LOGO_URL,
  SettingsServiceBetaTheme.JSON_PROPERTY_ICON_URL
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class SettingsServiceBetaTheme {
  ...
  public SettingsServiceBetaTheme() {
  }

  public SettingsServiceBetaTheme primaryColor(@javax.annotation.Nullable String primaryColor) {
  ...
  public SettingsServiceBetaTheme backgroundColor(@javax.annotation.Nullable String backgroundColor) {
  ...
  public SettingsServiceBetaTheme warnColor(@javax.annotation.Nullable String warnColor) {
  ...
  public SettingsServiceBetaTheme fontColor(@javax.annotation.Nullable String fontColor) {
  ...
  public SettingsServiceBetaTheme logoUrl(@javax.annotation.Nullable String logoUrl) {
  ...
  public SettingsServiceBetaTheme iconUrl(@javax.annotation.Nullable String iconUrl) {
  ...
  public boolean equals(Object o) {
    ...
    SettingsServiceBetaTheme settingsServiceBetaTheme = (SettingsServiceBetaTheme) o;
    return Objects.equals(this.primaryColor, settingsServiceBetaTheme.primaryColor) &&
        Objects.equals(this.backgroundColor, settingsServiceBetaTheme.backgroundColor) &&
        Objects.equals(this.warnColor, settingsServiceBetaTheme.warnColor) &&
        Objects.equals(this.fontColor, settingsServiceBetaTheme.fontColor) &&
        Objects.equals(this.logoUrl, settingsServiceBetaTheme.logoUrl) &&
        Objects.equals(this.iconUrl, settingsServiceBetaTheme.iconUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class SettingsServiceBetaTheme {\n");
