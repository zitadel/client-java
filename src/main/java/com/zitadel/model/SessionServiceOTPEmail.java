...
public class SessionServiceOTPEmail {
  ...
  public SessionServiceOTPEmail returnCode(@javax.annotation.Nullable Object returnCode) {
  ...
  public SessionServiceOTPEmail sendCode(@javax.annotation.Nullable SessionServiceSendCode sendCode) {
  ...
  @JsonProperty(JSON_PROPERTY_SEND_CODE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSendCode(@javax.annotation.Nullable SessionServiceSendCode sendCode) {
    this.sendCode = sendCode;
  }
