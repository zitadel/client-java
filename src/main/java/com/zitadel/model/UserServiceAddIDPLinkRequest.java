...
public class UserServiceAddIDPLinkRequest {
  ...
  @Nullable
  public UserServiceIDPLink idpLink;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof UserServiceAddIDPLinkRequest other)) {
      return false;
    }
    return java.util.Objects.equals(this.userId, other.userId)
        && java.util.Objects.equals(this.idpLink, other.idpLink);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(userId, idpLink);
  }
}
