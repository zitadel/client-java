...
public class UserServiceAddIDPLinkRequest {
  ...
  public UserServiceAddIDPLinkRequest userId(@javax.annotation.Nullable String userId) {
  ...
  public UserServiceIDPLink getIdpLink() {
    return idpLink;
  }
  ...
  @JsonProperty(JSON_PROPERTY_IDP_LINK)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIdpLink(@javax.annotation.Nullable UserServiceIDPLink idpLink) {
    this.idpLink = idpLink;
  }
