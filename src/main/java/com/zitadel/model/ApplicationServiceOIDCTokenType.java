...
public enum ApplicationServiceOIDCTokenType {
  ...
  ApplicationServiceOIDCTokenType(String value) {
    this.value = value;
  }
  ...
  public static ApplicationServiceOIDCTokenType fromValue(String value) {
    for (ApplicationServiceOIDCTokenType b : values()) {
