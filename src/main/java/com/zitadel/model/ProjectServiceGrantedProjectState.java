...
public enum ProjectServiceGrantedProjectState {
  ...
  ProjectServiceGrantedProjectState(String value) {
    this.value = value;
  }
  ...
  public static ProjectServiceGrantedProjectState fromValue(String value) {
    for (ProjectServiceGrantedProjectState b : values()) {
