...
/**
 * SessionServiceBetaUserAgent
 */
@JsonPropertyOrder({
  SessionServiceBetaUserAgent.JSON_PROPERTY_FINGERPRINT_ID,
  SessionServiceBetaUserAgent.JSON_PROPERTY_IP,
  SessionServiceBetaUserAgent.JSON_PROPERTY_DESCRIPTION,
  SessionServiceBetaUserAgent.JSON_PROPERTY_HEADER
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class SessionServiceBetaUserAgent {
  ...
  public SessionServiceBetaUserAgent() {
  }

  public SessionServiceBetaUserAgent fingerprintId(@javax.annotation.Nullable String fingerprintId) {
  ...
  public SessionServiceBetaUserAgent ip(@javax.annotation.Nullable String ip) {
  ...
  public SessionServiceBetaUserAgent description(@javax.annotation.Nullable String description) {
  ...
  public SessionServiceBetaUserAgent header(@javax.annotation.Nullable Map<String, SessionServiceUserAgentHeaderValues> header) {
    
    this.header = header;
    return this;
  }

  public SessionServiceBetaUserAgent putHeaderItem(String key, SessionServiceUserAgentHeaderValues headerItem) {
    if (this.header == null) {
  ...
  public boolean equals(Object o) {
    ...
    SessionServiceBetaUserAgent sessionServiceBetaUserAgent = (SessionServiceBetaUserAgent) o;
    return Objects.equals(this.fingerprintId, sessionServiceBetaUserAgent.fingerprintId) &&
        Objects.equals(this.ip, sessionServiceBetaUserAgent.ip) &&
        Objects.equals(this.description, sessionServiceBetaUserAgent.description) &&
        Objects.equals(this.header, sessionServiceBetaUserAgent.header);
  }
  ...
  public String toString() {
    ...
    sb.append("class SessionServiceBetaUserAgent {\n");
