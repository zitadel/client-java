...
public class BetaAppServiceOIDCLocalizedMessage {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaAppServiceOIDCLocalizedMessage other)) {
      return false;
    }
    return java.util.Objects.equals(this.key, other.key)
        && java.util.Objects.equals(this.localizedMessage, other.localizedMessage);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(key, localizedMessage);
  }
}
