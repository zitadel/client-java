 ...
 */
@JsonPropertyOrder({
  V2CheckIDPIntent.JSON_PROPERTY_IDP_INTENT_ID,
  V2CheckIDPIntent.JSON_PROPERTY_IDP_INTENT_TOKEN
})
@JsonTypeName("v2CheckIDPIntent")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2CheckIDPIntent {
  ...
  public V2CheckIDPIntent() {
  }

  public V2CheckIDPIntent idpIntentId(@javax.annotation.Nullable String idpIntentId) {
  ...
  public V2CheckIDPIntent idpIntentToken(@javax.annotation.Nullable String idpIntentToken) {
  ...
  public boolean equals(Object o) {
    ...
    V2CheckIDPIntent v2CheckIDPIntent = (V2CheckIDPIntent) o;
    return Objects.equals(this.idpIntentId, v2CheckIDPIntent.idpIntentId) &&
      Objects.equals(this.idpIntentToken, v2CheckIDPIntent.idpIntentToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2CheckIDPIntent {\n");
