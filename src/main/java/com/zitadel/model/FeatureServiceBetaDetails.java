...
/**
 * FeatureServiceBetaDetails
 */
@JsonPropertyOrder({
  FeatureServiceBetaDetails.JSON_PROPERTY_SEQUENCE,
  FeatureServiceBetaDetails.JSON_PROPERTY_CHANGE_DATE,
  FeatureServiceBetaDetails.JSON_PROPERTY_RESOURCE_OWNER,
  FeatureServiceBetaDetails.JSON_PROPERTY_CREATION_DATE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class FeatureServiceBetaDetails {
  ...
  public FeatureServiceBetaDetails() {
  }

  public FeatureServiceBetaDetails sequence(@javax.annotation.Nullable String sequence) {
  ...
  public FeatureServiceBetaDetails changeDate(@javax.annotation.Nullable OffsetDateTime changeDate) {
  ...
  public FeatureServiceBetaDetails resourceOwner(@javax.annotation.Nullable String resourceOwner) {
  ...
  public FeatureServiceBetaDetails creationDate(@javax.annotation.Nullable OffsetDateTime creationDate) {
  ...
  public boolean equals(Object o) {
    ...
    FeatureServiceBetaDetails featureServiceBetaDetails = (FeatureServiceBetaDetails) o;
    return Objects.equals(this.sequence, featureServiceBetaDetails.sequence) &&
        Objects.equals(this.changeDate, featureServiceBetaDetails.changeDate) &&
        Objects.equals(this.resourceOwner, featureServiceBetaDetails.resourceOwner) &&
        Objects.equals(this.creationDate, featureServiceBetaDetails.creationDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class FeatureServiceBetaDetails {\n");
