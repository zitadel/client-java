 ...
 */
@JsonPropertyOrder({
  V2PasswordFactor.JSON_PROPERTY_VERIFIED_AT
})
@JsonTypeName("v2PasswordFactor")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2PasswordFactor {
  public static final String JSON_PROPERTY_VERIFIED_AT = "verifiedAt";
  @javax.annotation.Nullable
  private OffsetDateTime verifiedAt;

  public V2PasswordFactor() {
  }

  public V2PasswordFactor verifiedAt(@javax.annotation.Nullable OffsetDateTime verifiedAt) {
  ...
  public boolean equals(Object o) {
    ...
    V2PasswordFactor v2PasswordFactor = (V2PasswordFactor) o;
    return Objects.equals(this.verifiedAt, v2PasswordFactor.verifiedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2PasswordFactor {\n");
