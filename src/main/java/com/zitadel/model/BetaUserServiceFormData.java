 ...
 */
@JsonPropertyOrder({
  BetaUserServiceFormData.JSON_PROPERTY_URL,
  BetaUserServiceFormData.JSON_PROPERTY_FIELDS
})
...
public class BetaUserServiceFormData {
  ...
  public BetaUserServiceFormData url(@javax.annotation.Nullable String url) {
  ...
  public BetaUserServiceFormData fields(@javax.annotation.Nullable Map<String, String> fields) {
    
    this.fields = fields;
    return this;
  }

  public BetaUserServiceFormData putFieldsItem(String key, String fieldsItem) {
    if (this.fields == null) {
  ...
  public boolean equals(Object o) {
    ...
    BetaUserServiceFormData betaUserServiceFormData = (BetaUserServiceFormData) o;
    return Objects.equals(this.url, betaUserServiceFormData.url) &&
        Objects.equals(this.fields, betaUserServiceFormData.fields);
  }
  ...
  public String toString() {
    ...
    sb.append("class BetaUserServiceFormData {\n");
