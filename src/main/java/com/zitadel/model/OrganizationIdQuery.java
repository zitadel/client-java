 ...
 */
@JsonPropertyOrder({
  OrganizationIdQuery.JSON_PROPERTY_ORGANIZATION_ID_QUERY
})
@JsonTypeName("organization_id_query")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class OrganizationIdQuery {
  ...
  public OrganizationIdQuery organizationIdQuery(@javax.annotation.Nonnull UserServiceOrganizationIdQuery organizationIdQuery) {
  ...
  public boolean equals(Object o) {
    ...
    OrganizationIdQuery organizationIdQuery = (OrganizationIdQuery) o;
    return Objects.equals(this.organizationIdQuery, organizationIdQuery.organizationIdQuery);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationIdQuery {\n");
