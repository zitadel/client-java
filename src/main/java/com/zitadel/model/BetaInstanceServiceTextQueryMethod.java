...
public enum BetaInstanceServiceTextQueryMethod {
  ...
  BetaInstanceServiceTextQueryMethod(String value) {
    this.value = value;
  }
  ...
  public static BetaInstanceServiceTextQueryMethod fromValue(String value) {
    for (BetaInstanceServiceTextQueryMethod b : values()) {
