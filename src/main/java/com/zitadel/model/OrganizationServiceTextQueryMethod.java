...
public enum OrganizationServiceTextQueryMethod {
  ...
  OrganizationServiceTextQueryMethod(String value) {
    this.value = value;
  }
  ...
  public static OrganizationServiceTextQueryMethod fromValue(String value) {
    for (OrganizationServiceTextQueryMethod b : values()) {
