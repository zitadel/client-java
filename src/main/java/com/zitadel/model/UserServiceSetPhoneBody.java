 ...
 */
@JsonPropertyOrder({
  UserServiceSetPhoneBody.JSON_PROPERTY_PHONE,
  UserServiceSetPhoneBody.JSON_PROPERTY_SEND_CODE,
  UserServiceSetPhoneBody.JSON_PROPERTY_RETURN_CODE,
  UserServiceSetPhoneBody.JSON_PROPERTY_IS_VERIFIED
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class UserServiceSetPhoneBody {
  ...
  public UserServiceSetPhoneBody() {
  }

  public UserServiceSetPhoneBody phone(@javax.annotation.Nonnull String phone) {
  ...
  public UserServiceSetPhoneBody sendCode(@javax.annotation.Nullable Object sendCode) {
  ...
  public UserServiceSetPhoneBody returnCode(@javax.annotation.Nullable Object returnCode) {
  ...
  public UserServiceSetPhoneBody isVerified(@javax.annotation.Nullable Boolean isVerified) {
  ...
  public boolean equals(Object o) {
    ...
    UserServiceSetPhoneBody userServiceSetPhoneBody = (UserServiceSetPhoneBody) o;
    return Objects.equals(this.phone, userServiceSetPhoneBody.phone) &&
      Objects.equals(this.sendCode, userServiceSetPhoneBody.sendCode) &&
      Objects.equals(this.returnCode, userServiceSetPhoneBody.returnCode) &&
      Objects.equals(this.isVerified, userServiceSetPhoneBody.isVerified);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserServiceSetPhoneBody {\n");
