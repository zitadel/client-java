...
public enum ApplicationServiceAPIAuthMethodType {
  /** The {@code "API_AUTH_METHOD_TYPE_BASIC"} value. */
  API_AUTH_METHOD_TYPE_BASIC("API_AUTH_METHOD_TYPE_BASIC"),
  /** The {@code "API_AUTH_METHOD_TYPE_PRIVATE_KEY_JWT"} value. */
  API_AUTH_METHOD_TYPE_PRIVATE_KEY_JWT("API_AUTH_METHOD_TYPE_PRIVATE_KEY_JWT");

  private final String value;

  ApplicationServiceAPIAuthMethodType(String value) {
    this.value = value;
  }
  ...
  public static ApplicationServiceAPIAuthMethodType fromValue(String value) {
    for (ApplicationServiceAPIAuthMethodType b : values()) {
