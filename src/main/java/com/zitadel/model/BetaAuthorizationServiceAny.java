...
@JsonPropertyOrder({
  ...
  BetaAuthorizationServiceAny.JSON_PROPERTY_VALUE,
  BetaAuthorizationServiceAny.JSON_PROPERTY_DEBUG
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class BetaAuthorizationServiceAny extends HashMap<String, Object> {
  ...
  public BetaAuthorizationServiceAny type(@javax.annotation.Nullable String type) {
  ...
  public BetaAuthorizationServiceAny value(@javax.annotation.Nullable File value) {
  ...
  public String toString() {
    ...
    sb.append("class BetaAuthorizationServiceAny {\n");
