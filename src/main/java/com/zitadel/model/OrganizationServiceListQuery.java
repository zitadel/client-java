 ...
 */
@JsonPropertyOrder({
  OrganizationServiceListQuery.JSON_PROPERTY_OFFSET,
...
public class OrganizationServiceListQuery {
  ...
  public OrganizationServiceListQuery() {
  }

  public OrganizationServiceListQuery offset(@javax.annotation.Nullable Object offset) {
  ...
  public OrganizationServiceListQuery limit(@javax.annotation.Nullable Integer limit) {
  ...
  public OrganizationServiceListQuery asc(@javax.annotation.Nullable Boolean asc) {
  ...
  public boolean equals(Object o) {
    ...
    OrganizationServiceListQuery organizationServiceListQuery = (OrganizationServiceListQuery) o;
    return equalsNullable(this.offset, organizationServiceListQuery.offset) &&
        Objects.equals(this.limit, organizationServiceListQuery.limit) &&
        Objects.equals(this.asc, organizationServiceListQuery.asc);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationServiceListQuery {\n");
