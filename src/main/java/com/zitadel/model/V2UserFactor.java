 ...
 */
@JsonPropertyOrder({
  V2UserFactor.JSON_PROPERTY_VERIFIED_AT,
  V2UserFactor.JSON_PROPERTY_ID,
  V2UserFactor.JSON_PROPERTY_LOGIN_NAME,
  V2UserFactor.JSON_PROPERTY_DISPLAY_NAME,
  V2UserFactor.JSON_PROPERTY_ORGANIZATION_ID
})
@JsonTypeName("v2UserFactor")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2UserFactor {
  ...
  public V2UserFactor verifiedAt(@javax.annotation.Nullable OffsetDateTime verifiedAt) {
  ...
  public V2UserFactor id(@javax.annotation.Nullable String id) {
  ...
  public V2UserFactor loginName(@javax.annotation.Nullable String loginName) {
  ...
  public V2UserFactor displayName(@javax.annotation.Nullable String displayName) {
  ...
  public V2UserFactor organizationId(@javax.annotation.Nullable String organizationId) {
  ...
  public boolean equals(Object o) {
    ...
    V2UserFactor v2UserFactor = (V2UserFactor) o;
    return Objects.equals(this.verifiedAt, v2UserFactor.verifiedAt) &&
        Objects.equals(this.id, v2UserFactor.id) &&
        Objects.equals(this.loginName, v2UserFactor.loginName) &&
        Objects.equals(this.displayName, v2UserFactor.displayName) &&
        Objects.equals(this.organizationId, v2UserFactor.organizationId);
  }
