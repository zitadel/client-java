 ...
 */
@JsonPropertyOrder({
  IsVerified.JSON_PROPERTY_IS_VERIFIED
})
@JsonTypeName("is_verified")
...
public class IsVerified {
  ...
  public IsVerified isVerified(@javax.annotation.Nonnull Boolean isVerified) {
  ...
  public boolean equals(Object o) {
    ...
    IsVerified isVerified = (IsVerified) o;
    return Objects.equals(this.isVerified, isVerified.isVerified);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isVerified);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IsVerified {\n");
