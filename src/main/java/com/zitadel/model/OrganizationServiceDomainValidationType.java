...
public enum OrganizationServiceDomainValidationType {
  ...
  OrganizationServiceDomainValidationType(String value) {
    this.value = value;
  }
  ...
  public static OrganizationServiceDomainValidationType fromValue(String value) {
    for (OrganizationServiceDomainValidationType b : values()) {
