 ...
 */
@JsonPropertyOrder({
  V2SendEmailCodeResponse.JSON_PROPERTY_DETAILS,
  V2SendEmailCodeResponse.JSON_PROPERTY_VERIFICATION_CODE
})
@JsonTypeName("v2SendEmailCodeResponse")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2SendEmailCodeResponse {
  ...
  public V2SendEmailCodeResponse() {
  }

  public V2SendEmailCodeResponse details(@javax.annotation.Nullable V2Details details) {
  ...
  public V2SendEmailCodeResponse verificationCode(@javax.annotation.Nullable String verificationCode) {
  ...
  public boolean equals(Object o) {
    ...
    V2SendEmailCodeResponse v2SendEmailCodeResponse = (V2SendEmailCodeResponse) o;
    return Objects.equals(this.details, v2SendEmailCodeResponse.details) &&
      Objects.equals(this.verificationCode, v2SendEmailCodeResponse.verificationCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2SendEmailCodeResponse {\n");
