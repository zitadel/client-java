...
public class BetaUserServiceSetHumanEmail {
  ...
  public BetaUserServiceSetHumanEmail email(@javax.annotation.Nullable String email) {
  ...
  public BetaUserServiceSetHumanEmail isVerified(@javax.annotation.Nullable Boolean isVerified) {
  ...
  public BetaUserServiceSetHumanEmail returnCode(@javax.annotation.Nullable Object returnCode) {
  ...
  public BetaUserServiceSetHumanEmail sendCode(@javax.annotation.Nullable BetaUserServiceSendEmailVerificationCode sendCode) {
