 ...
 */
@JsonPropertyOrder({
  AuthorizationServiceAny.JSON_PROPERTY_TYPE,
  AuthorizationServiceAny.JSON_PROPERTY_VALUE,
  AuthorizationServiceAny.JSON_PROPERTY_DEBUG
})
@javax.annotation.Generated(value = "io.github.mridang.codegen.generators.java.BetterJavaCodegen", comments = "Generator version: 7.14.0")
public class AuthorizationServiceAny extends HashMap<String, Object> {
  ...
  public AuthorizationServiceAny() {

  }

  public AuthorizationServiceAny type(@javax.annotation.Nullable String type) {
  ...
  public AuthorizationServiceAny value(@javax.annotation.Nullable File value) {
  ...
  public AuthorizationServiceAny debug(@javax.annotation.Nullable Object debug) {
  ...
  public boolean equals(Object o) {
    ...
    AuthorizationServiceAny authorizationServiceAny = (AuthorizationServiceAny) o;
    return Objects.equals(this.type, authorizationServiceAny.type) &&
        Objects.equals(this.value, authorizationServiceAny.value) &&
        equalsNullable(this.debug, authorizationServiceAny.debug) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthorizationServiceAny {\n");
