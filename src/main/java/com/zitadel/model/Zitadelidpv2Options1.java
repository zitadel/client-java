 ...
 */
@JsonPropertyOrder({
  Zitadelidpv2Options1.JSON_PROPERTY_IS_LINKING_ALLOWED,
  Zitadelidpv2Options1.JSON_PROPERTY_IS_CREATION_ALLOWED,
  Zitadelidpv2Options1.JSON_PROPERTY_IS_AUTO_CREATION,
  Zitadelidpv2Options1.JSON_PROPERTY_IS_AUTO_UPDATE,
  Zitadelidpv2Options1.JSON_PROPERTY_AUTO_LINKING
})
@JsonTypeName("zitadelidpv2Options_1")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class Zitadelidpv2Options1 {
  ...
  @javax.annotation.Nullable
  private V2AutoLinkingOption autoLinking = V2AutoLinkingOption.AUTO_LINKING_OPTION_UNSPECIFIED;

  public Zitadelidpv2Options1() {
  }

  public Zitadelidpv2Options1 isLinkingAllowed(@javax.annotation.Nullable Boolean isLinkingAllowed) {
  ...
  public Zitadelidpv2Options1 isCreationAllowed(@javax.annotation.Nullable Boolean isCreationAllowed) {
  ...
  public Zitadelidpv2Options1 isAutoCreation(@javax.annotation.Nullable Boolean isAutoCreation) {
  ...
  public Zitadelidpv2Options1 isAutoUpdate(@javax.annotation.Nullable Boolean isAutoUpdate) {
  ...
  public Zitadelidpv2Options1 autoLinking(@javax.annotation.Nullable V2AutoLinkingOption autoLinking) {
  ...
  public V2AutoLinkingOption getAutoLinking() {
    return autoLinking;
  }
  ...
  @JsonProperty(JSON_PROPERTY_AUTO_LINKING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAutoLinking(@javax.annotation.Nullable V2AutoLinkingOption autoLinking) {
    this.autoLinking = autoLinking;
  }
  ...
  public boolean equals(Object o) {
    ...
    Zitadelidpv2Options1 zitadelidpv2Options1 = (Zitadelidpv2Options1) o;
    return Objects.equals(this.isLinkingAllowed, zitadelidpv2Options1.isLinkingAllowed) &&
        Objects.equals(this.isCreationAllowed, zitadelidpv2Options1.isCreationAllowed) &&
        Objects.equals(this.isAutoCreation, zitadelidpv2Options1.isAutoCreation) &&
        Objects.equals(this.isAutoUpdate, zitadelidpv2Options1.isAutoUpdate) &&
        Objects.equals(this.autoLinking, zitadelidpv2Options1.autoLinking);
  }
  ...
  public String toString() {
    ...
    sb.append("class Zitadelidpv2Options1 {\n");
