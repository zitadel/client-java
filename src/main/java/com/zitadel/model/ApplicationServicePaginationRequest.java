 ...
 */
@JsonPropertyOrder({
  ApplicationServicePaginationRequest.JSON_PROPERTY_OFFSET,
  ApplicationServicePaginationRequest.JSON_PROPERTY_LIMIT,
  ApplicationServicePaginationRequest.JSON_PROPERTY_ASC
})
@javax.annotation.Generated(value = "io.github.mridang.codegen.generators.java.BetterJavaCodegen", comments = "Generator version: 7.14.0")
public class ApplicationServicePaginationRequest {
  ...
  public ApplicationServicePaginationRequest() {
  }

  public ApplicationServicePaginationRequest offset(@javax.annotation.Nullable Object offset) {
  ...
  public ApplicationServicePaginationRequest limit(@javax.annotation.Nullable Integer limit) {
  ...
  public ApplicationServicePaginationRequest asc(@javax.annotation.Nullable Boolean asc) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicationServicePaginationRequest applicationServicePaginationRequest = (ApplicationServicePaginationRequest) o;
    return equalsNullable(this.offset, applicationServicePaginationRequest.offset) &&
        Objects.equals(this.limit, applicationServicePaginationRequest.limit) &&
        Objects.equals(this.asc, applicationServicePaginationRequest.asc);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicationServicePaginationRequest {\n");
