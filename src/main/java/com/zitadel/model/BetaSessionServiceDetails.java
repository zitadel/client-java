 ...
 */
@JsonPropertyOrder({
  BetaSessionServiceDetails.JSON_PROPERTY_SEQUENCE,
  BetaSessionServiceDetails.JSON_PROPERTY_CHANGE_DATE,
  BetaSessionServiceDetails.JSON_PROPERTY_RESOURCE_OWNER,
  BetaSessionServiceDetails.JSON_PROPERTY_CREATION_DATE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class BetaSessionServiceDetails {
  ...
  public BetaSessionServiceDetails() {
  }

  public BetaSessionServiceDetails sequence(@javax.annotation.Nullable Object sequence) {
  ...
  public BetaSessionServiceDetails changeDate(@javax.annotation.Nullable OffsetDateTime changeDate) {
  ...
  public BetaSessionServiceDetails resourceOwner(@javax.annotation.Nullable String resourceOwner) {
  ...
  public BetaSessionServiceDetails creationDate(@javax.annotation.Nullable OffsetDateTime creationDate) {
  ...
  public boolean equals(Object o) {
    ...
    BetaSessionServiceDetails betaSessionServiceDetails = (BetaSessionServiceDetails) o;
    return equalsNullable(this.sequence, betaSessionServiceDetails.sequence) &&
        Objects.equals(this.changeDate, betaSessionServiceDetails.changeDate) &&
        Objects.equals(this.resourceOwner, betaSessionServiceDetails.resourceOwner) &&
        Objects.equals(this.creationDate, betaSessionServiceDetails.creationDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class BetaSessionServiceDetails {\n");
