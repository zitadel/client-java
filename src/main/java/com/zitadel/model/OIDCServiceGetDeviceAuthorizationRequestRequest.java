...
public class OIDCServiceGetDeviceAuthorizationRequestRequest {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof OIDCServiceGetDeviceAuthorizationRequestRequest other)) {
      return false;
    }
    return java.util.Objects.equals(this.userCode, other.userCode);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(userCode);
  }
}
