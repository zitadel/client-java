...
public class UserServiceRemoveIDPLinkRequest {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof UserServiceRemoveIDPLinkRequest other)) {
      return false;
    }
    return java.util.Objects.equals(this.userId, other.userId)
        && java.util.Objects.equals(this.idpId, other.idpId)
        && java.util.Objects.equals(this.linkedUserId, other.linkedUserId);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(userId, idpId, linkedUserId);
  }
}
