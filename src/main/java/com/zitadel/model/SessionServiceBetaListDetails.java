...
/**
 * SessionServiceBetaListDetails
 */
@JsonPropertyOrder({
  SessionServiceBetaListDetails.JSON_PROPERTY_TOTAL_RESULT,
  SessionServiceBetaListDetails.JSON_PROPERTY_PROCESSED_SEQUENCE,
  SessionServiceBetaListDetails.JSON_PROPERTY_TIMESTAMP
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class SessionServiceBetaListDetails {
  ...
  public SessionServiceBetaListDetails() {
  }

  public SessionServiceBetaListDetails totalResult(@javax.annotation.Nullable String totalResult) {
  ...
  public SessionServiceBetaListDetails processedSequence(@javax.annotation.Nullable String processedSequence) {
  ...
  public SessionServiceBetaListDetails timestamp(@javax.annotation.Nullable OffsetDateTime timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    SessionServiceBetaListDetails sessionServiceBetaListDetails = (SessionServiceBetaListDetails) o;
    return Objects.equals(this.totalResult, sessionServiceBetaListDetails.totalResult) &&
        Objects.equals(this.processedSequence, sessionServiceBetaListDetails.processedSequence) &&
        Objects.equals(this.timestamp, sessionServiceBetaListDetails.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class SessionServiceBetaListDetails {\n");
