...
public class ActionServicePublicKey {
  ...
  /**
   * KeyID is the unique identifier of the public key. It's also used as the `kid` field in the JWE
   * header when the payload type is set to `PAYLOAD_TYPE_JWE`.
   *
   * <p>Example: {@code null}
   */
  @JsonProperty("keyId")
  ...
  /**
   * Active indicates whether the public key is active and used for payload encryption. Only one
   * public key can be active at a time.
   *
   * <p>Example: {@code null}
   */
  @JsonProperty("active")
  ...
  public int hashCode() {
    return java.util.Objects.hash(
        keyId,
        active,
        java.util.Arrays.hashCode(publicKey),
        fingerprint,
        expirationDate,
        creationDate,
        changeDate);
