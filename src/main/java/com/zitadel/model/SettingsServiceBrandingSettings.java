...
import com.zitadel.model.SettingsServiceTheme;
import com.zitadel.model.SettingsServiceThemeMode;
 ...
 */
@JsonPropertyOrder({
  SettingsServiceBrandingSettings.JSON_PROPERTY_LIGHT_THEME,
  SettingsServiceBrandingSettings.JSON_PROPERTY_DARK_THEME,
  SettingsServiceBrandingSettings.JSON_PROPERTY_FONT_URL,
  SettingsServiceBrandingSettings.JSON_PROPERTY_HIDE_LOGIN_NAME_SUFFIX,
  SettingsServiceBrandingSettings.JSON_PROPERTY_DISABLE_WATERMARK,
...
public class SettingsServiceBrandingSettings {
  ...
  private SettingsServiceTheme lightTheme;

  public static final String JSON_PROPERTY_DARK_THEME = "darkTheme";
  @javax.annotation.Nullable
  private SettingsServiceTheme darkTheme;
  ...
  public SettingsServiceBrandingSettings lightTheme(@javax.annotation.Nullable SettingsServiceTheme lightTheme) {
  ...
  public SettingsServiceTheme getLightTheme() {
    return lightTheme;
  }
  ...
  @JsonProperty(JSON_PROPERTY_LIGHT_THEME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLightTheme(@javax.annotation.Nullable SettingsServiceTheme lightTheme) {
    this.lightTheme = lightTheme;
  }

  public SettingsServiceBrandingSettings darkTheme(@javax.annotation.Nullable SettingsServiceTheme darkTheme) {
  ...
  public SettingsServiceTheme getDarkTheme() {
    return darkTheme;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DARK_THEME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDarkTheme(@javax.annotation.Nullable SettingsServiceTheme darkTheme) {
    this.darkTheme = darkTheme;
  }

  public SettingsServiceBrandingSettings fontUrl(@javax.annotation.Nullable String fontUrl) {
  ...
  public SettingsServiceBrandingSettings hideLoginNameSuffix(@javax.annotation.Nullable Boolean hideLoginNameSuffix) {
  ...
  public SettingsServiceBrandingSettings disableWatermark(@javax.annotation.Nullable Boolean disableWatermark) {
  ...
  public SettingsServiceBrandingSettings resourceOwnerType(@javax.annotation.Nullable SettingsServiceResourceOwnerType resourceOwnerType) {
  ...
  public SettingsServiceBrandingSettings themeMode(@javax.annotation.Nullable SettingsServiceThemeMode themeMode) {
  ...
  public SettingsServiceThemeMode getThemeMode() {
    return themeMode;
  }
  ...
  @JsonProperty(JSON_PROPERTY_THEME_MODE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setThemeMode(@javax.annotation.Nullable SettingsServiceThemeMode themeMode) {
    this.themeMode = themeMode;
  }
  ...
  public boolean equals(Object o) {
    ...
    SettingsServiceBrandingSettings settingsServiceBrandingSettings = (SettingsServiceBrandingSettings) o;
    return Objects.equals(this.lightTheme, settingsServiceBrandingSettings.lightTheme) &&
        Objects.equals(this.darkTheme, settingsServiceBrandingSettings.darkTheme) &&
        Objects.equals(this.fontUrl, settingsServiceBrandingSettings.fontUrl) &&
        Objects.equals(this.hideLoginNameSuffix, settingsServiceBrandingSettings.hideLoginNameSuffix) &&
        Objects.equals(this.disableWatermark, settingsServiceBrandingSettings.disableWatermark) &&
        Objects.equals(this.resourceOwnerType, settingsServiceBrandingSettings.resourceOwnerType) &&
        Objects.equals(this.themeMode, settingsServiceBrandingSettings.themeMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class SettingsServiceBrandingSettings {\n");
