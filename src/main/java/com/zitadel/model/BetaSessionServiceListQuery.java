 ...
 */
@JsonPropertyOrder({
  BetaSessionServiceListQuery.JSON_PROPERTY_OFFSET,
  BetaSessionServiceListQuery.JSON_PROPERTY_LIMIT,
  BetaSessionServiceListQuery.JSON_PROPERTY_ASC
})
...
public class BetaSessionServiceListQuery {
  ...
  public BetaSessionServiceListQuery() {
  }

  public BetaSessionServiceListQuery offset(@javax.annotation.Nullable Object offset) {
  ...
  public BetaSessionServiceListQuery limit(@javax.annotation.Nullable Integer limit) {
  ...
  public BetaSessionServiceListQuery asc(@javax.annotation.Nullable Boolean asc) {
  ...
  public boolean equals(Object o) {
    ...
    BetaSessionServiceListQuery betaSessionServiceListQuery = (BetaSessionServiceListQuery) o;
    return equalsNullable(this.offset, betaSessionServiceListQuery.offset) &&
        Objects.equals(this.limit, betaSessionServiceListQuery.limit) &&
        Objects.equals(this.asc, betaSessionServiceListQuery.asc);
  }
  ...
  public String toString() {
    ...
    sb.append("class BetaSessionServiceListQuery {\n");
