...
public class BetaUserServiceResendPhoneCodeRequest {
  ...
  public BetaUserServiceResendPhoneCodeRequest userId(@javax.annotation.Nullable String userId) {
  ...
  public BetaUserServiceResendPhoneCodeRequest returnCode(@javax.annotation.Nullable Object returnCode) {
  ...
  public BetaUserServiceResendPhoneCodeRequest sendCode(@javax.annotation.Nullable Object sendCode) {
