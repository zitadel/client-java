 ...
 */
@JsonPropertyOrder({
  SessionServiceSendCode.JSON_PROPERTY_URL_TEMPLATE
})
...
public class SessionServiceSendCode {
  ...
  public SessionServiceSendCode urlTemplate(@javax.annotation.Nullable String urlTemplate) {
  ...
  public boolean equals(Object o) {
    ...
    SessionServiceSendCode sessionServiceSendCode = (SessionServiceSendCode) o;
    return equalsNullable(this.urlTemplate, sessionServiceSendCode.urlTemplate);
  }
  ...
  public String toString() {
    ...
    sb.append("class SessionServiceSendCode {\n");
