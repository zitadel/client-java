...
public class IdentityProviderServiceGitLabConfig {
  ...
  public IdentityProviderServiceGitLabConfig clientId(@javax.annotation.Nullable String clientId) {
  ...
  public IdentityProviderServiceGitLabConfig scopes(@javax.annotation.Nullable List<String> scopes) {
    
    this.scopes = scopes;
    return this;
  }

  public IdentityProviderServiceGitLabConfig addScopesItem(String scopesItem) {
    if (this.scopes == null) {
  ...
  public boolean equals(Object o) {
    ...
    IdentityProviderServiceGitLabConfig identityProviderServiceGitLabConfig = (IdentityProviderServiceGitLabConfig) o;
    return Objects.equals(this.clientId, identityProviderServiceGitLabConfig.clientId) &&
        Objects.equals(this.scopes, identityProviderServiceGitLabConfig.scopes);
  }
  ...
  public String toString() {
    ...
    sb.append("class IdentityProviderServiceGitLabConfig {\n");
