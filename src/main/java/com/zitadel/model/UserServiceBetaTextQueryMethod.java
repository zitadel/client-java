...
/**
 * Gets or Sets UserServiceBetaTextQueryMethod
 */
public enum UserServiceBetaTextQueryMethod {
  ...
  UserServiceBetaTextQueryMethod(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static UserServiceBetaTextQueryMethod fromValue(String value) {
    for (UserServiceBetaTextQueryMethod b : UserServiceBetaTextQueryMethod.values()) {
