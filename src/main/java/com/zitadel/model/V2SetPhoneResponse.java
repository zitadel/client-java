 ...
 */
@JsonPropertyOrder({
  V2SetPhoneResponse.JSON_PROPERTY_DETAILS,
  V2SetPhoneResponse.JSON_PROPERTY_VERIFICATION_CODE
})
@JsonTypeName("v2SetPhoneResponse")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2SetPhoneResponse {
  ...
  public V2SetPhoneResponse() {
  }

  public V2SetPhoneResponse details(@javax.annotation.Nullable V2Details details) {
  ...
  public V2SetPhoneResponse verificationCode(@javax.annotation.Nullable String verificationCode) {
  ...
  public boolean equals(Object o) {
    ...
    V2SetPhoneResponse v2SetPhoneResponse = (V2SetPhoneResponse) o;
    return Objects.equals(this.details, v2SetPhoneResponse.details) &&
        Objects.equals(this.verificationCode, v2SetPhoneResponse.verificationCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2SetPhoneResponse {\n");
