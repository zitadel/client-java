...
/**
 * SettingsServiceBetaGetGeneralSettingsResponse
 */
@JsonPropertyOrder({
  SettingsServiceBetaGetGeneralSettingsResponse.JSON_PROPERTY_DEFAULT_ORG_ID,
  SettingsServiceBetaGetGeneralSettingsResponse.JSON_PROPERTY_DEFAULT_LANGUAGE,
  SettingsServiceBetaGetGeneralSettingsResponse.JSON_PROPERTY_SUPPORTED_LANGUAGES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class SettingsServiceBetaGetGeneralSettingsResponse {
  ...
  public SettingsServiceBetaGetGeneralSettingsResponse() {
  }

  public SettingsServiceBetaGetGeneralSettingsResponse defaultOrgId(@javax.annotation.Nullable String defaultOrgId) {
  ...
  public SettingsServiceBetaGetGeneralSettingsResponse defaultLanguage(@javax.annotation.Nullable String defaultLanguage) {
  ...
  public SettingsServiceBetaGetGeneralSettingsResponse supportedLanguages(@javax.annotation.Nullable List<String> supportedLanguages) {
    
    this.supportedLanguages = supportedLanguages;
    return this;
  }

  public SettingsServiceBetaGetGeneralSettingsResponse addSupportedLanguagesItem(String supportedLanguagesItem) {
  ...
  public boolean equals(Object o) {
    ...
    SettingsServiceBetaGetGeneralSettingsResponse settingsServiceBetaGetGeneralSettingsResponse = (SettingsServiceBetaGetGeneralSettingsResponse) o;
    return Objects.equals(this.defaultOrgId, settingsServiceBetaGetGeneralSettingsResponse.defaultOrgId) &&
        Objects.equals(this.defaultLanguage, settingsServiceBetaGetGeneralSettingsResponse.defaultLanguage) &&
        Objects.equals(this.supportedLanguages, settingsServiceBetaGetGeneralSettingsResponse.supportedLanguages);
  }
  ...
  public String toString() {
    ...
    sb.append("class SettingsServiceBetaGetGeneralSettingsResponse {\n");
