 ...
 */
@JsonPropertyOrder({
  Userv2SetPassword.JSON_PROPERTY_PASSWORD,
  Userv2SetPassword.JSON_PROPERTY_HASHED_PASSWORD,
  Userv2SetPassword.JSON_PROPERTY_CURRENT_PASSWORD,
  Userv2SetPassword.JSON_PROPERTY_VERIFICATION_CODE
})
@JsonTypeName("userv2SetPassword")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class Userv2SetPassword {
  ...
  public Userv2SetPassword() {
  }

  public Userv2SetPassword password(@javax.annotation.Nullable V2Password password) {
  ...
  public Userv2SetPassword hashedPassword(@javax.annotation.Nullable V2HashedPassword hashedPassword) {
  ...
  public Userv2SetPassword currentPassword(@javax.annotation.Nonnull String currentPassword) {
  ...
  public Userv2SetPassword verificationCode(@javax.annotation.Nonnull String verificationCode) {
  ...
  public boolean equals(Object o) {
    ...
    Userv2SetPassword userv2SetPassword = (Userv2SetPassword) o;
    return Objects.equals(this.password, userv2SetPassword.password) &&
        Objects.equals(this.hashedPassword, userv2SetPassword.hashedPassword) &&
        Objects.equals(this.currentPassword, userv2SetPassword.currentPassword) &&
        Objects.equals(this.verificationCode, userv2SetPassword.verificationCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class Userv2SetPassword {\n");
