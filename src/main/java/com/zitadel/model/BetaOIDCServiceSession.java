 ...
 */
@JsonPropertyOrder({
  BetaOIDCServiceSession.JSON_PROPERTY_SESSION_ID,
  BetaOIDCServiceSession.JSON_PROPERTY_SESSION_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class BetaOIDCServiceSession {
  ...
  public BetaOIDCServiceSession() {
  }

  public BetaOIDCServiceSession sessionId(@javax.annotation.Nullable String sessionId) {
  ...
  public BetaOIDCServiceSession sessionToken(@javax.annotation.Nullable String sessionToken) {
  ...
  public boolean equals(Object o) {
    ...
    BetaOIDCServiceSession betaOIDCServiceSession = (BetaOIDCServiceSession) o;
    return Objects.equals(this.sessionId, betaOIDCServiceSession.sessionId) &&
        Objects.equals(this.sessionToken, betaOIDCServiceSession.sessionToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class BetaOIDCServiceSession {\n");
