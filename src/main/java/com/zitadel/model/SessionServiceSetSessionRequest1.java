...
/**
 * SessionServiceSetSessionRequest1
 */
@JsonPropertyOrder({
  SessionServiceSetSessionRequest1.JSON_PROPERTY_SESSION_TOKEN,
  SessionServiceSetSessionRequest1.JSON_PROPERTY_CHECKS,
  SessionServiceSetSessionRequest1.JSON_PROPERTY_METADATA,
  SessionServiceSetSessionRequest1.JSON_PROPERTY_CHALLENGES,
  SessionServiceSetSessionRequest1.JSON_PROPERTY_LIFETIME
})
@JsonTypeName("SessionServiceSetSessionRequest_1")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class SessionServiceSetSessionRequest1 {
  ...
  public SessionServiceSetSessionRequest1() {
  }

  public SessionServiceSetSessionRequest1 sessionToken(@javax.annotation.Nullable String sessionToken) {
  ...
  public SessionServiceSetSessionRequest1 checks(@javax.annotation.Nullable SessionServiceChecks checks) {
  ...
  public SessionServiceSetSessionRequest1 metadata(@javax.annotation.Nullable Map<String, byte[]> metadata) {
    
    this.metadata = metadata;
    return this;
  }

  public SessionServiceSetSessionRequest1 putMetadataItem(String key, byte[] metadataItem) {
  ...
  public SessionServiceSetSessionRequest1 challenges(@javax.annotation.Nullable SessionServiceRequestChallenges challenges) {
  ...
  public SessionServiceSetSessionRequest1 lifetime(@javax.annotation.Nullable String lifetime) {
  ...
  public boolean equals(Object o) {
    ...
    SessionServiceSetSessionRequest1 sessionServiceSetSessionRequest1 = (SessionServiceSetSessionRequest1) o;
    return Objects.equals(this.sessionToken, sessionServiceSetSessionRequest1.sessionToken) &&
        Objects.equals(this.checks, sessionServiceSetSessionRequest1.checks) &&
        Objects.equals(this.metadata, sessionServiceSetSessionRequest1.metadata) &&
        Objects.equals(this.challenges, sessionServiceSetSessionRequest1.challenges) &&
        Objects.equals(this.lifetime, sessionServiceSetSessionRequest1.lifetime);
  }
  ...
  public String toString() {
    ...
    sb.append("class SessionServiceSetSessionRequest1 {\n");
