...
public enum IdentityProviderServiceAzureADTenantType {
  ...
  public static IdentityProviderServiceAzureADTenantType fromValue(String value) {
    for (IdentityProviderServiceAzureADTenantType b : values()) {
