...
public class BetaUserServiceCreatePasskeyRegistrationLinkRequest {
  ...
  /** The {@code sendLink} property. */
  @JsonProperty("sendLink")
  @Nullable
  public BetaUserServiceSendPasskeyRegistrationLink sendLink;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaUserServiceCreatePasskeyRegistrationLinkRequest other)) {
      return false;
    }
    return java.util.Objects.equals(this.userId, other.userId)
        && java.util.Objects.equals(this.returnCode, other.returnCode)
        && java.util.Objects.equals(this.sendLink, other.sendLink);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(userId, returnCode, sendLink);
  }
}
