 ...
 */
@JsonPropertyOrder({
  OrganizationServicePaginationRequest.JSON_PROPERTY_OFFSET,
  OrganizationServicePaginationRequest.JSON_PROPERTY_LIMIT,
  OrganizationServicePaginationRequest.JSON_PROPERTY_ASC
})
@javax.annotation.Generated(value = "io.github.mridang.codegen.generators.java.BetterJavaCodegen", comments = "Generator version: 7.14.0")
public class OrganizationServicePaginationRequest {
  ...
  public OrganizationServicePaginationRequest() {
  }

  public OrganizationServicePaginationRequest offset(@javax.annotation.Nullable Object offset) {
  ...
  public OrganizationServicePaginationRequest limit(@javax.annotation.Nullable Integer limit) {
  ...
  public OrganizationServicePaginationRequest asc(@javax.annotation.Nullable Boolean asc) {
  ...
  public boolean equals(Object o) {
    ...
    OrganizationServicePaginationRequest organizationServicePaginationRequest = (OrganizationServicePaginationRequest) o;
    return equalsNullable(this.offset, organizationServicePaginationRequest.offset) &&
        Objects.equals(this.limit, organizationServicePaginationRequest.limit) &&
        Objects.equals(this.asc, organizationServicePaginationRequest.asc);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationServicePaginationRequest {\n");
