...
public class UserServiceDomainQuery {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof UserServiceDomainQuery other)) {
      return false;
    }
    return java.util.Objects.equals(this.includeWithoutDomain, other.includeWithoutDomain)
        && java.util.Objects.equals(this.domain, other.domain);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(includeWithoutDomain, domain);
  }
}
