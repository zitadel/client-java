...
public enum BetaAppServiceAPIAuthMethodType {
  ...
  BetaAppServiceAPIAuthMethodType(String value) {
    this.value = value;
  }
  ...
  public static BetaAppServiceAPIAuthMethodType fromValue(String value) {
    for (BetaAppServiceAPIAuthMethodType b : values()) {
