...
public enum BetaUserServiceTextQueryMethod {
  ...
  BetaUserServiceTextQueryMethod(String value) {
    this.value = value;
  }
  ...
  public static BetaUserServiceTextQueryMethod fromValue(String value) {
    for (BetaUserServiceTextQueryMethod b : values()) {
