...
/**
 * FeatureServiceSetInstanceFeaturesRequest1
 */
@JsonPropertyOrder({
  FeatureServiceSetInstanceFeaturesRequest1.JSON_PROPERTY_LOGIN_DEFAULT_ORG,
  FeatureServiceSetInstanceFeaturesRequest1.JSON_PROPERTY_OIDC_TRIGGER_INTROSPECTION_PROJECTIONS,
  FeatureServiceSetInstanceFeaturesRequest1.JSON_PROPERTY_OIDC_LEGACY_INTROSPECTION,
  FeatureServiceSetInstanceFeaturesRequest1.JSON_PROPERTY_USER_SCHEMA,
  FeatureServiceSetInstanceFeaturesRequest1.JSON_PROPERTY_OIDC_TOKEN_EXCHANGE,
  FeatureServiceSetInstanceFeaturesRequest1.JSON_PROPERTY_ACTIONS,
  FeatureServiceSetInstanceFeaturesRequest1.JSON_PROPERTY_IMPROVED_PERFORMANCE,
  FeatureServiceSetInstanceFeaturesRequest1.JSON_PROPERTY_WEB_KEY,
  FeatureServiceSetInstanceFeaturesRequest1.JSON_PROPERTY_DEBUG_OIDC_PARENT_ERROR,
  FeatureServiceSetInstanceFeaturesRequest1.JSON_PROPERTY_OIDC_SINGLE_V1_SESSION_TERMINATION,
  FeatureServiceSetInstanceFeaturesRequest1.JSON_PROPERTY_DISABLE_USER_TOKEN_EVENT,
  FeatureServiceSetInstanceFeaturesRequest1.JSON_PROPERTY_ENABLE_BACK_CHANNEL_LOGOUT,
  FeatureServiceSetInstanceFeaturesRequest1.JSON_PROPERTY_LOGIN_V2,
  FeatureServiceSetInstanceFeaturesRequest1.JSON_PROPERTY_PERMISSION_CHECK_V2,
  FeatureServiceSetInstanceFeaturesRequest1.JSON_PROPERTY_CONSOLE_USE_V2_USER_API
})
@JsonTypeName("FeatureServiceSetInstanceFeaturesRequest_1")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class FeatureServiceSetInstanceFeaturesRequest1 {
  ...
  public FeatureServiceSetInstanceFeaturesRequest1() {
  }

  public FeatureServiceSetInstanceFeaturesRequest1 loginDefaultOrg(@javax.annotation.Nullable Boolean loginDefaultOrg) {
  ...
  public FeatureServiceSetInstanceFeaturesRequest1 oidcTriggerIntrospectionProjections(@javax.annotation.Nullable Boolean oidcTriggerIntrospectionProjections) {
  ...
  public FeatureServiceSetInstanceFeaturesRequest1 oidcLegacyIntrospection(@javax.annotation.Nullable Boolean oidcLegacyIntrospection) {
  ...
  public FeatureServiceSetInstanceFeaturesRequest1 userSchema(@javax.annotation.Nullable Boolean userSchema) {
  ...
  public FeatureServiceSetInstanceFeaturesRequest1 oidcTokenExchange(@javax.annotation.Nullable Boolean oidcTokenExchange) {
  ...
  public FeatureServiceSetInstanceFeaturesRequest1 actions(@javax.annotation.Nullable Boolean actions) {
  ...
  public FeatureServiceSetInstanceFeaturesRequest1 improvedPerformance(@javax.annotation.Nullable List<FeatureServiceImprovedPerformance> improvedPerformance) {
    
    this.improvedPerformance = improvedPerformance;
    return this;
  }

  public FeatureServiceSetInstanceFeaturesRequest1 addImprovedPerformanceItem(FeatureServiceImprovedPerformance improvedPerformanceItem) {
  ...
  public FeatureServiceSetInstanceFeaturesRequest1 webKey(@javax.annotation.Nullable Boolean webKey) {
  ...
  public FeatureServiceSetInstanceFeaturesRequest1 debugOidcParentError(@javax.annotation.Nullable Boolean debugOidcParentError) {
  ...
  public FeatureServiceSetInstanceFeaturesRequest1 oidcSingleV1SessionTermination(@javax.annotation.Nullable Boolean oidcSingleV1SessionTermination) {
  ...
  public FeatureServiceSetInstanceFeaturesRequest1 disableUserTokenEvent(@javax.annotation.Nullable Boolean disableUserTokenEvent) {
  ...
  public FeatureServiceSetInstanceFeaturesRequest1 enableBackChannelLogout(@javax.annotation.Nullable Boolean enableBackChannelLogout) {
  ...
  public FeatureServiceSetInstanceFeaturesRequest1 loginV2(@javax.annotation.Nullable FeatureServiceLoginV2 loginV2) {
  ...
  public FeatureServiceSetInstanceFeaturesRequest1 permissionCheckV2(@javax.annotation.Nullable Boolean permissionCheckV2) {
  ...
  public FeatureServiceSetInstanceFeaturesRequest1 consoleUseV2UserApi(@javax.annotation.Nullable Boolean consoleUseV2UserApi) {
  ...
  public boolean equals(Object o) {
    ...
    FeatureServiceSetInstanceFeaturesRequest1 featureServiceSetInstanceFeaturesRequest1 = (FeatureServiceSetInstanceFeaturesRequest1) o;
    return Objects.equals(this.loginDefaultOrg, featureServiceSetInstanceFeaturesRequest1.loginDefaultOrg) &&
        Objects.equals(this.oidcTriggerIntrospectionProjections, featureServiceSetInstanceFeaturesRequest1.oidcTriggerIntrospectionProjections) &&
        Objects.equals(this.oidcLegacyIntrospection, featureServiceSetInstanceFeaturesRequest1.oidcLegacyIntrospection) &&
        Objects.equals(this.userSchema, featureServiceSetInstanceFeaturesRequest1.userSchema) &&
        Objects.equals(this.oidcTokenExchange, featureServiceSetInstanceFeaturesRequest1.oidcTokenExchange) &&
        Objects.equals(this.actions, featureServiceSetInstanceFeaturesRequest1.actions) &&
        Objects.equals(this.improvedPerformance, featureServiceSetInstanceFeaturesRequest1.improvedPerformance) &&
        Objects.equals(this.webKey, featureServiceSetInstanceFeaturesRequest1.webKey) &&
        Objects.equals(this.debugOidcParentError, featureServiceSetInstanceFeaturesRequest1.debugOidcParentError) &&
        Objects.equals(this.oidcSingleV1SessionTermination, featureServiceSetInstanceFeaturesRequest1.oidcSingleV1SessionTermination) &&
        Objects.equals(this.disableUserTokenEvent, featureServiceSetInstanceFeaturesRequest1.disableUserTokenEvent) &&
        Objects.equals(this.enableBackChannelLogout, featureServiceSetInstanceFeaturesRequest1.enableBackChannelLogout) &&
        Objects.equals(this.loginV2, featureServiceSetInstanceFeaturesRequest1.loginV2) &&
        Objects.equals(this.permissionCheckV2, featureServiceSetInstanceFeaturesRequest1.permissionCheckV2) &&
        Objects.equals(this.consoleUseV2UserApi, featureServiceSetInstanceFeaturesRequest1.consoleUseV2UserApi);
  }
  ...
  public String toString() {
    ...
    sb.append("class FeatureServiceSetInstanceFeaturesRequest1 {\n");
