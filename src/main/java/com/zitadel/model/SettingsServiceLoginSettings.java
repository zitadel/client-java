...
import com.zitadel.model.SettingsServiceMultiFactorType;
import com.zitadel.model.SettingsServicePasskeysType;
import com.zitadel.model.SettingsServiceResourceOwnerType;
import com.zitadel.model.SettingsServiceSecondFactorType;
...
@JsonPropertyOrder({
  ...
  SettingsServiceLoginSettings.JSON_PROPERTY_PASSKEYS_TYPE,
  SettingsServiceLoginSettings.JSON_PROPERTY_HIDE_PASSWORD_RESET,
  SettingsServiceLoginSettings.JSON_PROPERTY_IGNORE_UNKNOWN_USERNAMES,
  SettingsServiceLoginSettings.JSON_PROPERTY_DEFAULT_REDIRECT_URI,
  SettingsServiceLoginSettings.JSON_PROPERTY_PASSWORD_CHECK_LIFETIME,
  SettingsServiceLoginSettings.JSON_PROPERTY_EXTERNAL_LOGIN_CHECK_LIFETIME,
  SettingsServiceLoginSettings.JSON_PROPERTY_MFA_INIT_SKIP_LIFETIME,
  SettingsServiceLoginSettings.JSON_PROPERTY_SECOND_FACTOR_CHECK_LIFETIME,
  SettingsServiceLoginSettings.JSON_PROPERTY_MULTI_FACTOR_CHECK_LIFETIME,
  SettingsServiceLoginSettings.JSON_PROPERTY_SECOND_FACTORS,
  SettingsServiceLoginSettings.JSON_PROPERTY_MULTI_FACTORS,
  SettingsServiceLoginSettings.JSON_PROPERTY_ALLOW_DOMAIN_DISCOVERY,
  SettingsServiceLoginSettings.JSON_PROPERTY_DISABLE_LOGIN_WITH_EMAIL,
  SettingsServiceLoginSettings.JSON_PROPERTY_DISABLE_LOGIN_WITH_PHONE,
...
public class SettingsServiceLoginSettings {
  ...
  @javax.annotation.Nullable
  private List<SettingsServiceSecondFactorType> secondFactors = new ArrayList<>();

  public static final String JSON_PROPERTY_MULTI_FACTORS = "multiFactors";
  @javax.annotation.Nullable
  private List<SettingsServiceMultiFactorType> multiFactors = new ArrayList<>();
  ...
  public SettingsServiceLoginSettings allowUsernamePassword(@javax.annotation.Nullable Boolean allowUsernamePassword) {
  ...
  public SettingsServiceLoginSettings allowExternalIdp(@javax.annotation.Nullable Boolean allowExternalIdp) {
  ...
  public SettingsServiceLoginSettings forceMfa(@javax.annotation.Nullable Boolean forceMfa) {
  ...
  public SettingsServiceLoginSettings passkeysType(@javax.annotation.Nullable SettingsServicePasskeysType passkeysType) {
  ...
  public SettingsServicePasskeysType getPasskeysType() {
    return passkeysType;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PASSKEYS_TYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPasskeysType(@javax.annotation.Nullable SettingsServicePasskeysType passkeysType) {
    this.passkeysType = passkeysType;
  }

  public SettingsServiceLoginSettings hidePasswordReset(@javax.annotation.Nullable Boolean hidePasswordReset) {
  ...
  public SettingsServiceLoginSettings ignoreUnknownUsernames(@javax.annotation.Nullable Boolean ignoreUnknownUsernames) {
  ...
  public SettingsServiceLoginSettings defaultRedirectUri(@javax.annotation.Nullable String defaultRedirectUri) {
  ...
  public SettingsServiceLoginSettings passwordCheckLifetime(@javax.annotation.Nullable String passwordCheckLifetime) {
  ...
  public SettingsServiceLoginSettings externalLoginCheckLifetime(@javax.annotation.Nullable String externalLoginCheckLifetime) {
  ...
  public SettingsServiceLoginSettings mfaInitSkipLifetime(@javax.annotation.Nullable String mfaInitSkipLifetime) {
  ...
  public SettingsServiceLoginSettings secondFactorCheckLifetime(@javax.annotation.Nullable String secondFactorCheckLifetime) {
  ...
  public SettingsServiceLoginSettings multiFactorCheckLifetime(@javax.annotation.Nullable String multiFactorCheckLifetime) {
  ...
  public SettingsServiceLoginSettings secondFactors(@javax.annotation.Nullable List<SettingsServiceSecondFactorType> secondFactors) {
    
    this.secondFactors = secondFactors;
    return this;
  }

  public SettingsServiceLoginSettings addSecondFactorsItem(SettingsServiceSecondFactorType secondFactorsItem) {
  ...
  public List<SettingsServiceSecondFactorType> getSecondFactors() {
    return secondFactors;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SECOND_FACTORS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSecondFactors(@javax.annotation.Nullable List<SettingsServiceSecondFactorType> secondFactors) {
    this.secondFactors = secondFactors;
  }

  public SettingsServiceLoginSettings multiFactors(@javax.annotation.Nullable List<SettingsServiceMultiFactorType> multiFactors) {
    
    this.multiFactors = multiFactors;
    return this;
  }

  public SettingsServiceLoginSettings addMultiFactorsItem(SettingsServiceMultiFactorType multiFactorsItem) {
  ...
  public List<SettingsServiceMultiFactorType> getMultiFactors() {
    return multiFactors;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MULTI_FACTORS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMultiFactors(@javax.annotation.Nullable List<SettingsServiceMultiFactorType> multiFactors) {
    this.multiFactors = multiFactors;
  }

  public SettingsServiceLoginSettings allowDomainDiscovery(@javax.annotation.Nullable Boolean allowDomainDiscovery) {
  ...
  public SettingsServiceLoginSettings disableLoginWithEmail(@javax.annotation.Nullable Boolean disableLoginWithEmail) {
  ...
  public SettingsServiceLoginSettings disableLoginWithPhone(@javax.annotation.Nullable Boolean disableLoginWithPhone) {
  ...
  public SettingsServiceLoginSettings resourceOwnerType(@javax.annotation.Nullable SettingsServiceResourceOwnerType resourceOwnerType) {
  ...
  public SettingsServiceLoginSettings forceMfaLocalOnly(@javax.annotation.Nullable Boolean forceMfaLocalOnly) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowUsernamePassword, settingsServiceLoginSettings.allowUsernamePassword) &&
        ...
        Objects.equals(this.passkeysType, settingsServiceLoginSettings.passkeysType) &&
        Objects.equals(this.hidePasswordReset, settingsServiceLoginSettings.hidePasswordReset) &&
        Objects.equals(this.ignoreUnknownUsernames, settingsServiceLoginSettings.ignoreUnknownUsernames) &&
        Objects.equals(this.defaultRedirectUri, settingsServiceLoginSettings.defaultRedirectUri) &&
        Objects.equals(this.passwordCheckLifetime, settingsServiceLoginSettings.passwordCheckLifetime) &&
        Objects.equals(this.externalLoginCheckLifetime, settingsServiceLoginSettings.externalLoginCheckLifetime) &&
        Objects.equals(this.mfaInitSkipLifetime, settingsServiceLoginSettings.mfaInitSkipLifetime) &&
        Objects.equals(this.secondFactorCheckLifetime, settingsServiceLoginSettings.secondFactorCheckLifetime) &&
        Objects.equals(this.multiFactorCheckLifetime, settingsServiceLoginSettings.multiFactorCheckLifetime) &&
        Objects.equals(this.secondFactors, settingsServiceLoginSettings.secondFactors) &&
        Objects.equals(this.multiFactors, settingsServiceLoginSettings.multiFactors) &&
        Objects.equals(this.allowDomainDiscovery, settingsServiceLoginSettings.allowDomainDiscovery) &&
        Objects.equals(this.disableLoginWithEmail, settingsServiceLoginSettings.disableLoginWithEmail) &&
        Objects.equals(this.disableLoginWithPhone, settingsServiceLoginSettings.disableLoginWithPhone) &&
        Objects.equals(this.resourceOwnerType, settingsServiceLoginSettings.resourceOwnerType) &&
        Objects.equals(this.forceMfaLocalOnly, settingsServiceLoginSettings.forceMfaLocalOnly);
  }
