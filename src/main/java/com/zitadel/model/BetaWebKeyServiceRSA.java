...
public class BetaWebKeyServiceRSA {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaWebKeyServiceRSA other)) {
      return false;
    }
    return java.util.Objects.equals(this.bits, other.bits)
        && java.util.Objects.equals(this.hasher, other.hasher);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(bits, hasher);
  }
}
