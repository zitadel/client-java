...
/**
 * SessionServiceListSessionsRequest1
 */
@JsonPropertyOrder({
  SessionServiceListSessionsRequest1.JSON_PROPERTY_QUERY,
  SessionServiceListSessionsRequest1.JSON_PROPERTY_QUERIES,
  SessionServiceListSessionsRequest1.JSON_PROPERTY_SORTING_COLUMN
})
@JsonTypeName("SessionServiceListSessionsRequest_1")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class SessionServiceListSessionsRequest1 {
  ...
  public SessionServiceListSessionsRequest1() {
  }

  public SessionServiceListSessionsRequest1 query(@javax.annotation.Nullable SessionServiceListQuery query) {
  ...
  public SessionServiceListSessionsRequest1 queries(@javax.annotation.Nullable List<SessionServiceSearchQuery> queries) {
    
    this.queries = queries;
    return this;
  }

  public SessionServiceListSessionsRequest1 addQueriesItem(SessionServiceSearchQuery queriesItem) {
  ...
  public SessionServiceListSessionsRequest1 sortingColumn(@javax.annotation.Nullable SessionServiceSessionFieldName sortingColumn) {
  ...
  public boolean equals(Object o) {
    ...
    SessionServiceListSessionsRequest1 sessionServiceListSessionsRequest1 = (SessionServiceListSessionsRequest1) o;
    return Objects.equals(this.query, sessionServiceListSessionsRequest1.query) &&
        Objects.equals(this.queries, sessionServiceListSessionsRequest1.queries) &&
        Objects.equals(this.sortingColumn, sessionServiceListSessionsRequest1.sortingColumn);
  }
  ...
  public String toString() {
    ...
    sb.append("class SessionServiceListSessionsRequest1 {\n");
