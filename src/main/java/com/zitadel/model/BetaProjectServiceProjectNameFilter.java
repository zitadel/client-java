...
public class BetaProjectServiceProjectNameFilter {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaProjectServiceProjectNameFilter other)) {
      return false;
    }
    return java.util.Objects.equals(this.projectName, other.projectName)
        && java.util.Objects.equals(this.method, other.method);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(projectName, method);
  }
}
