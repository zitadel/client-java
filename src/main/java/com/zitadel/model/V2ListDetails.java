 ...
 */
@JsonPropertyOrder({
  V2ListDetails.JSON_PROPERTY_TOTAL_RESULT,
  V2ListDetails.JSON_PROPERTY_PROCESSED_SEQUENCE,
  V2ListDetails.JSON_PROPERTY_TIMESTAMP
})
@JsonTypeName("v2ListDetails")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2ListDetails {
  ...
  public V2ListDetails() {
  }

  public V2ListDetails totalResult(@javax.annotation.Nullable String totalResult) {
  ...
  public V2ListDetails processedSequence(@javax.annotation.Nullable String processedSequence) {
  ...
  public V2ListDetails timestamp(@javax.annotation.Nullable OffsetDateTime timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    V2ListDetails v2ListDetails = (V2ListDetails) o;
    return Objects.equals(this.totalResult, v2ListDetails.totalResult) &&
        Objects.equals(this.processedSequence, v2ListDetails.processedSequence) &&
        Objects.equals(this.timestamp, v2ListDetails.timestamp);
  }
