...
public class ProjectServiceProjectGrantSearchFilter {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ProjectServiceProjectGrantSearchFilter other)) {
      return false;
    }
    return java.util.Objects.equals(
            this.grantedOrganizationIdFilter, other.grantedOrganizationIdFilter)
        && java.util.Objects.equals(this.inProjectIdsFilter, other.inProjectIdsFilter)
