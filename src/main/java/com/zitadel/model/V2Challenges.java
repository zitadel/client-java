 ...
 */
@JsonPropertyOrder({
  V2Challenges.JSON_PROPERTY_WEB_AUTH_N,
  V2Challenges.JSON_PROPERTY_OTP_SMS,
  V2Challenges.JSON_PROPERTY_OTP_EMAIL
})
@JsonTypeName("v2Challenges")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2Challenges {
  public static final String JSON_PROPERTY_WEB_AUTH_N = "webAuthN";
  @javax.annotation.Nullable
  private V2ChallengesWebAuthN webAuthN;
  ...
  public V2Challenges webAuthN(@javax.annotation.Nullable V2ChallengesWebAuthN webAuthN) {
  ...
  public V2ChallengesWebAuthN getWebAuthN() {
    return webAuthN;
  }
  ...
  @JsonProperty(JSON_PROPERTY_WEB_AUTH_N)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setWebAuthN(@javax.annotation.Nullable V2ChallengesWebAuthN webAuthN) {
    this.webAuthN = webAuthN;
  }

  public V2Challenges otpSms(@javax.annotation.Nullable String otpSms) {
  ...
  public V2Challenges otpEmail(@javax.annotation.Nullable String otpEmail) {
  ...
  public boolean equals(Object o) {
    ...
    V2Challenges v2Challenges = (V2Challenges) o;
    return Objects.equals(this.webAuthN, v2Challenges.webAuthN) &&
        Objects.equals(this.otpSms, v2Challenges.otpSms) &&
        Objects.equals(this.otpEmail, v2Challenges.otpEmail);
  }
