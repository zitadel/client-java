...
public enum ApplicationServiceOIDCResponseType {
  ...
  /** The {@code "OIDC_RESPONSE_TYPE_CODE"} value. */
  OIDC_RESPONSE_TYPE_CODE("OIDC_RESPONSE_TYPE_CODE"),
  /** The {@code "OIDC_RESPONSE_TYPE_ID_TOKEN"} value. */
  OIDC_RESPONSE_TYPE_ID_TOKEN("OIDC_RESPONSE_TYPE_ID_TOKEN"),
  /** The {@code "OIDC_RESPONSE_TYPE_ID_TOKEN_TOKEN"} value. */
  OIDC_RESPONSE_TYPE_ID_TOKEN_TOKEN("OIDC_RESPONSE_TYPE_ID_TOKEN_TOKEN");

  private final String value;

  ApplicationServiceOIDCResponseType(String value) {
    this.value = value;
  }
  ...
  public static ApplicationServiceOIDCResponseType fromValue(String value) {
    for (ApplicationServiceOIDCResponseType b : values()) {
