 ...
 */
@JsonPropertyOrder({
  ProjectServiceAny.JSON_PROPERTY_TYPE,
  ProjectServiceAny.JSON_PROPERTY_VALUE,
  ProjectServiceAny.JSON_PROPERTY_DEBUG
})
@javax.annotation.Generated(value = "io.github.mridang.codegen.generators.java.BetterJavaCodegen", comments = "Generator version: 7.14.0")
public class ProjectServiceAny extends HashMap<String, Object> {
  ...
  public ProjectServiceAny() {

  }

  public ProjectServiceAny type(@javax.annotation.Nullable String type) {
  ...
  public ProjectServiceAny value(@javax.annotation.Nullable File value) {
  ...
  public ProjectServiceAny debug(@javax.annotation.Nullable Object debug) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectServiceAny projectServiceAny = (ProjectServiceAny) o;
    return Objects.equals(this.type, projectServiceAny.type) &&
        Objects.equals(this.value, projectServiceAny.value) &&
        equalsNullable(this.debug, projectServiceAny.debug) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectServiceAny {\n");
