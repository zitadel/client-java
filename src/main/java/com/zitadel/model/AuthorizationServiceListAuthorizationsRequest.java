...
public class AuthorizationServiceListAuthorizationsRequest {
  ...
  @Nullable
  public AuthorizationServicePaginationRequest pagination;

  /** Example: {@code null} */
  @JsonProperty("sortingColumn")
  @Nullable
  public AuthorizationServiceAuthorizationFieldName sortingColumn;
  ...
  @Nullable
  public List<AuthorizationServiceAuthorizationsSearchFilter> filters = new ArrayList<>();
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof AuthorizationServiceListAuthorizationsRequest other)) {
      return false;
    }
