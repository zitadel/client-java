 ...
 */
@JsonPropertyOrder({
  InstanceServiceAny.JSON_PROPERTY_TYPE,
  InstanceServiceAny.JSON_PROPERTY_VALUE,
  InstanceServiceAny.JSON_PROPERTY_DEBUG
})
@javax.annotation.Generated(value = "io.github.mridang.codegen.generators.java.BetterJavaCodegen", comments = "Generator version: 7.14.0")
public class InstanceServiceAny extends HashMap<String, Object> {
  ...
  public InstanceServiceAny() {

  }

  public InstanceServiceAny type(@javax.annotation.Nullable String type) {
  ...
  public InstanceServiceAny value(@javax.annotation.Nullable File value) {
  ...
  public InstanceServiceAny debug(@javax.annotation.Nullable Object debug) {
  ...
  public boolean equals(Object o) {
    ...
    InstanceServiceAny instanceServiceAny = (InstanceServiceAny) o;
    return Objects.equals(this.type, instanceServiceAny.type) &&
        Objects.equals(this.value, instanceServiceAny.value) &&
        equalsNullable(this.debug, instanceServiceAny.debug) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstanceServiceAny {\n");
