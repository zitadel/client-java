...
public enum ProjectServiceProjectFieldName {
  ...
  ProjectServiceProjectFieldName(String value) {
    this.value = value;
  }
  ...
  public static ProjectServiceProjectFieldName fromValue(String value) {
    for (ProjectServiceProjectFieldName b : values()) {
