 ...
 */
@JsonPropertyOrder({
  Zitadelidpv2Options.JSON_PROPERTY_IS_LINKING_ALLOWED,
  Zitadelidpv2Options.JSON_PROPERTY_IS_CREATION_ALLOWED,
  Zitadelidpv2Options.JSON_PROPERTY_IS_AUTO_CREATION,
  Zitadelidpv2Options.JSON_PROPERTY_IS_AUTO_UPDATE,
  Zitadelidpv2Options.JSON_PROPERTY_AUTO_LINKING
})
@JsonTypeName("zitadelidpv2Options")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class Zitadelidpv2Options {
  ...
  public Zitadelidpv2Options() {
  }

  public Zitadelidpv2Options isLinkingAllowed(@javax.annotation.Nullable Boolean isLinkingAllowed) {
  ...
  public Zitadelidpv2Options isCreationAllowed(@javax.annotation.Nullable Boolean isCreationAllowed) {
  ...
  public Zitadelidpv2Options isAutoCreation(@javax.annotation.Nullable Boolean isAutoCreation) {
  ...
  public Zitadelidpv2Options isAutoUpdate(@javax.annotation.Nullable Boolean isAutoUpdate) {
  ...
  public Zitadelidpv2Options autoLinking(@javax.annotation.Nullable V2AutoLinkingOption autoLinking) {
  ...
  public boolean equals(Object o) {
    ...
    Zitadelidpv2Options zitadelidpv2Options = (Zitadelidpv2Options) o;
    return Objects.equals(this.isLinkingAllowed, zitadelidpv2Options.isLinkingAllowed) &&
        Objects.equals(this.isCreationAllowed, zitadelidpv2Options.isCreationAllowed) &&
        Objects.equals(this.isAutoCreation, zitadelidpv2Options.isAutoCreation) &&
        Objects.equals(this.isAutoUpdate, zitadelidpv2Options.isAutoUpdate) &&
        Objects.equals(this.autoLinking, zitadelidpv2Options.autoLinking);
  }
  ...
  public String toString() {
    ...
    sb.append("class Zitadelidpv2Options {\n");
