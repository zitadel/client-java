 ...
 */
@JsonPropertyOrder({
  UserServiceListQuery.JSON_PROPERTY_OFFSET,
...
public class UserServiceListQuery {
  ...
  public UserServiceListQuery() {
  }

  public UserServiceListQuery offset(@javax.annotation.Nullable Object offset) {
  ...
  public UserServiceListQuery limit(@javax.annotation.Nullable Integer limit) {
  ...
  public UserServiceListQuery asc(@javax.annotation.Nullable Boolean asc) {
  ...
  public boolean equals(Object o) {
    ...
    UserServiceListQuery userServiceListQuery = (UserServiceListQuery) o;
    return equalsNullable(this.offset, userServiceListQuery.offset) &&
        Objects.equals(this.limit, userServiceListQuery.limit) &&
        Objects.equals(this.asc, userServiceListQuery.asc);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserServiceListQuery {\n");
