...
public class FeatureServiceLoginV2 {
  ...
  /**
   * Require that all users must use the new login UI. If enabled, all users will be redirected to
   * the login V2 regardless of the application's preference.
   *
   * <p>Example: {@code null}
   */
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof FeatureServiceLoginV2 other)) {
      return false;
    }
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(required, baseUri);
  }
}
