...
public class BetaWebKeyServiceECDSA {
  ...
  @JsonProperty("curve")
  @Nullable
  public BetaWebKeyServiceECDSACurve curve;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaWebKeyServiceECDSA other)) {
      return false;
    }
    return java.util.Objects.equals(this.curve, other.curve);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(curve);
  }
}
