...
public class BetaUserServiceIDPSAMLAccessInformation {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaUserServiceIDPSAMLAccessInformation other)) {
      return false;
    }
    return java.util.Arrays.equals(this.assertion, other.assertion);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(java.util.Arrays.hashCode(assertion));
  }
}
