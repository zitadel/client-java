...
/**
 * SessionServiceBetaDetails
 */
@JsonPropertyOrder({
  SessionServiceBetaDetails.JSON_PROPERTY_SEQUENCE,
  SessionServiceBetaDetails.JSON_PROPERTY_CHANGE_DATE,
  SessionServiceBetaDetails.JSON_PROPERTY_RESOURCE_OWNER,
  SessionServiceBetaDetails.JSON_PROPERTY_CREATION_DATE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class SessionServiceBetaDetails {
  ...
  public SessionServiceBetaDetails() {
  }

  public SessionServiceBetaDetails sequence(@javax.annotation.Nullable String sequence) {
  ...
  public SessionServiceBetaDetails changeDate(@javax.annotation.Nullable OffsetDateTime changeDate) {
  ...
  public SessionServiceBetaDetails resourceOwner(@javax.annotation.Nullable String resourceOwner) {
  ...
  public SessionServiceBetaDetails creationDate(@javax.annotation.Nullable OffsetDateTime creationDate) {
  ...
  public boolean equals(Object o) {
    ...
    SessionServiceBetaDetails sessionServiceBetaDetails = (SessionServiceBetaDetails) o;
    return Objects.equals(this.sequence, sessionServiceBetaDetails.sequence) &&
        Objects.equals(this.changeDate, sessionServiceBetaDetails.changeDate) &&
        Objects.equals(this.resourceOwner, sessionServiceBetaDetails.resourceOwner) &&
        Objects.equals(this.creationDate, sessionServiceBetaDetails.creationDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class SessionServiceBetaDetails {\n");
