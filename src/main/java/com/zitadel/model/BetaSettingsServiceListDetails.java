...
public class BetaSettingsServiceListDetails {
  ...
  /** The {@code totalResult} property. */
  @JsonProperty("totalResult")
  @Nullable
  public Object totalResult;

  /** The {@code processedSequence} property. */
  @JsonProperty("processedSequence")
  @Nullable
  public Object processedSequence;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaSettingsServiceListDetails other)) {
      return false;
    }
    return java.util.Objects.equals(this.totalResult, other.totalResult)
        && java.util.Objects.equals(this.processedSequence, other.processedSequence)
        && java.util.Objects.equals(this.timestamp, other.timestamp);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(totalResult, processedSequence, timestamp);
  }
}
