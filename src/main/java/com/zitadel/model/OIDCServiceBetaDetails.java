...
/**
 * OIDCServiceBetaDetails
 */
@JsonPropertyOrder({
  OIDCServiceBetaDetails.JSON_PROPERTY_SEQUENCE,
  OIDCServiceBetaDetails.JSON_PROPERTY_CHANGE_DATE,
  OIDCServiceBetaDetails.JSON_PROPERTY_RESOURCE_OWNER,
  OIDCServiceBetaDetails.JSON_PROPERTY_CREATION_DATE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class OIDCServiceBetaDetails {
  ...
  public OIDCServiceBetaDetails() {
  }

  public OIDCServiceBetaDetails sequence(@javax.annotation.Nullable String sequence) {
  ...
  public OIDCServiceBetaDetails changeDate(@javax.annotation.Nullable OffsetDateTime changeDate) {
  ...
  public OIDCServiceBetaDetails resourceOwner(@javax.annotation.Nullable String resourceOwner) {
  ...
  public OIDCServiceBetaDetails creationDate(@javax.annotation.Nullable OffsetDateTime creationDate) {
  ...
  public boolean equals(Object o) {
    ...
    OIDCServiceBetaDetails oiDCServiceBetaDetails = (OIDCServiceBetaDetails) o;
    return Objects.equals(this.sequence, oiDCServiceBetaDetails.sequence) &&
        Objects.equals(this.changeDate, oiDCServiceBetaDetails.changeDate) &&
        Objects.equals(this.resourceOwner, oiDCServiceBetaDetails.resourceOwner) &&
        Objects.equals(this.creationDate, oiDCServiceBetaDetails.creationDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class OIDCServiceBetaDetails {\n");
