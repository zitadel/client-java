...
public enum UserServiceTextQueryMethod {
  ...
  public static UserServiceTextQueryMethod fromValue(String value) {
    for (UserServiceTextQueryMethod b : values()) {
