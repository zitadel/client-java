...
public class UserServiceVerifyU2FRegistrationRequest {
  ...
  public UserServiceVerifyU2FRegistrationRequest userId(@javax.annotation.Nullable String userId) {
  ...
  public UserServiceVerifyU2FRegistrationRequest u2fId(@javax.annotation.Nullable String u2fId) {
  ...
  public UserServiceVerifyU2FRegistrationRequest publicKeyCredential(@javax.annotation.Nullable Map<String, Object> publicKeyCredential) {
  ...
  public UserServiceVerifyU2FRegistrationRequest tokenName(@javax.annotation.Nullable String tokenName) {
