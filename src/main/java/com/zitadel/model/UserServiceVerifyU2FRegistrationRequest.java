...
public class UserServiceVerifyU2FRegistrationRequest {
  ...
  public UserServiceVerifyU2FRegistrationRequest publicKeyCredential(@javax.annotation.Nonnull Map<String, UserServiceValue> publicKeyCredential) {
    
    this.publicKeyCredential = publicKeyCredential;
    return this;
  }

  public UserServiceVerifyU2FRegistrationRequest putPublicKeyCredentialItem(String key, UserServiceValue publicKeyCredentialItem) {
