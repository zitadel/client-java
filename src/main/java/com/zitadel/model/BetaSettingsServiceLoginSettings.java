...
import com.zitadel.model.BetaSettingsServiceMultiFactorType;
import com.zitadel.model.BetaSettingsServicePasskeysType;
import com.zitadel.model.BetaSettingsServiceResourceOwnerType;
import com.zitadel.model.BetaSettingsServiceSecondFactorType;
 ...
 */
@JsonPropertyOrder({
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_ALLOW_USERNAME_PASSWORD,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_ALLOW_REGISTER,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_ALLOW_EXTERNAL_IDP,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_FORCE_MFA,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_PASSKEYS_TYPE,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_HIDE_PASSWORD_RESET,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_IGNORE_UNKNOWN_USERNAMES,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_DEFAULT_REDIRECT_URI,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_PASSWORD_CHECK_LIFETIME,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_EXTERNAL_LOGIN_CHECK_LIFETIME,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_MFA_INIT_SKIP_LIFETIME,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_SECOND_FACTOR_CHECK_LIFETIME,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_MULTI_FACTOR_CHECK_LIFETIME,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_SECOND_FACTORS,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_MULTI_FACTORS,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_ALLOW_DOMAIN_DISCOVERY,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_DISABLE_LOGIN_WITH_EMAIL,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_DISABLE_LOGIN_WITH_PHONE,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_RESOURCE_OWNER_TYPE,
  BetaSettingsServiceLoginSettings.JSON_PROPERTY_FORCE_MFA_LOCAL_ONLY
})
...
public class BetaSettingsServiceLoginSettings {
  ...
  @javax.annotation.Nullable
  private BetaSettingsServicePasskeysType passkeysType;
  ...
  @javax.annotation.Nullable
  private List<BetaSettingsServiceSecondFactorType> secondFactors = new ArrayList<>();

  public static final String JSON_PROPERTY_MULTI_FACTORS = "multiFactors";
  @javax.annotation.Nullable
  private List<BetaSettingsServiceMultiFactorType> multiFactors = new ArrayList<>();
  ...
  public BetaSettingsServiceLoginSettings allowUsernamePassword(@javax.annotation.Nullable Boolean allowUsernamePassword) {
  ...
  public BetaSettingsServiceLoginSettings allowRegister(@javax.annotation.Nullable Boolean allowRegister) {
  ...
  public BetaSettingsServiceLoginSettings allowExternalIdp(@javax.annotation.Nullable Boolean allowExternalIdp) {
  ...
  public BetaSettingsServiceLoginSettings forceMfa(@javax.annotation.Nullable Boolean forceMfa) {
  ...
  public BetaSettingsServiceLoginSettings passkeysType(@javax.annotation.Nullable BetaSettingsServicePasskeysType passkeysType) {
  ...
  public BetaSettingsServicePasskeysType getPasskeysType() {
    return passkeysType;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PASSKEYS_TYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPasskeysType(@javax.annotation.Nullable BetaSettingsServicePasskeysType passkeysType) {
    this.passkeysType = passkeysType;
  }

  public BetaSettingsServiceLoginSettings hidePasswordReset(@javax.annotation.Nullable Boolean hidePasswordReset) {
  ...
  public BetaSettingsServiceLoginSettings ignoreUnknownUsernames(@javax.annotation.Nullable Boolean ignoreUnknownUsernames) {
  ...
  public BetaSettingsServiceLoginSettings defaultRedirectUri(@javax.annotation.Nullable String defaultRedirectUri) {
  ...
  public BetaSettingsServiceLoginSettings passwordCheckLifetime(@javax.annotation.Nullable String passwordCheckLifetime) {
  ...
  public BetaSettingsServiceLoginSettings externalLoginCheckLifetime(@javax.annotation.Nullable String externalLoginCheckLifetime) {
  ...
  public BetaSettingsServiceLoginSettings mfaInitSkipLifetime(@javax.annotation.Nullable String mfaInitSkipLifetime) {
  ...
  public BetaSettingsServiceLoginSettings secondFactorCheckLifetime(@javax.annotation.Nullable String secondFactorCheckLifetime) {
  ...
  public BetaSettingsServiceLoginSettings multiFactorCheckLifetime(@javax.annotation.Nullable String multiFactorCheckLifetime) {
  ...
  public BetaSettingsServiceLoginSettings secondFactors(@javax.annotation.Nullable List<BetaSettingsServiceSecondFactorType> secondFactors) {
    
    this.secondFactors = secondFactors;
    return this;
  }

  public BetaSettingsServiceLoginSettings addSecondFactorsItem(BetaSettingsServiceSecondFactorType secondFactorsItem) {
  ...
  public List<BetaSettingsServiceSecondFactorType> getSecondFactors() {
    return secondFactors;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SECOND_FACTORS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSecondFactors(@javax.annotation.Nullable List<BetaSettingsServiceSecondFactorType> secondFactors) {
    this.secondFactors = secondFactors;
  }

  public BetaSettingsServiceLoginSettings multiFactors(@javax.annotation.Nullable List<BetaSettingsServiceMultiFactorType> multiFactors) {
    
    this.multiFactors = multiFactors;
    return this;
  }

  public BetaSettingsServiceLoginSettings addMultiFactorsItem(BetaSettingsServiceMultiFactorType multiFactorsItem) {
  ...
  public List<BetaSettingsServiceMultiFactorType> getMultiFactors() {
    return multiFactors;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MULTI_FACTORS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMultiFactors(@javax.annotation.Nullable List<BetaSettingsServiceMultiFactorType> multiFactors) {
    this.multiFactors = multiFactors;
  }

  public BetaSettingsServiceLoginSettings allowDomainDiscovery(@javax.annotation.Nullable Boolean allowDomainDiscovery) {
  ...
  public BetaSettingsServiceLoginSettings disableLoginWithEmail(@javax.annotation.Nullable Boolean disableLoginWithEmail) {
  ...
  public BetaSettingsServiceLoginSettings disableLoginWithPhone(@javax.annotation.Nullable Boolean disableLoginWithPhone) {
  ...
  public BetaSettingsServiceLoginSettings resourceOwnerType(@javax.annotation.Nullable BetaSettingsServiceResourceOwnerType resourceOwnerType) {
  ...
  public BetaSettingsServiceLoginSettings forceMfaLocalOnly(@javax.annotation.Nullable Boolean forceMfaLocalOnly) {
  ...
  public boolean equals(Object o) {
    ...
    BetaSettingsServiceLoginSettings betaSettingsServiceLoginSettings = (BetaSettingsServiceLoginSettings) o;
    return Objects.equals(this.allowUsernamePassword, betaSettingsServiceLoginSettings.allowUsernamePassword) &&
        Objects.equals(this.allowRegister, betaSettingsServiceLoginSettings.allowRegister) &&
        Objects.equals(this.allowExternalIdp, betaSettingsServiceLoginSettings.allowExternalIdp) &&
        Objects.equals(this.forceMfa, betaSettingsServiceLoginSettings.forceMfa) &&
        Objects.equals(this.passkeysType, betaSettingsServiceLoginSettings.passkeysType) &&
        Objects.equals(this.hidePasswordReset, betaSettingsServiceLoginSettings.hidePasswordReset) &&
        Objects.equals(this.ignoreUnknownUsernames, betaSettingsServiceLoginSettings.ignoreUnknownUsernames) &&
        Objects.equals(this.defaultRedirectUri, betaSettingsServiceLoginSettings.defaultRedirectUri) &&
        Objects.equals(this.passwordCheckLifetime, betaSettingsServiceLoginSettings.passwordCheckLifetime) &&
        Objects.equals(this.externalLoginCheckLifetime, betaSettingsServiceLoginSettings.externalLoginCheckLifetime) &&
        Objects.equals(this.mfaInitSkipLifetime, betaSettingsServiceLoginSettings.mfaInitSkipLifetime) &&
        Objects.equals(this.secondFactorCheckLifetime, betaSettingsServiceLoginSettings.secondFactorCheckLifetime) &&
        Objects.equals(this.multiFactorCheckLifetime, betaSettingsServiceLoginSettings.multiFactorCheckLifetime) &&
        Objects.equals(this.secondFactors, betaSettingsServiceLoginSettings.secondFactors) &&
        Objects.equals(this.multiFactors, betaSettingsServiceLoginSettings.multiFactors) &&
        Objects.equals(this.allowDomainDiscovery, betaSettingsServiceLoginSettings.allowDomainDiscovery) &&
        Objects.equals(this.disableLoginWithEmail, betaSettingsServiceLoginSettings.disableLoginWithEmail) &&
        Objects.equals(this.disableLoginWithPhone, betaSettingsServiceLoginSettings.disableLoginWithPhone) &&
        Objects.equals(this.resourceOwnerType, betaSettingsServiceLoginSettings.resourceOwnerType) &&
        Objects.equals(this.forceMfaLocalOnly, betaSettingsServiceLoginSettings.forceMfaLocalOnly);
  }
  ...
  public String toString() {
    ...
    sb.append("class BetaSettingsServiceLoginSettings {\n");
