...
public class InternalPermissionServiceAdministrator {
  ...
  @JsonProperty("user")
  @Nullable
  public InternalPermissionServiceUser user;
  ...
  @Nullable
  public InternalPermissionServiceOrganization organization;

  /** Example: {@code null} */
  @JsonProperty("project")
  @Nullable
  public InternalPermissionServiceProject project;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof InternalPermissionServiceAdministrator other)) {
      return false;
    }
