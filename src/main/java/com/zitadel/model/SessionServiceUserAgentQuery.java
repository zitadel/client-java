...
public class SessionServiceUserAgentQuery {
  ...
  /**
   * Finger print id of the user agent used for the session. Set an empty fingerprint_id to use the
   * user agent from the call. If the user agent is not available from the current token, an error
   * will be returned.
   *
   * <p>Example: {@code null}
   */
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SessionServiceUserAgentQuery other)) {
      return false;
    }
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(fingerprintId);
  }
}
