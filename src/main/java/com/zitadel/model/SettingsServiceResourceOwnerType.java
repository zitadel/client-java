...
public enum SettingsServiceResourceOwnerType {
  ...
  SettingsServiceResourceOwnerType(String value) {
    this.value = value;
  }
  ...
  public static SettingsServiceResourceOwnerType fromValue(String value) {
    for (SettingsServiceResourceOwnerType b : values()) {
