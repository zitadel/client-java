...
public class UserServiceRetrieveIdentityProviderIntentResponse {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof UserServiceRetrieveIdentityProviderIntentResponse other)) {
      return false;
    }
    return java.util.Objects.equals(this.details, other.details)
        && java.util.Objects.equals(this.idpInformation, other.idpInformation)
        && java.util.Objects.equals(this.userId, other.userId)
        && java.util.Objects.equals(this.addHumanUser, other.addHumanUser)
        && java.util.Objects.equals(this.updateHumanUser, other.updateHumanUser);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(details, idpInformation, userId, addHumanUser, updateHumanUser);
  }
}
