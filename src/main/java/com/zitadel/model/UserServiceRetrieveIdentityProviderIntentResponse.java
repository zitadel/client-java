...
public class UserServiceRetrieveIdentityProviderIntentResponse {
  ...
  @javax.annotation.Nullable
  private UserServiceIDPInformation idpInformation;
  ...
  public UserServiceRetrieveIdentityProviderIntentResponse details(@javax.annotation.Nullable UserServiceDetails details) {
  ...
  public UserServiceRetrieveIdentityProviderIntentResponse idpInformation(@javax.annotation.Nullable UserServiceIDPInformation idpInformation) {
  ...
  public UserServiceIDPInformation getIdpInformation() {
    return idpInformation;
  }
  ...
  @JsonProperty(JSON_PROPERTY_IDP_INFORMATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIdpInformation(@javax.annotation.Nullable UserServiceIDPInformation idpInformation) {
    this.idpInformation = idpInformation;
  }

  public UserServiceRetrieveIdentityProviderIntentResponse userId(@javax.annotation.Nullable String userId) {
  ...
  public String toString() {
    ...
    sb.append("class UserServiceRetrieveIdentityProviderIntentResponse {\n");
