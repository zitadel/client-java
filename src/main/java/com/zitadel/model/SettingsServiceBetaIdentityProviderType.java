...
/**
 * Gets or Sets SettingsServiceBetaIdentityProviderType
 */
public enum SettingsServiceBetaIdentityProviderType {
  ...
  SettingsServiceBetaIdentityProviderType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static SettingsServiceBetaIdentityProviderType fromValue(String value) {
    for (SettingsServiceBetaIdentityProviderType b : SettingsServiceBetaIdentityProviderType.values()) {
