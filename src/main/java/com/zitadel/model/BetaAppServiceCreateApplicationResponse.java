...
public class BetaAppServiceCreateApplicationResponse {
  ...
  /** The {@code apiResponse} property. */
  @JsonProperty("apiResponse")
  @Nullable
  public BetaAppServiceCreateAPIApplicationResponse apiResponse;

  /** The {@code oidcResponse} property. */
  @JsonProperty("oidcResponse")
  @Nullable
  public BetaAppServiceCreateOIDCApplicationResponse oidcResponse;

  /** The {@code samlResponse} property. */
  @JsonProperty("samlResponse")
  @Nullable
  public Object samlResponse;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaAppServiceCreateApplicationResponse other)) {
      return false;
    }
    return java.util.Objects.equals(this.appId, other.appId)
        && java.util.Objects.equals(this.creationDate, other.creationDate)
        && java.util.Objects.equals(this.apiResponse, other.apiResponse)
        && java.util.Objects.equals(this.oidcResponse, other.oidcResponse)
        && java.util.Objects.equals(this.samlResponse, other.samlResponse);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(appId, creationDate, apiResponse, oidcResponse, samlResponse);
  }
}
