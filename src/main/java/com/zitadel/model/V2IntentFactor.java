 ...
 */
@JsonPropertyOrder({
  V2IntentFactor.JSON_PROPERTY_VERIFIED_AT
})
@JsonTypeName("v2IntentFactor")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2IntentFactor {
  public static final String JSON_PROPERTY_VERIFIED_AT = "verifiedAt";
  @javax.annotation.Nullable
  private OffsetDateTime verifiedAt;

  public V2IntentFactor() {
  }

  public V2IntentFactor verifiedAt(@javax.annotation.Nullable OffsetDateTime verifiedAt) {
  ...
  public boolean equals(Object o) {
    ...
    V2IntentFactor v2IntentFactor = (V2IntentFactor) o;
    return Objects.equals(this.verifiedAt, v2IntentFactor.verifiedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2IntentFactor {\n");
