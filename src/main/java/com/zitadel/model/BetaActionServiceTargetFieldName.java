...
public enum BetaActionServiceTargetFieldName {
  ...
  BetaActionServiceTargetFieldName(String value) {
    this.value = value;
  }
  ...
  public static BetaActionServiceTargetFieldName fromValue(String value) {
    for (BetaActionServiceTargetFieldName b : values()) {
