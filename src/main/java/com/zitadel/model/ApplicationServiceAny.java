 ...
 */
@JsonPropertyOrder({
  ApplicationServiceAny.JSON_PROPERTY_TYPE,
  ApplicationServiceAny.JSON_PROPERTY_VALUE,
  ApplicationServiceAny.JSON_PROPERTY_DEBUG
})
@javax.annotation.Generated(value = "io.github.mridang.codegen.generators.java.BetterJavaCodegen", comments = "Generator version: 7.14.0")
public class ApplicationServiceAny extends HashMap<String, Object> {
  ...
  public ApplicationServiceAny() {

  }

  public ApplicationServiceAny type(@javax.annotation.Nullable String type) {
  ...
  public ApplicationServiceAny value(@javax.annotation.Nullable File value) {
  ...
  public ApplicationServiceAny debug(@javax.annotation.Nullable Object debug) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicationServiceAny applicationServiceAny = (ApplicationServiceAny) o;
    return Objects.equals(this.type, applicationServiceAny.type) &&
        Objects.equals(this.value, applicationServiceAny.value) &&
        equalsNullable(this.debug, applicationServiceAny.debug) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicationServiceAny {\n");
