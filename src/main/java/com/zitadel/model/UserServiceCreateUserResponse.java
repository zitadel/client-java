 ...
 */
@JsonPropertyOrder({
  UserServiceCreateUserResponse.JSON_PROPERTY_ID,
  UserServiceCreateUserResponse.JSON_PROPERTY_CREATION_DATE,
  UserServiceCreateUserResponse.JSON_PROPERTY_EMAIL_CODE,
  UserServiceCreateUserResponse.JSON_PROPERTY_PHONE_CODE
})
@javax.annotation.Generated(value = "io.github.mridang.codegen.generators.java.BetterJavaCodegen", comments = "Generator version: 7.14.0")
public class UserServiceCreateUserResponse {
  ...
  public UserServiceCreateUserResponse() {
  }

  public UserServiceCreateUserResponse id(@javax.annotation.Nullable String id) {
  ...
  public UserServiceCreateUserResponse creationDate(@javax.annotation.Nullable OffsetDateTime creationDate) {
  ...
  public UserServiceCreateUserResponse emailCode(@javax.annotation.Nullable String emailCode) {
  ...
  public UserServiceCreateUserResponse phoneCode(@javax.annotation.Nullable String phoneCode) {
  ...
  public boolean equals(Object o) {
    ...
    UserServiceCreateUserResponse userServiceCreateUserResponse = (UserServiceCreateUserResponse) o;
    return Objects.equals(this.id, userServiceCreateUserResponse.id) &&
        Objects.equals(this.creationDate, userServiceCreateUserResponse.creationDate) &&
        equalsNullable(this.emailCode, userServiceCreateUserResponse.emailCode) &&
        equalsNullable(this.phoneCode, userServiceCreateUserResponse.phoneCode);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, creationDate, hashCodeNullable(emailCode), hashCodeNullable(phoneCode));
  }
  ...
  public String toString() {
    ...
    sb.append("class UserServiceCreateUserResponse {\n");
