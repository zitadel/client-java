...
public class UserServiceCreateUserResponse {
  ...
  /**
   * The email verification code if it was requested by setting the email verification to
   * return_code.
   *
   * <p>Example: {@code null}
   */
  ...
  /**
   * The phone verification code if it was requested by setting the phone verification to
   * return_code.
   *
   * <p>Example: {@code null}
   */
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof UserServiceCreateUserResponse other)) {
      return false;
    }
    return java.util.Objects.equals(this.id, other.id)
        && java.util.Objects.equals(this.creationDate, other.creationDate)
        && java.util.Objects.equals(this.emailCode, other.emailCode)
        && java.util.Objects.equals(this.phoneCode, other.phoneCode);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, creationDate, emailCode, phoneCode);
  }
}
