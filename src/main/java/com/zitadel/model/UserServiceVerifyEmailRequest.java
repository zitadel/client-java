...
public class UserServiceVerifyEmailRequest {
  ...
  public UserServiceVerifyEmailRequest userId(@javax.annotation.Nonnull String userId) {
  ...
  public UserServiceVerifyEmailRequest verificationCode(@javax.annotation.Nonnull String verificationCode) {
