...
public class UserServiceAddSecretResponse {
  ...
  /**
   * The client secret. Store this secret in a secure place. It is not possible to retrieve it
   * again.
   *
   * <p>Example: {@code null}
   */
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof UserServiceAddSecretResponse other)) {
      return false;
    }
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(creationDate, clientSecret);
  }
}
