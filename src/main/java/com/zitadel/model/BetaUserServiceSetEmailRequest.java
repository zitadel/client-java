...
public class BetaUserServiceSetEmailRequest {
  ...
  public BetaUserServiceSetEmailRequest isVerified(@javax.annotation.Nullable Boolean isVerified) {
  ...
  public BetaUserServiceSetEmailRequest returnCode(@javax.annotation.Nullable Object returnCode) {
  ...
  public BetaUserServiceSetEmailRequest sendCode(@javax.annotation.Nullable BetaUserServiceSendEmailVerificationCode sendCode) {
  ...
  @JsonProperty(JSON_PROPERTY_SEND_CODE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSendCode(@javax.annotation.Nullable BetaUserServiceSendEmailVerificationCode sendCode) {
    this.sendCode = sendCode;
  }
