 ...
 */
@JsonPropertyOrder({
  V2ResendPhoneCodeResponse.JSON_PROPERTY_DETAILS,
  V2ResendPhoneCodeResponse.JSON_PROPERTY_VERIFICATION_CODE
})
@JsonTypeName("v2ResendPhoneCodeResponse")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2ResendPhoneCodeResponse {
  ...
  public V2ResendPhoneCodeResponse() {
  }

  public V2ResendPhoneCodeResponse details(@javax.annotation.Nullable V2Details details) {
  ...
  public V2ResendPhoneCodeResponse verificationCode(@javax.annotation.Nullable String verificationCode) {
  ...
  public boolean equals(Object o) {
    ...
    V2ResendPhoneCodeResponse v2ResendPhoneCodeResponse = (V2ResendPhoneCodeResponse) o;
    return Objects.equals(this.details, v2ResendPhoneCodeResponse.details) &&
        Objects.equals(this.verificationCode, v2ResendPhoneCodeResponse.verificationCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2ResendPhoneCodeResponse {\n");
