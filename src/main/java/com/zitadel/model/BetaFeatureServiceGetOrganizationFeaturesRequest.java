...
public class BetaFeatureServiceGetOrganizationFeaturesRequest {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BetaFeatureServiceGetOrganizationFeaturesRequest other)) {
      return false;
    }
    return java.util.Objects.equals(this.organizationId, other.organizationId)
        && java.util.Objects.equals(this.inheritance, other.inheritance);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(organizationId, inheritance);
  }
}
