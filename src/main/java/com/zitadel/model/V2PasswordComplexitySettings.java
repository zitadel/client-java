 ...
 */
@JsonPropertyOrder({
  V2PasswordComplexitySettings.JSON_PROPERTY_MIN_LENGTH,
  V2PasswordComplexitySettings.JSON_PROPERTY_REQUIRES_UPPERCASE,
  V2PasswordComplexitySettings.JSON_PROPERTY_REQUIRES_LOWERCASE,
  V2PasswordComplexitySettings.JSON_PROPERTY_REQUIRES_NUMBER,
  V2PasswordComplexitySettings.JSON_PROPERTY_REQUIRES_SYMBOL,
  V2PasswordComplexitySettings.JSON_PROPERTY_RESOURCE_OWNER_TYPE
})
@JsonTypeName("v2PasswordComplexitySettings")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2PasswordComplexitySettings {
  ...
  public V2PasswordComplexitySettings() {
  }

  public V2PasswordComplexitySettings minLength(@javax.annotation.Nullable String minLength) {
  ...
  public V2PasswordComplexitySettings requiresUppercase(@javax.annotation.Nullable Boolean requiresUppercase) {
  ...
  public V2PasswordComplexitySettings requiresLowercase(@javax.annotation.Nullable Boolean requiresLowercase) {
  ...
  public V2PasswordComplexitySettings requiresNumber(@javax.annotation.Nullable Boolean requiresNumber) {
  ...
  public V2PasswordComplexitySettings requiresSymbol(@javax.annotation.Nullable Boolean requiresSymbol) {
  ...
  public V2PasswordComplexitySettings resourceOwnerType(@javax.annotation.Nullable V2ResourceOwnerType resourceOwnerType) {
  ...
  public boolean equals(Object o) {
    ...
    V2PasswordComplexitySettings v2PasswordComplexitySettings = (V2PasswordComplexitySettings) o;
    return Objects.equals(this.minLength, v2PasswordComplexitySettings.minLength) &&
        Objects.equals(this.requiresUppercase, v2PasswordComplexitySettings.requiresUppercase) &&
        Objects.equals(this.requiresLowercase, v2PasswordComplexitySettings.requiresLowercase) &&
        Objects.equals(this.requiresNumber, v2PasswordComplexitySettings.requiresNumber) &&
        Objects.equals(this.requiresSymbol, v2PasswordComplexitySettings.requiresSymbol) &&
        Objects.equals(this.resourceOwnerType, v2PasswordComplexitySettings.resourceOwnerType);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2PasswordComplexitySettings {\n");
