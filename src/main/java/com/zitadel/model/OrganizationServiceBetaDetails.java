...
/**
 * OrganizationServiceBetaDetails
 */
@JsonPropertyOrder({
  OrganizationServiceBetaDetails.JSON_PROPERTY_SEQUENCE,
  OrganizationServiceBetaDetails.JSON_PROPERTY_CHANGE_DATE,
  OrganizationServiceBetaDetails.JSON_PROPERTY_RESOURCE_OWNER,
  OrganizationServiceBetaDetails.JSON_PROPERTY_CREATION_DATE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class OrganizationServiceBetaDetails {
  ...
  public OrganizationServiceBetaDetails() {
  }

  public OrganizationServiceBetaDetails sequence(@javax.annotation.Nullable String sequence) {
  ...
  public OrganizationServiceBetaDetails changeDate(@javax.annotation.Nullable OffsetDateTime changeDate) {
  ...
  public OrganizationServiceBetaDetails resourceOwner(@javax.annotation.Nullable String resourceOwner) {
  ...
  public OrganizationServiceBetaDetails creationDate(@javax.annotation.Nullable OffsetDateTime creationDate) {
  ...
  public boolean equals(Object o) {
    ...
    OrganizationServiceBetaDetails organizationServiceBetaDetails = (OrganizationServiceBetaDetails) o;
    return Objects.equals(this.sequence, organizationServiceBetaDetails.sequence) &&
        Objects.equals(this.changeDate, organizationServiceBetaDetails.changeDate) &&
        Objects.equals(this.resourceOwner, organizationServiceBetaDetails.resourceOwner) &&
        Objects.equals(this.creationDate, organizationServiceBetaDetails.creationDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationServiceBetaDetails {\n");
