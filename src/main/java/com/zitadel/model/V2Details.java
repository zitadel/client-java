 ...
 */
@JsonPropertyOrder({
  V2Details.JSON_PROPERTY_SEQUENCE,
  V2Details.JSON_PROPERTY_CHANGE_DATE,
  V2Details.JSON_PROPERTY_RESOURCE_OWNER
})
@JsonTypeName("v2Details")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class V2Details {
  ...
  public V2Details sequence(@javax.annotation.Nullable String sequence) {
  ...
  public V2Details changeDate(@javax.annotation.Nullable OffsetDateTime changeDate) {
  ...
  public V2Details resourceOwner(@javax.annotation.Nullable String resourceOwner) {
  ...
  public boolean equals(Object o) {
    ...
    V2Details v2Details = (V2Details) o;
    return Objects.equals(this.sequence, v2Details.sequence) &&
      Objects.equals(this.changeDate, v2Details.changeDate) &&
      Objects.equals(this.resourceOwner, v2Details.resourceOwner);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sequence, changeDate, resourceOwner);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V2Details {\n");
