...
import com.zitadel.model.NoOp200Response14;
...
public class BetaOrganizationServiceApi extends BaseApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public NoOp200Response14 noOp() throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  private NoOp200Response14 noOp(Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
    
    String localVarPath = "/5d674148";
    ...
    TypeReference<NoOp200Response14> localVarReturnType = new TypeReference<NoOp200Response14>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
