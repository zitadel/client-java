...
import com.zitadel.model.NoOp200Response12;
...
public class BetaUserServiceApi extends BaseApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public NoOp200Response12 noOp() throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  private NoOp200Response12 noOp(Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
    
    String localVarPath = "/ac7df331";
    ...
    TypeReference<NoOp200Response12> localVarReturnType = new TypeReference<NoOp200Response12>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
