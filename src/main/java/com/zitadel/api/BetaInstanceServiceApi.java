...
import com.zitadel.model.NoOp200Response13;
...
public class BetaInstanceServiceApi extends BaseApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public NoOp200Response13 noOp() throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  private NoOp200Response13 noOp(Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
    
    String localVarPath = "/e4a70fb7";
    ...
    TypeReference<NoOp200Response13> localVarReturnType = new TypeReference<NoOp200Response13>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
