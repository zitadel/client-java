...
import com.zitadel.model.NoOp200Response16;
...
public class BetaInstanceServiceApi extends BaseApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public NoOp200Response16 noOp() throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  private NoOp200Response16 noOp(Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
    
    String localVarPath = "/91bc356a";
    ...
    TypeReference<NoOp200Response16> localVarReturnType = new TypeReference<NoOp200Response16>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
