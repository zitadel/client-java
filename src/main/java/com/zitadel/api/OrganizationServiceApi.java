...
import com.zitadel.model.NoOp200Response5;
...
public class OrganizationServiceApi extends BaseApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public OrganizationServiceAddOrganizationResponse addOrganization(OrganizationServiceAddOrganizationRequest organizationServiceAddOrganizationRequest, Map<String, String> additionalHeaders) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public OrganizationServiceListOrganizationsResponse listOrganizations(OrganizationServiceListOrganizationsRequest organizationServiceListOrganizationsRequest, Map<String, String> additionalHeaders) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public NoOp200Response5 noOp() throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public NoOp200Response5 noOp(Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
    
    String localVarPath = "/30a7bb25";
    ...
    TypeReference<NoOp200Response5> localVarReturnType = new TypeReference<NoOp200Response5>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
