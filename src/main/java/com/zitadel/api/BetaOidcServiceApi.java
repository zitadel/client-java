...
import com.zitadel.model.NoOp200Response15;
...
public class BetaOidcServiceApi extends BaseApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public NoOp200Response15 noOp() throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  private NoOp200Response15 noOp(Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
    
    String localVarPath = "/09757f2b";
    ...
    TypeReference<NoOp200Response15> localVarReturnType = new TypeReference<NoOp200Response15>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
