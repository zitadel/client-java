...
public class BetaOidcServiceApi extends BaseApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public BetaOIDCServiceCreateCallbackResponse createCallback(BetaOIDCServiceCreateCallbackRequest betaOIDCServiceCreateCallbackRequest, Map<String, String> additionalHeaders) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public BetaOIDCServiceGetAuthRequestResponse getAuthRequest(BetaOIDCServiceGetAuthRequestRequest betaOIDCServiceGetAuthRequestRequest, Map<String, String> additionalHeaders) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public NoOp200Response11 noOp(Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
    
    String localVarPath = "/e66c8195";
