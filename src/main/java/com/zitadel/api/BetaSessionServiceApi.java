...
import com.zitadel.model.NoOp200Response1;
...
public class BetaSessionServiceApi extends BaseApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public BetaSessionServiceCreateSessionResponse createSession(BetaSessionServiceCreateSessionRequest betaSessionServiceCreateSessionRequest, Map<String, String> additionalHeaders) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public BetaSessionServiceDeleteSessionResponse deleteSession(BetaSessionServiceDeleteSessionRequest betaSessionServiceDeleteSessionRequest, Map<String, String> additionalHeaders) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public BetaSessionServiceGetSessionResponse getSession(BetaSessionServiceGetSessionRequest betaSessionServiceGetSessionRequest, Map<String, String> additionalHeaders) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public BetaSessionServiceListSessionsResponse listSessions(BetaSessionServiceListSessionsRequest betaSessionServiceListSessionsRequest, Map<String, String> additionalHeaders) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public NoOp200Response1 noOp() throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public NoOp200Response1 noOp(Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
    
    String localVarPath = "/6b54ddc1";
    ...
    TypeReference<NoOp200Response1> localVarReturnType = new TypeReference<NoOp200Response1>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
   ...
   * @throws ApiException if fails to make API call
   */
  public BetaSessionServiceSetSessionResponse setSession(BetaSessionServiceSetSessionRequest betaSessionServiceSetSessionRequest, Map<String, String> additionalHeaders) throws ApiException {
