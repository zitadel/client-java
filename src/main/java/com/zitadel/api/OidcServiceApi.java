...
public class OidcServiceApi extends BaseApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public Object authorizeOrDenyDeviceAuthorization(OIDCServiceAuthorizeOrDenyDeviceAuthorizationRequest oiDCServiceAuthorizeOrDenyDeviceAuthorizationRequest, Map<String, String> additionalHeaders) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public OIDCServiceCreateCallbackResponse createCallback(OIDCServiceCreateCallbackRequest oiDCServiceCreateCallbackRequest, Map<String, String> additionalHeaders) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public OIDCServiceGetAuthRequestResponse getAuthRequest(OIDCServiceGetAuthRequestRequest oiDCServiceGetAuthRequestRequest, Map<String, String> additionalHeaders) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public OIDCServiceGetDeviceAuthorizationRequestResponse getDeviceAuthorizationRequest(OIDCServiceGetDeviceAuthorizationRequestRequest oiDCServiceGetDeviceAuthorizationRequestRequest, Map<String, String> additionalHeaders) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public NoOp200Response6 noOp(Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
    
    String localVarPath = "/dc68286c";
